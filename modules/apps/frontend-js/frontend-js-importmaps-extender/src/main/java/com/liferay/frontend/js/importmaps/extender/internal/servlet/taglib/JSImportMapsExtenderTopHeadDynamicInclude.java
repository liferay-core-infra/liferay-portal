...
import com.liferay.frontend.js.importmaps.extender.internal.servlet.taglib.util.JSImportMapsExtenderTopHeadDynamicIncludeUtil;
...
public class JSImportMapsExtenderTopHeadDynamicInclude
	...
	public void include(
		...
		if (_jsImportMapsConfiguration.enableImportMaps() &&
			(!JSImportMapsExtenderTopHeadDynamicIncludeUtil.
				isEmptyGlobalImportMapJSONObjects() ||
			 !JSImportMapsExtenderTopHeadDynamicIncludeUtil.
				 isEmptyScopedImportMapJSONObjects())) {
			...
			printWriter.print("\">");
			printWriter.print(
				JSImportMapsExtenderTopHeadDynamicIncludeUtil.getImportMaps());
	...
	protected void activate(
		...
		JSImportMapsExtenderTopHeadDynamicIncludeUtil.rebuildImportMaps();
