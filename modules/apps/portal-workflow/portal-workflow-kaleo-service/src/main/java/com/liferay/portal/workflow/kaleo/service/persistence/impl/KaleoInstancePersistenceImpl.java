...
public class KaleoInstancePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByKDI_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByKDI_C",
			new String[] {
		...
		_finderPathWithoutPaginationFindByKDI_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByKDI_C",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"kaleoDefinitionId", "completed"}, true);

		_finderPathCountByKDI_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByKDI_C",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"kaleoDefinitionId", "completed"}, false);

		_finderPathWithPaginationFindByKDVI_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByKDVI_C",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByKDVI_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByKDVI_C",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"kaleoDefinitionVersionId", "completed"}, true);

		_finderPathCountByKDVI_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByKDVI_C",
			new String[] {Long.class.getName(), Boolean.class.getName()},
		...
		_finderPathFetchByKII_C_U = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByKII_C_U",
			new String[] {
		...
		_finderPathCountByKII_C_U = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByKII_C_U",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_KDN_KDV_CD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_KDN_KDV_CD",
			new String[] {
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByKDI_C",
			_finderPathWithPaginationFindByKDI_C);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByKDI_C",
			_finderPathWithoutPaginationFindByKDI_C);

		_finderPaths.put("finderPathCountByKDI_C", _finderPathCountByKDI_C);

		_finderPaths.put(
			"finderPathWithPaginationFindByKDVI_C",
			_finderPathWithPaginationFindByKDVI_C);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByKDVI_C",
			_finderPathWithoutPaginationFindByKDVI_C);

		_finderPaths.put("finderPathCountByKDVI_C", _finderPathCountByKDVI_C);
		...
		_finderPaths.put("finderPathFetchByKII_C_U", _finderPathFetchByKII_C_U);

		_finderPaths.put("finderPathCountByKII_C_U", _finderPathCountByKII_C_U);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_KDN_KDV_CD",
			_finderPathWithPaginationFindByC_KDN_KDV_CD);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_KDN_KDV_CD",
			_finderPathWithoutPaginationFindByC_KDN_KDV_CD);

		_finderPaths.put(
			"finderPathCountByC_KDN_KDV_CD", _finderPathCountByC_KDN_KDV_CD);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<KaleoInstance> kaleoInstances = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<KaleoInstance>> resultMap = new HashMap<>();
			...
			for (KaleoInstance kaleoInstance : kaleoInstances) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						kaleoInstanceModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), kaleoInstance);
				}
				else {
					List<KaleoInstance> resultList = resultMap.computeIfAbsent(
						arguments, key -> new ArrayList<>());

					resultList.add(kaleoInstance);
				}
			}

			for (Map.Entry<List<Object>, List<KaleoInstance>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<KaleoInstance> value = resultEntry.getValue();
