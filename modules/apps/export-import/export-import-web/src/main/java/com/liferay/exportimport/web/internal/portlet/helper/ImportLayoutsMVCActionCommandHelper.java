...
package com.liferay.exportimport.web.internal.portlet.helper;
 ...
 */
@Component(service = ImportLayoutsMVCActionCommandHelper.class)
public class ImportLayoutsMVCActionCommandHelper {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ImportLayoutsMVCActionCommandHelper.class);
