...
import com.liferay.object.internal.filter.parser.ObjectFilterParserServiceRegistryImpl;
...
public class ObjectEntryLocalServiceImpl
			...
			List<String> oDataFilterStrings = TransformUtil.transform(
				...
				objectFilter -> {
					ObjectFilterParser objectFilterParser =
						_objectFilterParserServiceRegistryImpl.
	...
	@Reference
	private ObjectFilterParserServiceRegistryImpl
		_objectFilterParserServiceRegistryImpl;
