...
public class LanguageResourceFactoryImpl implements LanguageResource.Factory {
	...
	@Override
	public LanguageResource.Builder create() {
		return new LanguageResource.Builder() {
			...
			@Override
			public LanguageResource.Builder checkPermissions(
			...
			@Override
			public LanguageResource.Builder httpServletRequest(
			...
			@Override
			public LanguageResource.Builder httpServletResponse(
			...
			@Override
			public LanguageResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(languageResource);
	...
	private ComponentServiceObjects<LanguageResource> _componentServiceObjects;
