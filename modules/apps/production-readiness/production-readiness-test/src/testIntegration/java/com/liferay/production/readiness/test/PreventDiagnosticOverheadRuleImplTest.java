...
public class PreventDiagnosticOverheadRuleImplTest {
	...
	@Test
	public void testPreventDiagnosticOverheadRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getPreventDiagnosticOverheadRuleServiceReference(bundleContext);
	...
	@Test
	public void testPreventDiagnosticOverheadRuleIsRegistered()
		throws Exception {
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			PreventDiagnosticOverheadRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getPreventDiagnosticOverheadRuleServiceReference(
	...
	private static final String _RULE_KEY = "prevent-diagnostic-overhead";
