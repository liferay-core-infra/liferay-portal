...
public class AnnouncementsEntryUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByC_C_A() {

		return getPersistence().getFinderPathWithPaginationFindByC_C_A();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByC_C_A() {

		return getPersistence().getFinderPathWithoutPaginationFindByC_C_A();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByC_C_A() {

		return getPersistence().getFinderPathCountByC_C_A();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByC_C_C_A() {

		return getPersistence().getFinderPathWithPaginationFindByC_C_C_A();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByC_C_C_A() {

		return getPersistence().getFinderPathWithoutPaginationFindByC_C_C_A();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByC_C_C_A() {

		return getPersistence().getFinderPathCountByC_C_C_A();
	}
