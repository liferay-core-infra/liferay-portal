...
public class OptionValueResourceFactoryImpl
	...
	@Override
	public OptionValueResource.Builder create() {
		return new OptionValueResource.Builder() {
			...
			@Override
			public OptionValueResource.Builder checkPermissions(
			...
			@Override
			public OptionValueResource.Builder httpServletRequest(
			...
			@Override
			public OptionValueResource.Builder httpServletResponse(
			...
			@Override
			public OptionValueResource.Builder preferredLocale(
			...
			@Override
			public OptionValueResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, OptionValueResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			OptionValueResource.class.getClassLoader(),
			OptionValueResource.class);

		try {
			Constructor<OptionValueResource> constructor =
				(Constructor<OptionValueResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(optionValueResource);
