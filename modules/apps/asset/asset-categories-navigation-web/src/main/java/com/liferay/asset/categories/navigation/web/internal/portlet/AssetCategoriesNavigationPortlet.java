...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + AssetCategoriesNavigationPortletKeys.CATEGORIES_NAV,
...
public class AssetCategoriesNavigationPortlet extends MVCPortlet {
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			AssetCategoriesNavigationPortletKeys.CATEGORIES_NAV,
