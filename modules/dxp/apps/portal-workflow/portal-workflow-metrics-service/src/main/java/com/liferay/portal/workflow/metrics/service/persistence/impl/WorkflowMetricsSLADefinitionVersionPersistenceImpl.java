...
public class WorkflowMetricsSLADefinitionVersionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByV_WMSLAD = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByV_WMSLAD",
			new String[] {String.class.getName(), Long.class.getName()},
			new String[] {"version", "wmSLADefinitionId"}, true);

		_finderPathCountByV_WMSLAD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByV_WMSLAD",
			new String[] {String.class.getName(), Long.class.getName()},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByWorkflowMetricsSLADefinitionId",
			_finderPathWithPaginationFindByWorkflowMetricsSLADefinitionId);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByWorkflowMetricsSLADefinitionId",
			_finderPathWithoutPaginationFindByWorkflowMetricsSLADefinitionId);

		_finderPaths.put(
			"finderPathCountByWorkflowMetricsSLADefinitionId",
			_finderPathCountByWorkflowMetricsSLADefinitionId);

		_finderPaths.put(
			"finderPathFetchByV_WMSLAD", _finderPathFetchByV_WMSLAD);

		_finderPaths.put(
			"finderPathCountByV_WMSLAD", _finderPathCountByV_WMSLAD);
