...
public class SearchResultManagerImpl implements SearchResultManager {
	...
	protected void activate(BundleContext bundleContext) {
		_searchResultContributorsServiceTrackerMap =
	...
	protected void deactivate() {
		_searchResultContributorsServiceTrackerMap.close();
	}
	...
	private SearchResultContributor _getSearchResultContributor(
		...
		return _searchResultContributorsServiceTrackerMap.getService(
			entryClassName);
	}
