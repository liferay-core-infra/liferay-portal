...
public class SyncDevicePersistenceImpl
	...
	public List<SyncDevice> findByUuid(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(SyncDeviceModelImpl.ORDER_BY_JPQL);
			}
	...
	protected SyncDevice getByUuid_PrevAndNext(
		...
		List<SyncDevice> list = query.list();
	...
	public List<SyncDevice> findByC_LikeU(
		...
		if (list == null) {
			...
			try {
				...
				if (bindUserName) {
					queryPos.add(StringUtil.toLowerCase(userName));
				}
	...
	public SyncDevice updateImpl(SyncDevice syncDevice) {
		...
		entityCache.putResult(
			SyncDeviceImpl.class, syncDeviceModelImpl, false, true);
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_LikeU = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_LikeU",
			new String[] {
