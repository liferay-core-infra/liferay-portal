...
public class NodeNameComparator extends OrderByComparator<WikiNode> {
	...
	public static NodeNameComparator get(boolean ascending) {
		if (ascending) {
			return _ASCENDING;
		}
	...
	private static final NodeNameComparator _ASCENDING = new NodeNameComparator(
		true);

	private static final NodeNameComparator _DESCENDING =
