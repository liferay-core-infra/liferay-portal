 ...
 * @author Tina Tian
 */
public class ShardedPortalCacheTest {
	...
	@Before
	public void setUp() {
		_shardedPortalCache = new ShardedPortalCache(
		...
		_shardedPortalCache.put(_TEST_KEY_1, _TEST_VALUE_1);

		_companyIdThreadLocal.set(_TEST_COMPANY_ID_2);

		_shardedPortalCache.put(_TEST_KEY_2, _TEST_VALUE_2);
	}
	...
	public void testGet() {
		...
		Assert.assertSame(_TEST_VALUE_1, _shardedPortalCache.get(_TEST_KEY_1));
		Assert.assertNull(_shardedPortalCache.get(_TEST_KEY_2));

		_companyIdThreadLocal.set(_TEST_COMPANY_ID_2);

		Assert.assertNull(_shardedPortalCache.get(_TEST_KEY_1));
		Assert.assertSame(_TEST_VALUE_2, _shardedPortalCache.get(_TEST_KEY_2));
	}
	...
	public void testMisc() {
		Assert.assertSame(
			_ehcachePortalCacheManager,
			_shardedPortalCache.getPortalCacheManager());

		Assert.assertEquals(
			_TEST_CACHE_NAME, _shardedPortalCache.getPortalCacheName());

		Assert.assertFalse(_shardedPortalCache.isMVCC());

		Set<EhcachePortalCache<?, ?>> ehcachePortalCaches =
			_shardedPortalCache.getEhcachePortalCaches();

		Assert.assertEquals(
			ehcachePortalCaches.toString(), 2, ehcachePortalCaches.size());

		Assert.assertTrue(_shardedPortalCache.isSharded());
	}
	...
	public void testPut() {
		...
		_shardedPortalCache.put(_TEST_KEY_2, _TEST_VALUE_1);

		Assert.assertSame(_TEST_VALUE_1, _shardedPortalCache.get(_TEST_KEY_2));
		...
		_shardedPortalCache.put(_TEST_KEY_1, _TEST_VALUE_2, 1000);
	...
	public void testPutIfAbsent() {
		...
		_shardedPortalCache.putIfAbsent(_TEST_KEY_1, _TEST_VALUE_2);

		Assert.assertSame(_TEST_VALUE_1, _shardedPortalCache.get(_TEST_KEY_1));

		Assert.assertNull(_shardedPortalCache.get(_TEST_KEY_2));

		_shardedPortalCache.putIfAbsent(_TEST_KEY_2, _TEST_VALUE_1);
		...
		_shardedPortalCache.putIfAbsent(_TEST_KEY_1, _TEST_VALUE_2, 1000);

		_assertTimeToLive(_TEST_COMPANY_ID_2, _TEST_KEY_1, _TEST_VALUE_2, 1000);

		_shardedPortalCache.putIfAbsent(_TEST_KEY_2, _TEST_VALUE_1, 1000);
	...
	public void testRegisterPortalCacheListener() {
		...
		_shardedPortalCache.registerPortalCacheListener(portalCacheListener1);
	...
	public void testRemove() {
		...
		_shardedPortalCache.remove(_TEST_KEY_1);
		...
		_shardedPortalCache.remove(_TEST_KEY_2);
		...
		_shardedPortalCache.remove(_TEST_KEY_2, _TEST_VALUE_2);

		Assert.assertSame(_TEST_VALUE_1, _shardedPortalCache.get(_TEST_KEY_2));

		_shardedPortalCache.remove(_TEST_KEY_2, _TEST_VALUE_1);
	...
	public void testRemoveAll() {
		...
		List<?> keys = _shardedPortalCache.getKeys();

		Assert.assertFalse(keys.isEmpty());

		_shardedPortalCache.removeAll();

		keys = _shardedPortalCache.getKeys();
	...
	public void testReplace() {
		...
		_shardedPortalCache.put(_TEST_KEY_1, _TEST_VALUE_2);

		_companyIdThreadLocal.set(_TEST_COMPANY_ID_1);

		Assert.assertSame(_TEST_VALUE_1, _shardedPortalCache.get(_TEST_KEY_1));

		_shardedPortalCache.replace(_TEST_KEY_1, _TEST_VALUE_2);

		Assert.assertSame(_TEST_VALUE_2, _shardedPortalCache.get(_TEST_KEY_1));

		_shardedPortalCache.replace(_TEST_KEY_1, _TEST_VALUE_2, _TEST_VALUE_1);

		Assert.assertSame(_TEST_VALUE_1, _shardedPortalCache.get(_TEST_KEY_1));

		_shardedPortalCache.replace(_TEST_KEY_1, _TEST_VALUE_2, 1000);

		_assertTimeToLive(_TEST_COMPANY_ID_1, _TEST_KEY_1, _TEST_VALUE_2, 1000);

		_shardedPortalCache.replace(
	...
	public void testUnregisterPortalCacheListener() {
		...
		_shardedPortalCache.registerPortalCacheListener(portalCacheListener2);
		...
		_shardedPortalCache.unregisterPortalCacheListener(portalCacheListener1);
		...
		_shardedPortalCache.unregisterPortalCacheListener(portalCacheListener2);
	...
	public void testUnregisterPortalCacheListeners() {
		...
		_shardedPortalCache.unregisterPortalCacheListeners();
	...
	private ShardedPortalCache _shardedPortalCache;
