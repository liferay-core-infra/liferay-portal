...
public class CalendarResourcePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_C = new FinderPath(
			...
			new String[] {"groupId", "code_"}, true, true);
		...
		_finderPathCountByG_C = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "code_"}, false, true);
		...
		_finderPathWithPaginationFindByC_LikeC_A = new FinderPath(
			...
			new String[] {"companyId", "code_", "active_"}, true, true);
		...
		_finderPathWithPaginationCountByC_LikeC_A = new FinderPath(
			...
			new String[] {"companyId", "code_", "active_"}, false, true);
