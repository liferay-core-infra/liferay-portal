...
public class SecurityEnabledRuleImplTest {
	...
	@Test
	public void testSecurityEnabledRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getSecurityEnabledRuleServiceReference(bundleContext);
		...
		try {
			...
			Assert.assertNotNull(result.getMessageParameters());
		}
		finally {
	...
	@Test
	public void testSecurityEnabledRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			SecurityEnabledRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getSecurityEnabledRuleServiceReference(BundleContext bundleContext)
		throws Exception {
	...
	private static final String _RULE_KEY = "security-enabled";
