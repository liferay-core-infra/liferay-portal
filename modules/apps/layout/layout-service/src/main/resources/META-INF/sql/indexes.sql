create unique index IX_4C18FD9B on LayoutClassedModelUsage (classNameId, classExternalReferenceCode[$COLUMN_LENGTH:500$], classPK, containerType, plid, groupId, containerKey[$COLUMN_LENGTH:200$], ctCollectionId);
create index IX_B041F1F5 on LayoutClassedModelUsage (classNameId, classPK, type_);
create index IX_82A5B647 on LayoutClassedModelUsage (classNameId, companyId, classExternalReferenceCode[$COLUMN_LENGTH:500$], type_);
