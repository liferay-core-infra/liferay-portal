...
public class CommercePriceListChannelRelUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByCCI_CPI() {

		return getPersistence().getFinderPathFetchByCCI_CPI();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByCCI_CPI() {

		return getPersistence().getFinderPathCountByCCI_CPI();
	}
