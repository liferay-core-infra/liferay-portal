...
public class PriceModifierCategoryResourceFactoryImpl
	implements PriceModifierCategoryResource.Factory {

	@Override
	public PriceModifierCategoryResource.Builder create() {
		return new PriceModifierCategoryResource.Builder() {
			...
			@Override
			public PriceModifierCategoryResource.Builder checkPermissions(
			...
			@Override
			public PriceModifierCategoryResource.Builder httpServletRequest(
			...
			@Override
			public PriceModifierCategoryResource.Builder httpServletResponse(
			...
			@Override
			public PriceModifierCategoryResource.Builder preferredLocale(
			...
			@Override
			public PriceModifierCategoryResource.Builder user(User user) {
				_user = user;
