 ...
 */
@Component(
	service = {KaleoNotificationPersistence.class, BasePersistence.class}
)
public class KaleoNotificationPersistenceImpl
	...
	@Reference
	private KaleoNotificationModelArgumentsResolver
		_kaleoNotificationModelArgumentsResolver;
