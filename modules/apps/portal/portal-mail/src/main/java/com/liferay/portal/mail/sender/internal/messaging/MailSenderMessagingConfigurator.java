 ...
 */
@Component(
	configurationPid = "com.liferay.portal.mail.sender.internal.configuration.MailSenderMessagingConfiguration",
	immediate = true, service = {}
)
public class MailSenderMessagingConfigurator {
	...
	protected void activate(
		...
		destinationConfiguration.setWorkersCoreSize(
			mailSenderMessagingConfiguration.workersCoreSize());
		destinationConfiguration.setWorkersMaxSize(
			mailSenderMessagingConfiguration.workersMaxSize());
