...
@Component(
	service = {
		CommercePriceListDiscountRelPersistence.class, BasePersistence.class
	}
)
public class CommercePriceListDiscountRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByCDI_CPI = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByCDI_CPI",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"commerceDiscountId", "commercePriceListId"}, true);

		_finderPathCountByCDI_CPI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCDI_CPI",
			new String[] {Long.class.getName(), Long.class.getName()},
		...
		_finderPaths.put("finderPathFetchByCDI_CPI", _finderPathFetchByCDI_CPI);

		_finderPaths.put("finderPathCountByCDI_CPI", _finderPathCountByCDI_CPI);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommercePriceListDiscountRel>> resultMap =
				new HashMap<>();
			...
			for (CommercePriceListDiscountRel commercePriceListDiscountRel :
				...
				if (Objects.equals(
					...
					List<CommercePriceListDiscountRel> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commercePriceListDiscountRel);
				}
			}

			for (Map.Entry<List<Object>, List<CommercePriceListDiscountRel>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommercePriceListDiscountRel> value =
	...
	@Reference
	private CommercePriceListDiscountRelModelArgumentsResolver
		_commercePriceListDiscountRelModelArgumentsResolver;
