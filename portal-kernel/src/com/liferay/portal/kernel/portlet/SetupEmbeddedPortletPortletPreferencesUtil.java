...
public class SetupEmbeddedPortletPortletPreferencesUtil {
	...
	public static boolean createEmbeddedPortletPortletPreferences(
			String portletId, Portlet portlet, boolean portletEmbedded,
			String defaultPreferences, HttpServletRequest httpServletRequest)
		throws Exception {
