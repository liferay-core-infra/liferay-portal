create unique index IX_17295166 on ListTypeDefinition (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create index IX_8FB531BD on ListTypeEntry (externalReferenceCode[$COLUMN_LENGTH:500$]);
