...
public class SidecarDetectionRuleImplTest {
	...
	@Test
	public void testSidecarDetectionRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getSidecarDetectionRuleServiceReference(bundleContext);
	...
	@Test
	public void testSidecarDetectionRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			SidecarDetectionRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getSidecarDetectionRuleServiceReference(
	...
	private static final String _RULE_KEY = "sidecar-detection";
