create index IX_F30945DE on SExperienceAudienceEntryRel (audienceEntryERC[$COLUMN_LENGTH:500$], companyId);
create unique index IX_D9AF73C2 on SExperienceAudienceEntryRel (groupId, audienceEntryERC[$COLUMN_LENGTH:500$], segmentsExperienceERC[$COLUMN_LENGTH:500$], ctCollectionId);
create index IX_9B8A5E80 on SExperienceAudienceEntryRel (groupId, segmentsExperienceERC[$COLUMN_LENGTH:500$]);
...
create unique index IX_E42D8589 on SegmentsEntry (groupId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
...
create unique index IX_ED3A5441 on SegmentsExperience (groupId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
...
create index IX_F35DC382 on SegmentsExperience (groupId, plid, segmentsEntryERC[$COLUMN_LENGTH:500$], segmentsEntryScopeERC[$COLUMN_LENGTH:500$], active_);
create unique index IX_8ED0881E on SegmentsExperience (groupId, plid, segmentsExperienceKey[$COLUMN_LENGTH:75$], ctCollectionId);
create index IX_2C43E1D2 on SegmentsExperience (groupId, segmentsEntryERC[$COLUMN_LENGTH:500$], segmentsEntryScopeERC[$COLUMN_LENGTH:500$]);
create unique index IX_E606CEB8 on SegmentsExperience (groupId, uuid_[$COLUMN_LENGTH:75$], ctCollectionId);
create index IX_544A601C on SegmentsExperience (segmentsEntryERC[$COLUMN_LENGTH:500$], segmentsEntryScopeERC[$COLUMN_LENGTH:500$]);
