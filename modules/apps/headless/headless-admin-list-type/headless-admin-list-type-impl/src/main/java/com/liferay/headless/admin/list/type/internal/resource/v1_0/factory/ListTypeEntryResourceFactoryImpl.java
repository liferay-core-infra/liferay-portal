...
public class ListTypeEntryResourceFactoryImpl
	...
	@Override
	public ListTypeEntryResource.Builder create() {
		return new ListTypeEntryResource.Builder() {
			...
			@Override
			public ListTypeEntryResource.Builder checkPermissions(
			...
			@Override
			public ListTypeEntryResource.Builder httpServletRequest(
			...
			@Override
			public ListTypeEntryResource.Builder httpServletResponse(
			...
			@Override
			public ListTypeEntryResource.Builder preferredLocale(
			...
			@Override
			public ListTypeEntryResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ListTypeEntryResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ListTypeEntryResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, ListTypeEntryResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ListTypeEntryResource.class.getClassLoader(),
			ListTypeEntryResource.class);

		try {
			Constructor<ListTypeEntryResource> constructor =
				(Constructor<ListTypeEntryResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(listTypeEntryResource);
