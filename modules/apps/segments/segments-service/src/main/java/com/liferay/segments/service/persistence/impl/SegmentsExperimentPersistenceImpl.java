 ...
 */
@Component(
	service = {SegmentsExperimentPersistence.class, BasePersistence.class}
)
public class SegmentsExperimentPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByS_C_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByS_C_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByS_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"segmentsExperienceId", "classNameId", "classPK"},
		...
		_finderPathCountByS_C_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByS_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			new String[] {"segmentsExperienceId", "classNameId", "classPK"},
		...
		_finderPathWithPaginationFindByS_C_C_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_C_C_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByS_C_C_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByS_C_C_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByS_C_C_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByS_C_C_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathWithPaginationCountByS_C_C_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByS_C_C_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindBySegmentsExperimentKey",
			_finderPathWithPaginationFindBySegmentsExperimentKey);

		_finderPaths.put(
			"finderPathWithoutPaginationFindBySegmentsExperimentKey",
			_finderPathWithoutPaginationFindBySegmentsExperimentKey);

		_finderPaths.put(
			"finderPathCountBySegmentsExperimentKey",
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByS_C_C",
			_finderPathWithPaginationFindByS_C_C);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByS_C_C",
			_finderPathWithoutPaginationFindByS_C_C);

		_finderPaths.put("finderPathCountByS_C_C", _finderPathCountByS_C_C);

		_finderPaths.put(
			"finderPathWithPaginationFindByS_C_C_S",
			_finderPathWithPaginationFindByS_C_C_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByS_C_C_S",
			_finderPathWithoutPaginationFindByS_C_C_S);

		_finderPaths.put("finderPathCountByS_C_C_S", _finderPathCountByS_C_C_S);

		_finderPaths.put(
			"finderPathWithPaginationCountByS_C_C_S",
			_finderPathWithPaginationCountByS_C_C_S);
