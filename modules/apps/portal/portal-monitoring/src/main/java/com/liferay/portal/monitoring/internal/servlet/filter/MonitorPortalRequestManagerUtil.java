 ...
 */
public class MonitorPortalRequestManagerUtil {

	public static boolean isMonitorPortalRequest() {
		return _monitorPortalRequest;
	}

	public static void setMonitorPortalRequest(boolean monitorPortalRequest) {
