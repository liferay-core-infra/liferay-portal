...
create unique index IX_222127D1 on SiteNavigationMenu (groupId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
...
create unique index IX_16568744 on SiteNavigationMenuItem (groupId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
