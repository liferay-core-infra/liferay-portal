...
public class FieldMappingInfoResourceFactoryImpl
	...
	@Override
	public FieldMappingInfoResource.Builder create() {
		return new FieldMappingInfoResource.Builder() {
			...
			public FieldMappingInfoResource build() {
				...
				return _fieldMappingInfoResourceProxyProviderFunction.apply(
			...
			@Override
			public FieldMappingInfoResource.Builder checkPermissions(
			...
			@Override
			public FieldMappingInfoResource.Builder httpServletRequest(
			...
			@Override
			public FieldMappingInfoResource.Builder httpServletResponse(
			...
			@Override
			public FieldMappingInfoResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(fieldMappingInfoResource);
	...
	private static final Function<InvocationHandler, FieldMappingInfoResource>
