...
public class RenameFinderColumnEntryWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("renameFinderEntryId", getRenameFinderEntryId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Long renameFinderEntryId = (Long)attributes.get("renameFinderEntryId");

		if (renameFinderEntryId != null) {
			setRenameFinderEntryId(renameFinderEntryId);
		}
	...
	/**
	 * Returns the rename finder entry ID of this rename finder column entry.
	 *
	 * @return the rename finder entry ID of this rename finder column entry
	 */
	@Override
	public long getRenameFinderEntryId() {
		return model.getRenameFinderEntryId();
	}
	...
	/**
	 * Sets the rename finder entry ID of this rename finder column entry.
	 *
	 * @param renameFinderEntryId the rename finder entry ID of this rename finder column entry
	 */
	@Override
	public void setRenameFinderEntryId(long renameFinderEntryId) {
		model.setRenameFinderEntryId(renameFinderEntryId);
	}
