	...
	public void activate() {
		...
		_finderPathWithPaginationFindByWorkflowMetricsSLADefinitionId =
			new FinderPath(
				...
				new String[] {"wmSLADefinitionId"}, true, true);
