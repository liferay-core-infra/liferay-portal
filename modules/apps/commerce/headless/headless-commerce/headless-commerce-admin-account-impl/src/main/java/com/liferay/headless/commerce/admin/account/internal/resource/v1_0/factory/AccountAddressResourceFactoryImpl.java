...
@Generated("")
public class AccountAddressResourceFactoryImpl
	implements AccountAddressResource.Factory {

	@Override
	public AccountAddressResource.Builder create() {
		return new AccountAddressResource.Builder() {
			...
			public AccountAddressResource build() {
				...
				return _accountAddressResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountAddressResource.Builder checkPermissions(
			...
			@Override
			public AccountAddressResource.Builder httpServletRequest(
			...
			@Override
			public AccountAddressResource.Builder httpServletResponse(
			...
			@Override
			public AccountAddressResource.Builder preferredLocale(
			...
			@Override
			public AccountAddressResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		AccountAddressResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		AccountAddressResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, AccountAddressResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AccountAddressResource.class.getClassLoader(),
			AccountAddressResource.class);

		try {
			Constructor<AccountAddressResource> constructor =
				(Constructor<AccountAddressResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(accountAddressResource);
	...
	private static final Function<InvocationHandler, AccountAddressResource>
		_accountAddressResourceProxyProviderFunction =
			_getProxyProviderFunction();
