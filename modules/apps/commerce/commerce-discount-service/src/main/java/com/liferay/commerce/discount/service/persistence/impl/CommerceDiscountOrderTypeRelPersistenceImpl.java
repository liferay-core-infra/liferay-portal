...
@Component(
	service = {
		CommerceDiscountOrderTypeRelPersistence.class, BasePersistence.class
	}
)
public class CommerceDiscountOrderTypeRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByCDI_COTI = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByCDI_COTI",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"commerceDiscountId", "commerceOrderTypeId"}, true);

		_finderPathCountByCDI_COTI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCDI_COTI",
			new String[] {Long.class.getName(), Long.class.getName()},
		...
		_finderPaths.put(
			"finderPathFetchByCDI_COTI", _finderPathFetchByCDI_COTI);

		_finderPaths.put(
			"finderPathCountByCDI_COTI", _finderPathCountByCDI_COTI);
	...
	@Reference
	private CommerceDiscountOrderTypeRelModelArgumentsResolver
		_commerceDiscountOrderTypeRelModelArgumentsResolver;
