...
public class ${entity.name}PersistenceImpl extends BasePersistenceImpl<${entity.name}> implements ${entity.name}Persistence {
	...
	<#if entity.isPermissionCheckEnabled()>
		...
		<#else>
			private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "${entity.table}.${entity.filterPKEntityColumn.DBName}";

			private static final String _FILTER_SQL_SELECT_${entity.alias?upper_case}_WHERE = "SELECT DISTINCT {${entity.table}.*} FROM ${entity.table} WHERE ";
			...
			private static final String _FILTER_SQL_COUNT_${entity.alias?upper_case}_WHERE = "SELECT COUNT(DISTINCT ${entity.table}.${entity.PKDBName}) AS COUNT_VALUE FROM ${entity.table} WHERE ";
