...
public class WorkflowMetricsRESTTestHelper {
	...
	public Node addNode(
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(companyId, "node"),
	...
	public Process addProcess(long companyId, Process process)
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(companyId, "process"),
	...
	public Task addTask(
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(
				addTaskRequest.getCompanyId(), "task"),
		...
		if (!addTaskRequest.isCompleted()) {
			_assertCount(
				...
				1,
				_workflowMetricsIndexNameBuilder.getIndexName(
					addTaskRequest.getCompanyId(), "instance"),
	...
	public Task addTask(long companyId, Instance instance, Task task, User user)
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(companyId, "task"),
	...
	public void restoreProcess(Document document) throws Exception {
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(
				document.getLong("companyId"), "process"),
