 ...
 * @author Lily Chi
 */
public class JMXConfigurationDisabledRuleImplTest {
	...
	@Test
	public void testCheckReturnsFailWhenJMXRemoteIsEnabled() {
		_assertCheckResult(
			Arrays.asList("-Xmx2g", "-Dcom.sun.management.jmxremote"),
			Result.Status.FAIL, _MESSAGE_KEY_FAIL,
			"JMX Configuration has been enabled " +
				"(-Dcom.sun.management.jmxremote)");
	}

	@Test
	public void testCheckReturnsFailWhenJMXRemotePortIsSet() {
		_assertCheckResult(
			Arrays.asList("-Xmx2g", "-Dcom.sun.management.jmxremote.port=9010"),
			Result.Status.FAIL, _MESSAGE_KEY_FAIL,
			"JMX Configuration has been enabled " +
	...
	@Test
	public void testCheckReturnsPassWhenJMXRemoteIsNotPresent() {
		_assertCheckResult(
	...
	private void _assertCheckResult(
		...
		try (MockedStatic<ManagementFactory> managementFactoryMockedStatic =
			...
			Collection<Result> results =
				_jmxConfigurationDisabledRuleImpl.check(0L);
	...
	private final JMXConfigurationDisabledRuleImpl
		_jmxConfigurationDisabledRuleImpl =
			new JMXConfigurationDisabledRuleImpl();
