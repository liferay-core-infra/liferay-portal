...
public class DisablingWildcardsRuleImplTest {
	...
	public void testCheckReturnsFail() {
		Collection<Result> results = _disablingWildcardsRuleImpl.check(0L);
	...
	private final DisablingWildcardsRuleImpl _disablingWildcardsRuleImpl =
		new DisablingWildcardsRuleImpl();
