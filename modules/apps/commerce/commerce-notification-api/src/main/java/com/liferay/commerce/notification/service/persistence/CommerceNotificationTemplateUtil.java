...
public class CommerceNotificationTemplateUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByG_E() {

		return getPersistence().getFinderPathWithPaginationFindByG_E();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByG_E() {

		return getPersistence().getFinderPathWithoutPaginationFindByG_E();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByG_T_E() {

		return getPersistence().getFinderPathWithPaginationFindByG_T_E();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByG_T_E() {

		return getPersistence().getFinderPathWithoutPaginationFindByG_T_E();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByG_T_E() {

		return getPersistence().getFinderPathCountByG_T_E();
	}
