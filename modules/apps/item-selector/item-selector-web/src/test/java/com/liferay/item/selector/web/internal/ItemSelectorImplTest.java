...
public class ItemSelectorImplTest {
	...
	public void tearDown() {
		if ((_flickrItemSelectorCriterionHandlerServiceRegistration != null) ||
			(_mediaItemSelectorCriterionHandlerServiceRegistration != null)) {

			_itemSelectorImpl.deactivate();

			_flickrItemSelectorCriterionHandlerServiceRegistration.unregister();

			_flickrItemSelectorCriterionHandlerServiceRegistration = null;
