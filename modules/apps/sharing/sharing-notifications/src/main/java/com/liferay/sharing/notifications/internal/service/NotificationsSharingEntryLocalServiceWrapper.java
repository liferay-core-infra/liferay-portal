...
public class NotificationsSharingEntryLocalServiceWrapper
	...
	private String _getNotificationMessage(
		...
		if (sharingEntry.getExpirationDate() == null) {
			...
			expirationDateText = expirationDateFormat.format(
