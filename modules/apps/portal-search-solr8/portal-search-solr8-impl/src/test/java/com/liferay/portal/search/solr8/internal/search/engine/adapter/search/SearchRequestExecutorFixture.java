...
public class SearchRequestExecutorFixture {
	...
	public void tearDown() {
		if (_baseSolrQueryAssemblerImpl != null) {
			try {
				_baseSolrQueryAssemblerImpl.deactivate();
			}
			catch (Exception exception) {
			}
			finally {
				_baseSolrQueryAssemblerImpl = null;
			}
		}
	}
	...
	protected static void createBaseSolrQueryAssembler(
	...
	protected static CountSearchRequestExecutor
		createCountSearchRequestExecutor(SolrClientManager solrClientManager) {
	...
	protected static SearchSearchRequestExecutor
		createSearchSearchRequestExecutor(SolrClientManager solrClientManager) {
	...
	private static BaseSolrQueryAssemblerImpl _baseSolrQueryAssemblerImpl;
