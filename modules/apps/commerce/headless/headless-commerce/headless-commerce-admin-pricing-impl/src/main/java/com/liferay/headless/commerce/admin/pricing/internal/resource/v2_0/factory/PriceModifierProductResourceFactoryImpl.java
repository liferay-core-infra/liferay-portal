...
@Generated("")
public class PriceModifierProductResourceFactoryImpl
	implements PriceModifierProductResource.Factory {

	@Override
	public PriceModifierProductResource.Builder create() {
		return new PriceModifierProductResource.Builder() {
			...
			public PriceModifierProductResource build() {
				...
				return _priceModifierProductResourceProxyProviderFunction.apply(
			...
			@Override
			public PriceModifierProductResource.Builder checkPermissions(
			...
			@Override
			public PriceModifierProductResource.Builder httpServletRequest(
			...
			@Override
			public PriceModifierProductResource.Builder httpServletResponse(
			...
			@Override
			public PriceModifierProductResource.Builder preferredLocale(
			...
			@Override
			public PriceModifierProductResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PriceModifierProductResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PriceModifierProductResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, PriceModifierProductResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PriceModifierProductResource.class.getClassLoader(),
			PriceModifierProductResource.class);

		try {
			Constructor<PriceModifierProductResource> constructor =
				(Constructor<PriceModifierProductResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(priceModifierProductResource);
	...
	private static final Function
		<InvocationHandler, PriceModifierProductResource>
			_priceModifierProductResourceProxyProviderFunction =
				_getProxyProviderFunction();
