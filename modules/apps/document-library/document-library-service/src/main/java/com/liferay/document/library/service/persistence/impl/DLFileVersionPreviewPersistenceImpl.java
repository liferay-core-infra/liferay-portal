...
public class DLFileVersionPreviewPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByF_F = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByF_F",
		...
		_finderPathFetchByF_F_P = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByF_F_P",
			new String[] {
		...
		_finderPathCountByF_F_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_F_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPaths.put("finderPathFetchByF_F", _finderPathFetchByF_F);

		_finderPaths.put("finderPathCountByF_F", _finderPathCountByF_F);

		_finderPaths.put("finderPathFetchByF_F_P", _finderPathFetchByF_F_P);

		_finderPaths.put("finderPathCountByF_F_P", _finderPathCountByF_F_P);
