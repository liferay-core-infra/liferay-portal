...
JavaServiceHopCheck | .java | Flags a service method that delegates to a same-bundle service pass-through method, so it can call persistence directly and skip the AOP proxy hop. |
