...
import com.liferay.portal.tools.service.builder.test.compat710.model.ERCVersionedEntryModel;
...
public class ERCVersionedEntryModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table ERCVersionedEntry (uuid_ VARCHAR(75) null,externalReferenceCode VARCHAR(500) null,ercVersionedEntryId LONG not null primary key,groupId LONG,companyId LONG)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(
		com.liferay.portal.tools.service.builder.test.compat710.service.util.
			ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.portal.tools.service.builder.test.compat710.model.ERCVersionedEntry"),
		true);

	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(
		com.liferay.portal.tools.service.builder.test.compat710.service.util.
			ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.portal.tools.service.builder.test.compat710.model.ERCVersionedEntry"),
		true);

	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(
		com.liferay.portal.tools.service.builder.test.compat710.service.util.
			ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.portal.tools.service.builder.test.compat710.model.ERCVersionedEntry"),
		true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.liferay.portal.tools.service.builder.test.compat710.service.util.
			ServiceProps.get(
				"lock.expiration.time.com.liferay.portal.tools.service.builder.test.compat710.model.ERCVersionedEntry"));
	...
	private static Function<InvocationHandler, ERCVersionedEntry>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ERCVersionedEntry.class.getClassLoader(), ERCVersionedEntry.class,
			ModelWrapper.class);

		try {
			Constructor<ERCVersionedEntry> constructor =
				(Constructor<ERCVersionedEntry>)proxyClass.getConstructor(
	...
	static {
		...
		attributeGetterFunctions.put(
			"uuid",
			new Function<ERCVersionedEntry, Object>() {

				@Override
				public Object apply(ERCVersionedEntry ercVersionedEntry) {
					return ercVersionedEntry.getUuid();
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<ERCVersionedEntry, Object>() {
				...
				@Override
				public Object apply(ERCVersionedEntry ercVersionedEntry) {
					return ercVersionedEntry.getExternalReferenceCode();
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<ERCVersionedEntry, Object>() {
				...
				@Override
				public Object apply(ERCVersionedEntry ercVersionedEntry) {
					return ercVersionedEntry.getGroupId();
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<ERCVersionedEntry, Object>() {
				...
				@Override
				public Object apply(ERCVersionedEntry ercVersionedEntry) {
					return ercVersionedEntry.getCompanyId();
				}
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"uuid",
			new BiConsumer<ERCVersionedEntry, Object>() {

				@Override
				public void accept(
					ERCVersionedEntry ercVersionedEntry, Object uuidObject) {

					ercVersionedEntry.setUuid((String)uuidObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ERCVersionedEntry, Object>() {
				...
				public void accept(
					ERCVersionedEntry ercVersionedEntry,
					Object ercVersionedEntryIdObject) {

					ercVersionedEntry.setErcVersionedEntryId(
						(Long)ercVersionedEntryIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ERCVersionedEntry, Object>() {
				...
				@Override
				public void accept(
					ERCVersionedEntry ercVersionedEntry, Object groupIdObject) {

					ercVersionedEntry.setGroupId((Long)groupIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ERCVersionedEntry, Object>() {
				...
				public void accept(
					...
					ercVersionedEntry.setCompanyId((Long)companyIdObject);
				}
...
// LIFERAY-SERVICE-BUILDER-HASH:-245180285