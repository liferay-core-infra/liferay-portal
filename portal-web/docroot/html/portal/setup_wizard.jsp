					...
					<c:choose>
						<c:when test="<%= GetterUtil.getBoolean((Boolean)session.getAttribute(WebKeys.SETUP_WIZARD_PROPERTIES_FILE_CREATED)) %>">
							...
							<p class="lfr-setup-notice">
								...
								<%
								String taglibArguments = "<span class=\"lfr-inline-code\">" + SystemProperties.LIFERAY_HOME + StringPool.SLASH + SetupWizardUtil.PROPERTIES_FILE_NAME + "</span>";
								%>
						...
						<c:otherwise>
							<p>
								<div class="alert alert-warning">
									...
									<%
									String taglibArguments = "<span class=\"lfr-inline-code\">" + SystemProperties.LIFERAY_HOME + "</span>";
									%>
