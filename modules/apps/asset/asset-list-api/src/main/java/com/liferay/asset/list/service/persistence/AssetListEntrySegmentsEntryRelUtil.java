...
public class AssetListEntrySegmentsEntryRelUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByA_S() {

		return getPersistence().getFinderPathFetchByA_S();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByA_S_C() {

		return getPersistence().getFinderPathWithPaginationFindByA_S_C();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByA_S_C() {

		return getPersistence().getFinderPathWithoutPaginationFindByA_S_C();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByA_S_C() {

		return getPersistence().getFinderPathCountByA_S_C();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationCountByA_S_C() {

		return getPersistence().getFinderPathWithPaginationCountByA_S_C();
	}
