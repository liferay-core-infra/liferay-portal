...
public class DisablingWildcardsRuleImplTest {
	...
	@Test
	public void testDisablingWildcardsRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getDisablingWildcardsRuleServiceReference(bundleContext);
	...
	@Test
	public void testDisablingWildcardsRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			DisablingWildcardsRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getDisablingWildcardsRuleServiceReference(
	...
	private static final String _RULE_KEY = "disable-wildcards";
