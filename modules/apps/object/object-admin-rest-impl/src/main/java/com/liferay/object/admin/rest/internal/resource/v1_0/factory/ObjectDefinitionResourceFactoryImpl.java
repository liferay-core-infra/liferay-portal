...
public class ObjectDefinitionResourceFactoryImpl
	...
	@Override
	public ObjectDefinitionResource.Builder create() {
		return new ObjectDefinitionResource.Builder() {
			...
			@Override
			public ObjectDefinitionResource.Builder checkPermissions(
			...
			@Override
			public ObjectDefinitionResource.Builder httpServletRequest(
			...
			@Override
			public ObjectDefinitionResource.Builder httpServletResponse(
			...
			@Override
			public ObjectDefinitionResource.Builder preferredLocale(
			...
			@Override
			public ObjectDefinitionResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ObjectDefinitionResource>
		...
		try {
			Constructor<ObjectDefinitionResource> constructor =
				(Constructor<ObjectDefinitionResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(objectDefinitionResource);
