...
@Generated("")
public class PriceListAccountResourceFactoryImpl
	implements PriceListAccountResource.Factory {

	@Override
	public PriceListAccountResource.Builder create() {
		return new PriceListAccountResource.Builder() {
			...
			@Override
			public PriceListAccountResource.Builder checkPermissions(
			...
			@Override
			public PriceListAccountResource.Builder httpServletRequest(
			...
			@Override
			public PriceListAccountResource.Builder httpServletResponse(
			...
			@Override
			public PriceListAccountResource.Builder preferredLocale(
			...
			@Override
			public PriceListAccountResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PriceListAccountResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PriceListAccountResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, PriceListAccountResource>
		...
		try {
			Constructor<PriceListAccountResource> constructor =
				(Constructor<PriceListAccountResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(priceListAccountResource);
