...
public class UserGroupResourceFactoryImpl implements UserGroupResource.Factory {
	...
	public UserGroupResource.Builder create() {
		return new UserGroupResource.Builder() {
			...
			public UserGroupResource build() {
				...
				return _userGroupResourceProxyProviderFunction.apply(
	...
	protected void activate() {
		UserGroupResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		UserGroupResource.FactoryHolder.factory = null;
	}
	...
	private static final Function<InvocationHandler, UserGroupResource>
		_userGroupResourceProxyProviderFunction = _getProxyProviderFunction();
