...
@Component(
	service = {
		LayoutPageTemplateCollectionPersistence.class, BasePersistence.class
	}
)
public class LayoutPageTemplateCollectionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByG_LPTCK = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByG_LPTCK",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "lptCollectionKey"}, true);

		_finderPathCountByG_LPTCK = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_LPTCK",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPaths.put("finderPathFetchByG_LPTCK", _finderPathFetchByG_LPTCK);

		_finderPaths.put("finderPathCountByG_LPTCK", _finderPathCountByG_LPTCK);
