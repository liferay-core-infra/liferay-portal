...
public class GarbageCollectorTypeRuleImplTest {
	...
	@Test
	public void testGarbageCollectorTypeRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getGarbageCollectorTypeRuleServiceReference(bundleContext);
	...
	@Test
	public void testGarbageCollectorTypeRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			GarbageCollectorTypeRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getGarbageCollectorTypeRuleServiceReference(
	...
	private static final String _RULE_KEY = "garbage-collector-type";
