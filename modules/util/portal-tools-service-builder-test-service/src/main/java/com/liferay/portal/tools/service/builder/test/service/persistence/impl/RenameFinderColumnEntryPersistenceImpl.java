...
public class RenameFinderColumnEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByColumnToRename = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByColumnToRename",
		...
		_finderPathCountByColumnToRename = new FinderPath(
			...
			"countByColumnToRename", new String[] {String.class.getName()},
		...
		_finderPaths.put(
			"finderPathFetchByColumnToRename",
			_finderPathFetchByColumnToRename);

		_finderPaths.put(
			"finderPathCountByColumnToRename",
			_finderPathCountByColumnToRename);
