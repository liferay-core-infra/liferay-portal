...
public class HeapAllocationConsistencyRuleImplTest {
	...
	@Test
	public void testHeapAllocationConsistencyRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getHeapAllocationConsistencyRuleServiceReference(bundleContext);
	...
	@Test
	public void testHeapAllocationConsistencyRuleIsRegistered()
		throws Exception {
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			HeapAllocationConsistencyRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getHeapAllocationConsistencyRuleServiceReference(
	...
	private static final String _RULE_KEY = "heap-allocation-consistency";
