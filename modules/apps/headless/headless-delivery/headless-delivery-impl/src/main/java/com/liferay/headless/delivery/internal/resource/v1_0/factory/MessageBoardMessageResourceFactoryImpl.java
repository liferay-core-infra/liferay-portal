...
public class MessageBoardMessageResourceFactoryImpl
	implements MessageBoardMessageResource.Factory {

	@Override
	public MessageBoardMessageResource.Builder create() {
		return new MessageBoardMessageResource.Builder() {
			...
			@Override
			public MessageBoardMessageResource.Builder checkPermissions(
			...
			@Override
			public MessageBoardMessageResource.Builder httpServletRequest(
			...
			@Override
			public MessageBoardMessageResource.Builder httpServletResponse(
			...
			@Override
			public MessageBoardMessageResource.Builder preferredLocale(
			...
			@Override
			public MessageBoardMessageResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		MessageBoardMessageResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		MessageBoardMessageResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, MessageBoardMessageResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			MessageBoardMessageResource.class.getClassLoader(),
			MessageBoardMessageResource.class);

		try {
			Constructor<MessageBoardMessageResource> constructor =
				(Constructor<MessageBoardMessageResource>)
