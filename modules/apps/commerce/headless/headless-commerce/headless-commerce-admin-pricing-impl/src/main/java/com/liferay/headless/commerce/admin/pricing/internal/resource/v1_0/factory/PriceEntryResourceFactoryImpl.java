...
public class PriceEntryResourceFactoryImpl
	...
	public PriceEntryResource.Builder create() {
		return new PriceEntryResource.Builder() {
			...
			public PriceEntryResource build() {
				...
				return _priceEntryResourceProxyProviderFunction.apply(
			...
			@Override
			public PriceEntryResource.Builder httpServletRequest(
			...
			@Override
			public PriceEntryResource.Builder httpServletResponse(
			...
			@Override
			public PriceEntryResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, PriceEntryResource>
		...
		try {
			Constructor<PriceEntryResource> constructor =
				(Constructor<PriceEntryResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, PriceEntryResource>
		_priceEntryResourceProxyProviderFunction = _getProxyProviderFunction();
