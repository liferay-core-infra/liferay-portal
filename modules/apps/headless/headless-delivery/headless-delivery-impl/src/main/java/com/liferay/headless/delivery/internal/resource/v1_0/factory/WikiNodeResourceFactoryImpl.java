...
public class WikiNodeResourceFactoryImpl implements WikiNodeResource.Factory {
	...
	public WikiNodeResource.Builder create() {
		return new WikiNodeResource.Builder() {
			...
			@Override
			public WikiNodeResource.Builder httpServletRequest(
			...
			@Override
			public WikiNodeResource.Builder httpServletResponse(
			...
			@Override
			public WikiNodeResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, WikiNodeResource>
		...
		try {
			Constructor<WikiNodeResource> constructor =
				(Constructor<WikiNodeResource>)proxyClass.getConstructor(
