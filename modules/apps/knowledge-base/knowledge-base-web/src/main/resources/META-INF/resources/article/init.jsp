...
<%
KBArticlePortletInstanceConfiguration kbArticlePortletInstanceConfiguration = ConfigurationProviderUtil.getPortletInstanceConfiguration(KBArticlePortletInstanceConfiguration.class, themeDisplay.getLayout(), portletDisplay.getPortletId());
