...
public class DDMStructurePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByStructureKey = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByStructureKey",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathFetchByG_C_S = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByG_C_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithPaginationFindByG_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_N_D",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_N_D",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
		...
		_finderPathCountByG_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_N_D",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_C_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_C_N_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_C_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_C_N_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName()
			},
		...
		_finderPathCountByG_C_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_C_N_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName()
			},
		...
		_finderPathWithPaginationCountByG_C_N_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_C_N_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByParentStructureId",
			_finderPathWithPaginationFindByParentStructureId);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByParentStructureId",
			_finderPathWithoutPaginationFindByParentStructureId);

		_finderPaths.put(
			"finderPathCountByParentStructureId",
			_finderPathCountByParentStructureId);

		_finderPaths.put(
			"finderPathWithPaginationFindByStructureKey",
			_finderPathWithPaginationFindByStructureKey);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByStructureKey",
			_finderPathWithoutPaginationFindByStructureKey);

		_finderPaths.put(
			"finderPathCountByStructureKey", _finderPathCountByStructureKey);
		...
		_finderPaths.put("finderPathFetchByG_C_S", _finderPathFetchByG_C_S);

		_finderPaths.put("finderPathCountByG_C_S", _finderPathCountByG_C_S);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_N_D",
			_finderPathWithPaginationFindByG_N_D);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_N_D",
			_finderPathWithoutPaginationFindByG_N_D);

		_finderPaths.put("finderPathCountByG_N_D", _finderPathCountByG_N_D);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_C_N_D",
			_finderPathWithPaginationFindByG_C_N_D);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_C_N_D",
			_finderPathWithoutPaginationFindByG_C_N_D);

		_finderPaths.put("finderPathCountByG_C_N_D", _finderPathCountByG_C_N_D);

		_finderPaths.put(
			"finderPathWithPaginationCountByG_C_N_D",
			_finderPathWithPaginationCountByG_C_N_D);
