...
public class SLAResultResourceFactoryImpl implements SLAResultResource.Factory {
	...
	@Override
	public SLAResultResource.Builder create() {
		return new SLAResultResource.Builder() {
			...
			@Override
			public SLAResultResource.Builder checkPermissions(
			...
			@Override
			public SLAResultResource.Builder httpServletRequest(
			...
			@Override
			public SLAResultResource.Builder httpServletResponse(
			...
			@Override
			public SLAResultResource.Builder preferredLocale(
	...
	protected void activate() {
		SLAResultResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		SLAResultResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, SLAResultResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SLAResultResource.class.getClassLoader(), SLAResultResource.class);

		try {
			Constructor<SLAResultResource> constructor =
				(Constructor<SLAResultResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(slaResultResource);
	...
	private ComponentServiceObjects<SLAResultResource> _componentServiceObjects;
