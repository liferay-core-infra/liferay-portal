...
import com.liferay.redirect.internal.provider.RedirectPatternEntriesRegisterUtil;
...
public class RedirectProviderManagedServiceFactory
	...
	public void updated(String pid, Dictionary<String, ?> dictionary)
		...
		RedirectPatternEntriesRegisterUtil.putRedirectPatternEntry(
			groupId,
	...
	private void _unmapPid(String pid) {
		if (_groupIds.containsKey(pid)) {
			...
			RedirectPatternEntriesRegisterUtil.removeRedirectPatternEntry(
				groupId);
		}
	}
