...
public class KaleoDefinitionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_S = new FinderPath(
			...
			new String[] {"companyId", "scope"}, true, true);
		...
		_finderPathCountByC_S = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "scope"}, false, true);
		...
		_finderPathFetchByC_N_V = new FinderPath(
			...
			new String[] {"companyId", "name", "version"}, true, true);
		...
		_finderPathCountByC_N_V = new FinderPath(
			...
			new String[] {"companyId", "name", "version"}, false, true);
		...
		_finderPathFetchByC_N_A = new FinderPath(
			...
			new String[] {"companyId", "name", "active_"}, true, true);
		...
		_finderPathCountByC_N_A = new FinderPath(
			...
			new String[] {"companyId", "name", "active_"}, false, true);
		...
		_finderPathWithPaginationFindByC_S_A = new FinderPath(
			...
			new String[] {"companyId", "scope", "active_"}, true, true);
		...
		_finderPathCountByC_S_A = new FinderPath(
			...
			new String[] {"companyId", "scope", "active_"}, false, true);
