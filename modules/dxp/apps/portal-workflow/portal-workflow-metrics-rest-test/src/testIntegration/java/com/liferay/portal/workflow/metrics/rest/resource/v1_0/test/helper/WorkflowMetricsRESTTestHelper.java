...
public class WorkflowMetricsRESTTestHelper {
	...
	public Instance addInstance(long companyId, Instance instance)
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(
				companyId, WorkflowMetricsIndexEntityName.INSTANCE),
	...
	public void addSLATaskResult(
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(
				companyId, WorkflowMetricsIndexEntityName.SLA_TASK_RESULT),
	...
	public Task addTask(
		...
		if (!addTaskRequest.isCompleted()) {
			_assertCount(
				...
				_workflowMetricsIndexNameBuilder.getIndexName(
					addTaskRequest.getCompanyId(),
					WorkflowMetricsIndexEntityName.INSTANCE),
	...
	public void blockSLAInstanceResults(
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(
				companyId, WorkflowMetricsIndexEntityName.SLA_INSTANCE_RESULT),
	...
	public void restoreProcess(Document document) throws Exception {
		...
		_assertCount(
			_workflowMetricsIndexNameBuilder.getIndexName(
				document.getLong("companyId"),
				WorkflowMetricsIndexEntityName.PROCESS),
