...
public class WorkflowMetricsIndexInitialRequestPortalInstanceLifecycleListener
	...
	private void _createIndex(Company company) throws Exception {
		...
		TransactionCommitCallbackUtil.registerCallback(
			() -> {
				...
				_backgroundTaskLocalService.addBackgroundTask(
					...
					WorkflowMetricsIndexPortalInstanceLifecycleListener.class.
						getSimpleName(),
	...
	private void _removeIndex(Company company) throws Exception {
