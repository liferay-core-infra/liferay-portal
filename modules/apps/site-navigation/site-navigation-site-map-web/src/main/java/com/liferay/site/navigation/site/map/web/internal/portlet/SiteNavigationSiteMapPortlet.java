...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + SiteNavigationSiteMapPortlet.ALIAS,
...
public class SiteNavigationSiteMapPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "site-map";

	@Activate
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, SiteNavigationSiteMapPortletKeys.SITE_NAVIGATION_SITE_MAP);
	}
