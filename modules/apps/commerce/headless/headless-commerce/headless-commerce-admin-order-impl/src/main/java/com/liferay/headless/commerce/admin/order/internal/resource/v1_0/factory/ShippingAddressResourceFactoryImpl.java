...
public class ShippingAddressResourceFactoryImpl
	...
	public ShippingAddressResource.Builder create() {
		return new ShippingAddressResource.Builder() {
			...
			@Override
			public ShippingAddressResource.Builder httpServletRequest(
			...
			@Override
			public ShippingAddressResource.Builder httpServletResponse(
			...
			@Override
			public ShippingAddressResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, ShippingAddressResource>
		...
		try {
			Constructor<ShippingAddressResource> constructor =
				(Constructor<ShippingAddressResource>)proxyClass.getConstructor(
