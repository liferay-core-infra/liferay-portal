 ...
 */
@Component(
	 immediate = true, service = AccountResource.Factory.class
)
@Generated("")
public class AccountResourceFactoryImpl implements AccountResource.Factory {

	@Override
	public AccountResource.Builder create() {
		return new AccountResource.Builder() {
			...
			@Override
			public AccountResource.Builder checkPermissions(
			...
			@Override
			public AccountResource.Builder httpServletRequest(
			...
			@Override
			public AccountResource.Builder httpServletResponse(
			...
			@Override
			public AccountResource.Builder preferredLocale(
	...
	protected void activate() {
		AccountResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		AccountResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(accountResource);
	...
	private ComponentServiceObjects<AccountResource> _componentServiceObjects;
