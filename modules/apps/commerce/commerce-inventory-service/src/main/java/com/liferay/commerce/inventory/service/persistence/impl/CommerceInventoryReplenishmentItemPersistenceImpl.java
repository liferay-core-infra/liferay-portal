...
public class CommerceInventoryReplenishmentItemPersistenceImpl
	...
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_3 =
		"(commerceInventoryReplenishmentItem.externalReferenceCode IS NULL OR commerceInventoryReplenishmentItem.externalReferenceCode = '')";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindBySku = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBySku",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathWithoutPaginationFindBySku = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBySku",
			new String[] {String.class.getName()}, new String[] {"sku"}, true);

		_finderPathCountBySku = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBySku",
		...
		_finderPathWithPaginationFindByS_AD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_AD",
			new String[] {
		...
		_finderPathWithoutPaginationFindByS_AD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByS_AD",
			new String[] {String.class.getName(), Date.class.getName()},
			new String[] {"sku", "availabilityDate"}, true);

		_finderPathCountByS_AD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByS_AD",
			new String[] {String.class.getName(), Date.class.getName()},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByAvailabilityDate",
			_finderPathWithPaginationFindByAvailabilityDate);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByAvailabilityDate",
			_finderPathWithoutPaginationFindByAvailabilityDate);

		_finderPaths.put(
			"finderPathCountByAvailabilityDate",
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByS_AD",
			_finderPathWithPaginationFindByS_AD);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByS_AD",
			_finderPathWithoutPaginationFindByS_AD);

		_finderPaths.put("finderPathCountByS_AD", _finderPathCountByS_AD);
