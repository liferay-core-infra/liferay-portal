 ...
 */
@Component(
	 immediate = true, service = CartItemResource.Factory.class
)
@Generated("")
public class CartItemResourceFactoryImpl implements CartItemResource.Factory {
	...
	public CartItemResource.Builder create() {
		return new CartItemResource.Builder() {
			...
			public CartItemResource build() {
				...
				return _cartItemResourceProxyProviderFunction.apply(
			...
			@Override
			public CartItemResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, CartItemResource>
		...
		try {
			Constructor<CartItemResource> constructor =
				(Constructor<CartItemResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, CartItemResource>
		_cartItemResourceProxyProviderFunction = _getProxyProviderFunction();
