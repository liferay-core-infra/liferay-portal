...
package com.liferay.recent.documents.web.internal.scheduler;
...
public class RecentDocumentsSchedulerJobConfiguration
	implements SchedulerJobConfiguration {

	@Override
	public UnsafeRunnable<Exception> getJobExecutor() {
		return _dLFileRankLocalService::checkFileRanks;
	}

	@Override
	public TriggerConfiguration getTriggerConfiguration() {
		return TriggerConfiguration.createTriggerConfiguration(
			_recentDocumentsConfiguration.checkFileRanksInterval(),
			TimeUnit.MINUTE);
	}

	@Activate
	protected void activate(Map<String, Object> properties) {
		_recentDocumentsConfiguration = ConfigurableUtil.createConfigurable(
	...
	private RecentDocumentsConfiguration _recentDocumentsConfiguration;
