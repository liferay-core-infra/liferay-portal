...
import com.liferay.portal.test.rule.FeatureFlagTestRule;
...
public class SchedulerEngineHelperTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			false, CompanyProviderClassTestRule.INSTANCE,
			DataGuardTestRule.INSTANCE,
			DeleteAfterTestRunMethodTestRule.INSTANCE,
			FeatureFlagTestRule.INSTANCE, InjectTestRule.INSTANCE,
			LogAssertionTestRule.INSTANCE, PortalRunModeClassTestRule.INSTANCE,
			SybaseDumpTransactionLogTestRule.INSTANCE, TimeoutTestRule.INSTANCE,
			UniqueStringRandomizerBumperClassTestRule.INSTANCE);
