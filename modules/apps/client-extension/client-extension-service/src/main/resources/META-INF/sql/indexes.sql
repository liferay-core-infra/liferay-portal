create unique index IX_EFD3CBF7 on ClientExtensionEntry (companyId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
...
create index IX_44C5316 on ClientExtensionEntryRel (companyId, cetExternalReferenceCode[$COLUMN_LENGTH:500$]);
create unique index IX_8C6A0432 on ClientExtensionEntryRel (groupId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
