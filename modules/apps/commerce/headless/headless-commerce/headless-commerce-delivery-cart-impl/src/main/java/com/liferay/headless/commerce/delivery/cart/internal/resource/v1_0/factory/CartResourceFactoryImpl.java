 ...
 */
@Component(
	 immediate = true, service = CartResource.Factory.class
)
@Generated("")
public class CartResourceFactoryImpl implements CartResource.Factory {
	...
	public CartResource.Builder create() {
		return new CartResource.Builder() {
			...
			public CartResource build() {
				...
				return _cartResourceProxyProviderFunction.apply(
	...
	private static Function<InvocationHandler, CartResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CartResource.class.getClassLoader(), CartResource.class);

		try {
			Constructor<CartResource> constructor =
				(Constructor<CartResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, CartResource>
		_cartResourceProxyProviderFunction = _getProxyProviderFunction();
