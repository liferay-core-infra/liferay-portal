...
public interface JavaConstants {
	...
	public static final String JAVAX_PORTLET_CONFIG = "jakarta.portlet.config";
	...
	public static final String JAVAX_PORTLET_SERVLET_CONTEXT =
		"jakarta.portlet.servletContext";

	public static final String JAVAX_PORTLET_SHORT_TITLE =
		"jakarta.portlet.short-title";

	public static final String JAVAX_PORTLET_TITLE = "jakarta.portlet.title";
