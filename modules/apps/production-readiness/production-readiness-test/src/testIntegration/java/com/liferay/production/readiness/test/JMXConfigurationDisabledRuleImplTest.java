...
public class JMXConfigurationDisabledRuleImplTest {
	...
	@Test
	public void testJMXConfigurationDisabledRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getJMXConfigurationDisabledRuleServiceReference(bundleContext);
	...
	@Test
	public void testJMXConfigurationDisabledRuleIsRegistered()
		throws Exception {
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			JMXConfigurationDisabledRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getJMXConfigurationDisabledRuleServiceReference(
	...
	private static final String _RULE_KEY = "jmx-configuration-disabled";
