...
public class SpecificationResourceFactoryImpl
	...
	public SpecificationResource.Builder create() {
		return new SpecificationResource.Builder() {
			...
			public SpecificationResource build() {
				...
				return _specificationResourceProxyProviderFunction.apply(
			...
			@Override
			public SpecificationResource.Builder httpServletRequest(
			...
			@Override
			public SpecificationResource.Builder httpServletResponse(
			...
			@Override
			public SpecificationResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, SpecificationResource>
		...
		try {
			Constructor<SpecificationResource> constructor =
				(Constructor<SpecificationResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, SpecificationResource>
		_specificationResourceProxyProviderFunction =
			_getProxyProviderFunction();
