...
public class CommerceInventoryWarehouseItemPersistenceImpl
	...
	public CommerceInventoryWarehouseItem updateImpl(
		...
		if (Validator.isNull(
			...
			commerceInventoryWarehouseItem.setExternalReferenceCode(
				String.valueOf(commerceInventoryWarehouseItem.getPrimaryKey()));
		}
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_S = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"commerceInventoryWarehouseId", "sku"}, true, true);

		_finderPathCountByC_S = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_S",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"commerceInventoryWarehouseId", "sku"}, false, true);
