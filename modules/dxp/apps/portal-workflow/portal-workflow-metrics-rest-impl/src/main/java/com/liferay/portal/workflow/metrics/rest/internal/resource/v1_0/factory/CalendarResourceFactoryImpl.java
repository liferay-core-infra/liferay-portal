...
public class CalendarResourceFactoryImpl implements CalendarResource.Factory {
	...
	@Override
	public CalendarResource.Builder create() {
		return new CalendarResource.Builder() {
			...
			@Override
			public CalendarResource.Builder checkPermissions(
			...
			@Override
			public CalendarResource.Builder httpServletRequest(
	...
	private ComponentServiceObjects<CalendarResource> _componentServiceObjects;
