...
public class LogResourceFactoryImpl implements LogResource.Factory {
	...
	public LogResource.Builder create() {
		return new LogResource.Builder() {
			...
			@Override
			public LogResource.Builder httpServletResponse(
	...
	private Object _invoke(
		...
		logResource.setContextHttpServletResponse(httpServletResponse);
		logResource.setContextUser(user);
		logResource.setExpressionConvert(_expressionConvert);
		logResource.setFilterParserProvider(_filterParserProvider);
		logResource.setGroupLocalService(_groupLocalService);
		logResource.setResourceActionLocalService(_resourceActionLocalService);
		logResource.setResourcePermissionLocalService(
			_resourcePermissionLocalService);
		logResource.setRoleLocalService(_roleLocalService);
