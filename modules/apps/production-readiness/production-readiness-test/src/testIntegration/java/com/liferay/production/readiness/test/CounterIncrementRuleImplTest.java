...
public class CounterIncrementRuleImplTest {
	...
	@Test
	public void testCounterIncrementRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getCounterIncrementRuleServiceReference(bundleContext);
	...
	@Test
	public void testCounterIncrementRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			CounterIncrementRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getCounterIncrementRuleServiceReference(
	...
	private static final String _RULE_KEY = "counter-increment";
