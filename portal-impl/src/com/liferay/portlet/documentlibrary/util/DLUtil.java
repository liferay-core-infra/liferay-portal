...
public class DLUtil {
	...
	public static String getUniqueFileName(
		...
		for (int i = 1;; i++) {
			if ((ignoreDuplicateTitle ||
				 !existsFileEntryByTitle(groupId, folderId, uniqueFileTitle)) &&
				!existsFileEntryByFileName(
	...
	public static String getUniqueTitle(
		...
		while (existsFileEntryByTitle(groupId, folderId, uniqueFileTitle)) {
			uniqueFileTitle = FileUtil.appendParentheticalSuffix(
	...
	protected static boolean existsFileEntryByTitle(
	...
	protected static void populateGenericNamesMap(String genericName) {
	...
	protected static String stripVersionSuffix(String version) {
	...
	private static final Log _log = LogFactoryUtil.getLog(DLUtil.class);
	...
	private static final Snapshot<TrashHelper> _trashHelperSnapshot =
		new Snapshot<>(DLUtil.class, TrashHelper.class);
	...
	static {
		...
		for (String genericName : genericNames) {
			populateGenericNamesMap(genericName);
		}
	}
