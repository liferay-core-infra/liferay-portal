...
public class CPInstancePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_ST = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_ST",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_ST = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"groupId", "status"}, true);

		_finderPathCountByG_ST = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"groupId", "status"}, false);

		_finderPathWithPaginationFindByC_SKU = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_SKU",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_SKU = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_SKU",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "sku"}, true);

		_finderPathCountByC_SKU = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_SKU",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPathFetchByCPDI_SKU = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByCPDI_SKU",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"CPDefinitionId", "sku"}, true);

		_finderPathCountByCPDI_SKU = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCPDI_SKU",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"CPDefinitionId", "sku"}, false);

		_finderPathWithPaginationFindByC_ST = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_ST",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_ST = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
			new String[] {"CPDefinitionId", "status"}, true);

		_finderPathCountByC_ST = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_ST",
			new String[] {Long.class.getName(), Integer.class.getName()},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_ST",
			_finderPathWithPaginationFindByG_ST);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_ST",
			_finderPathWithoutPaginationFindByG_ST);

		_finderPaths.put("finderPathCountByG_ST", _finderPathCountByG_ST);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_SKU",
			_finderPathWithPaginationFindByC_SKU);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_SKU",
			_finderPathWithoutPaginationFindByC_SKU);

		_finderPaths.put("finderPathCountByC_SKU", _finderPathCountByC_SKU);
		...
		_finderPaths.put(
			"finderPathFetchByCPDI_SKU", _finderPathFetchByCPDI_SKU);

		_finderPaths.put(
			"finderPathCountByCPDI_SKU", _finderPathCountByCPDI_SKU);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_ST",
			_finderPathWithPaginationFindByC_ST);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_ST",
			_finderPathWithoutPaginationFindByC_ST);

		_finderPaths.put("finderPathCountByC_ST", _finderPathCountByC_ST);
