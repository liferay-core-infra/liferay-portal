...
public class SXPElementUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByC_T_S() {

		return getPersistence().getFinderPathWithPaginationFindByC_T_S();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByC_T_S() {

		return getPersistence().getFinderPathWithoutPaginationFindByC_T_S();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByC_T_S() {

		return getPersistence().getFinderPathCountByC_T_S();
	}
	 ...
	 * @throws NoSuchSXPElementException if a matching sxp element could not be found
	 */
	public static SXPElement findByC_ERC(
	 ...
	 */
	public static SXPElement fetchByC_ERC(
		long companyId, String externalReferenceCode) {
	 ...
	 */
	public static SXPElement removeByC_ERC(
			long companyId, String externalReferenceCode)
		throws com.liferay.search.experiences.exception.
			NoSuchSXPElementException {
