...
public class CommerceTierPriceEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByCommercePriceEntryId = new FinderPath(
			...
			new String[] {"commercePriceEntryId"}, true, true);
