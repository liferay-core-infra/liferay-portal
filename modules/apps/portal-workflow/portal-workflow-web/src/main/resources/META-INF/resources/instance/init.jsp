...
<%
WorkflowInstanceEditDisplayContext workflowInstanceEditDisplayContext = (WorkflowInstanceEditDisplayContext)renderRequest.getAttribute(WebKeys.EDIT_PORTLET_DISPLAY_CONTEXT);
