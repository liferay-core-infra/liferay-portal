...
@Generated("")
public class PaymentMethodGroupRelOrderTypeResourceFactoryImpl
	implements PaymentMethodGroupRelOrderTypeResource.Factory {

	@Override
	public PaymentMethodGroupRelOrderTypeResource.Builder create() {
		return new PaymentMethodGroupRelOrderTypeResource.Builder() {
			...
			@Override
			public PaymentMethodGroupRelOrderTypeResource.Builder
			...
			@Override
			public PaymentMethodGroupRelOrderTypeResource.Builder user(
				User user) {
	...
	protected void activate() {
		PaymentMethodGroupRelOrderTypeResource.FactoryHolder.factory = this;
	}
