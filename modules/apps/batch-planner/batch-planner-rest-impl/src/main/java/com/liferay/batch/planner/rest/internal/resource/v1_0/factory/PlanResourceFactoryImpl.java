...
public class PlanResourceFactoryImpl implements PlanResource.Factory {
	...
	@Override
	public PlanResource.Builder create() {
		return new PlanResource.Builder() {
			...
			@Override
			public PlanResource.Builder checkPermissions(
			...
			@Override
			public PlanResource.Builder httpServletRequest(
			...
			@Override
			public PlanResource.Builder httpServletResponse(
			...
			@Override
			public PlanResource.Builder preferredLocale(
			...
			@Override
			public PlanResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(planResource);
	...
	private ComponentServiceObjects<PlanResource> _componentServiceObjects;
