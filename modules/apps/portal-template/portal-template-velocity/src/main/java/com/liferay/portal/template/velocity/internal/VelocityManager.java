...
public class VelocityManager extends BaseTemplateManager {
	...
	public class VelocityTemplateResourceLoader
		...
		public void init(
			...
			VelocityTemplateResourceCache velocityTemplateResourceCache) {

			init(
				bundleContext, TemplateConstants.LANG_TYPE_VM,
				velocityTemplateResourceCache);
		}
	...
	protected void activate(
		...
		_velocityTemplateResourceLoader.init(
	...
	private VelocityTemplateResourceLoader _velocityTemplateResourceLoader;
