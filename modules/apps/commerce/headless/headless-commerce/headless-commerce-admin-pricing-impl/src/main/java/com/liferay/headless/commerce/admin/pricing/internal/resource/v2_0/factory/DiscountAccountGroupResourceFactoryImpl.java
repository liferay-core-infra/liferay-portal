...
public class DiscountAccountGroupResourceFactoryImpl
	...
	@Override
	public DiscountAccountGroupResource.Builder create() {
		return new DiscountAccountGroupResource.Builder() {
			...
			public DiscountAccountGroupResource build() {
				...
				return _discountAccountGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public DiscountAccountGroupResource.Builder checkPermissions(
			...
			@Override
			public DiscountAccountGroupResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, DiscountAccountGroupResource>
		...
		try {
			Constructor<DiscountAccountGroupResource> constructor =
				(Constructor<DiscountAccountGroupResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(discountAccountGroupResource);
	...
	private static final Function
		<InvocationHandler, DiscountAccountGroupResource>
			_discountAccountGroupResourceProxyProviderFunction =
				_getProxyProviderFunction();
