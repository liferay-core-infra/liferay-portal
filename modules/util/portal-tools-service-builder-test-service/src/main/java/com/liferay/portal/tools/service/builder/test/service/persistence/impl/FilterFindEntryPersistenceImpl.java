...
public class FilterFindEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByI_T;
	private FinderPath _finderPathWithoutPaginationFindByI_T;
	private FinderPath _finderPathCountByI_T;

	/**
	 * Returns all the filter find entries where integer = &#63; and type = &#63;.
	 *
	 ...
	 */
	@Override
	public List<FilterFindEntry> findByI_T(int integer, String type) {
		return findByI_T(
			integer, type, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the filter find entries where integer = &#63; and type = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<FilterFindEntry> findByI_T(
		int integer, String type, int start, int end) {

		return findByI_T(integer, type, start, end, null);
	}

	/**
	 * Returns an ordered range of all the filter find entries where integer = &#63; and type = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>FilterFindEntryModelImpl</code>.
	 * </p>
	...
	public List<FilterFindEntry> findByI_T(
		...
		return findByI_T(integer, type, start, end, orderByComparator, true);
	}
	...
	public List<FilterFindEntry> findByI_T(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByI_T;
				finderArgs = new Object[] {integer, type};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByI_T;
			finderArgs = new Object[] {
				integer, type, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (FilterFindEntry filterFindEntry : list) {
					if ((integer != filterFindEntry.getInteger()) ||
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_I_T_INTEGER_2);

			boolean bindType = false;

			if (type.isEmpty()) {
				sb.append(_FINDER_COLUMN_I_T_TYPE_3);
			}
			else {
				bindType = true;

				sb.append(_FINDER_COLUMN_I_T_TYPE_2);
			}
	...
	/**
	 * Returns the first filter find entry in the ordered set where integer = &#63; and type = &#63;.
	 *
	 * @param integer the integer
	 * @param type the type
	 ...
	 */
	@Override
	public FilterFindEntry findByI_T_First(
			int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws NoSuchFilterFindEntryException {

		FilterFindEntry filterFindEntry = fetchByI_T_First(
			integer, type, orderByComparator);
	 ...
	 */
	@Override
	public FilterFindEntry fetchByI_T_First(
		int integer, String type,
		OrderByComparator<FilterFindEntry> orderByComparator) {

		List<FilterFindEntry> list = findByI_T(
			integer, type, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last filter find entry in the ordered set where integer = &#63; and type = &#63;.
	 *
	 * @param integer the integer
	 * @param type the type
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public FilterFindEntry findByI_T_Last(
			int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws NoSuchFilterFindEntryException {

		FilterFindEntry filterFindEntry = fetchByI_T_Last(
			integer, type, orderByComparator);
	 ...
	 */
	@Override
	public FilterFindEntry fetchByI_T_Last(
		int integer, String type,
		OrderByComparator<FilterFindEntry> orderByComparator) {

		int count = countByI_T(integer, type);
		...
		List<FilterFindEntry> list = findByI_T(
			integer, type, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the filter find entries before and after the current filter find entry in the ordered set where integer = &#63; and type = &#63;.
	 *
	 ...
	 */
	@Override
	public FilterFindEntry[] findByI_T_PrevAndNext(
			long filterFindEntryId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws NoSuchFilterFindEntryException {
		...
		try {
			...
			array[0] = getByI_T_PrevAndNext(
				session, filterFindEntry, integer, type, orderByComparator,
				true);

			array[1] = filterFindEntry;

			array[2] = getByI_T_PrevAndNext(
				session, filterFindEntry, integer, type, orderByComparator,
				false);
	...
	protected FilterFindEntry getByI_T_PrevAndNext(
		Session session, FilterFindEntry filterFindEntry, int integer,
		String type, OrderByComparator<FilterFindEntry> orderByComparator,
		boolean previous) {
	...
	/**
	 * Returns all the filter find entries that the user has permission to view where integer = &#63; and type = &#63;.
	 *
	 * @param integer the integer
	 * @param type the type
	 ...
	 */
	@Override
	public List<FilterFindEntry> filterFindByI_T(int integer, String type) {
		return filterFindByI_T(
			integer, type, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the filter find entries that the user has permission to view where integer = &#63; and type = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>FilterFindEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<FilterFindEntry> filterFindByI_T(
		int integer, String type, int start, int end) {

		return filterFindByI_T(integer, type, start, end, null);
	}

	/**
	 * Returns an ordered range of all the filter find entries that the user has permissions to view where integer = &#63; and type = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>FilterFindEntryModelImpl</code>.
	 * </p>
	...
	public List<FilterFindEntry> filterFindByI_T(
		...
		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByI_T(integer, type, start, end, orderByComparator);
		}
		...
		sb.append(_FINDER_COLUMN_I_T_INTEGER_2_SQL);

		boolean bindType = false;

		if (type.isEmpty()) {
			sb.append(_FINDER_COLUMN_I_T_TYPE_3_SQL);
		}
		else {
			bindType = true;

			sb.append(_FINDER_COLUMN_I_T_TYPE_2_SQL);
		}
	...
	/**
	 * Returns the filter find entries before and after the current filter find entry in the ordered set of filter find entries that the user has permission to view where integer = &#63; and type = &#63;.
	 *
	 * @param filterFindEntryId the primary key of the current filter find entry
	 * @param integer the integer
	 * @param type the type
	 ...
	 */
	@Override
	public FilterFindEntry[] filterFindByI_T_PrevAndNext(
			long filterFindEntryId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws NoSuchFilterFindEntryException {

		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByI_T_PrevAndNext(
				filterFindEntryId, integer, type, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByI_T_PrevAndNext(
				session, filterFindEntry, integer, type, orderByComparator,
				true);

			array[1] = filterFindEntry;

			array[2] = filterGetByI_T_PrevAndNext(
				session, filterFindEntry, integer, type, orderByComparator,
				false);
	...
	protected FilterFindEntry filterGetByI_T_PrevAndNext(
		Session session, FilterFindEntry filterFindEntry, int integer,
		String type, OrderByComparator<FilterFindEntry> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the filter find entries where integer = &#63; and type = &#63; from the database.
	 *
	 * @param integer the integer
	 * @param type the type
	 */
	@Override
	public void removeByI_T(int integer, String type) {
		for (FilterFindEntry filterFindEntry :
				findByI_T(
					integer, type, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of filter find entries where integer = &#63; and type = &#63;.
	 *
	 * @param integer the integer
	 * @param type the type
	 ...
	 */
	@Override
	public int countByI_T(int integer, String type) {
		type = Objects.toString(type, "");

		FinderPath finderPath = _finderPathCountByI_T;

		Object[] finderArgs = new Object[] {integer, type};
	...
	/**
	 * Returns the number of filter find entries that the user has permission to view where integer = &#63; and type = &#63;.
	 *
	 * @param integer the integer
	 * @param type the type
	 ...
	 */
	@Override
	public int filterCountByI_T(int integer, String type) {
		if (!InlineSQLHelperUtil.isEnabled()) {
			return countByI_T(integer, type);
		}
	...
	private static final String _FINDER_COLUMN_I_T_INTEGER_2 =
	...
	private static final String _FINDER_COLUMN_I_T_TYPE_3 =
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByI_T = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByI_T",
			new String[] {
				Integer.class.getName(), String.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"integer_", "type_"}, true);

		_finderPathWithoutPaginationFindByI_T = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByI_T",
			new String[] {Integer.class.getName(), String.class.getName()},
			new String[] {"integer_", "type_"}, true);

		_finderPathCountByI_T = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByI_T",
			new String[] {Integer.class.getName(), String.class.getName()},
			new String[] {"integer_", "type_"}, false);
