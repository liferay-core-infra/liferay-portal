...
public class KeywordQueryContributorResourceFactoryImpl
	implements KeywordQueryContributorResource.Factory {

	@Override
	public KeywordQueryContributorResource.Builder create() {
		return new KeywordQueryContributorResource.Builder() {
			...
			@Override
			public KeywordQueryContributorResource.Builder checkPermissions(
			...
			@Override
			public KeywordQueryContributorResource.Builder httpServletRequest(
			...
			@Override
			public KeywordQueryContributorResource.Builder httpServletResponse(
			...
			@Override
			public KeywordQueryContributorResource.Builder preferredLocale(
	...
	protected void activate() {
		KeywordQueryContributorResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		KeywordQueryContributorResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, KeywordQueryContributorResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			KeywordQueryContributorResource.class.getClassLoader(),
			KeywordQueryContributorResource.class);

		try {
			Constructor<KeywordQueryContributorResource> constructor =
				(Constructor<KeywordQueryContributorResource>)
