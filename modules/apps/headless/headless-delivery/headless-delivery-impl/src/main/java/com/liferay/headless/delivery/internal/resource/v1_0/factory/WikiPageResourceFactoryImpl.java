...
public class WikiPageResourceFactoryImpl implements WikiPageResource.Factory {
	...
	@Override
	public WikiPageResource.Builder create() {
		return new WikiPageResource.Builder() {
			...
			@Override
			public WikiPageResource.Builder checkPermissions(
			...
			@Override
			public WikiPageResource.Builder httpServletRequest(
			...
			@Override
			public WikiPageResource.Builder httpServletResponse(
			...
			@Override
			public WikiPageResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(wikiPageResource);
	...
	private ComponentServiceObjects<WikiPageResource> _componentServiceObjects;
