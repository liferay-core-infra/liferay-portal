...
public class FilterFindEntryUtil {
	 ...
	 */
	public static List<FilterFindEntry> findByI_T(int integer, String type) {
		return getPersistence().findByI_T(integer, type);
	}
	 ...
	 */
	public static List<FilterFindEntry> findByI_T(
		int integer, String type, int start, int end) {

		return getPersistence().findByI_T(integer, type, start, end);
	}
	...
	public static List<FilterFindEntry> findByI_T(
		...
		return getPersistence().findByI_T(
	...
	public static List<FilterFindEntry> findByI_T(
		...
		return getPersistence().findByI_T(
			integer, type, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 */
	public static FilterFindEntry findByI_T_First(
			int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().findByI_T_First(
	 ...
	 */
	public static FilterFindEntry fetchByI_T_First(
		int integer, String type,
		OrderByComparator<FilterFindEntry> orderByComparator) {

		return getPersistence().fetchByI_T_First(
			integer, type, orderByComparator);
	}
	 ...
	 * @throws NoSuchFilterFindEntryException if a matching filter find entry could not be found
	 */
	public static FilterFindEntry findByI_T_Last(
			int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().findByI_T_Last(
			integer, type, orderByComparator);
	}
	 ...
	 */
	public static FilterFindEntry fetchByI_T_Last(
		int integer, String type,
		OrderByComparator<FilterFindEntry> orderByComparator) {

		return getPersistence().fetchByI_T_Last(
			integer, type, orderByComparator);
	}
	 ...
	 */
	public static FilterFindEntry[] findByI_T_PrevAndNext(
			long filterFindEntryId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().findByI_T_PrevAndNext(
	 ...
	 */
	public static List<FilterFindEntry> filterFindByI_T(
		int integer, String type) {

		return getPersistence().filterFindByI_T(integer, type);
	}
	...
	public static List<FilterFindEntry> filterFindByI_T(
		...
		return getPersistence().filterFindByI_T(integer, type, start, end);
	}
	...
	public static List<FilterFindEntry> filterFindByI_T(
		...
		return getPersistence().filterFindByI_T(
			integer, type, start, end, orderByComparator);
	}
	 ...
	 * @throws NoSuchFilterFindEntryException if a filter find entry with the primary key could not be found
	 */
	public static FilterFindEntry[] filterFindByI_T_PrevAndNext(
			long filterFindEntryId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().filterFindByI_T_PrevAndNext(
			filterFindEntryId, integer, type, orderByComparator);
	}
	 ...
	 * @param type the type
	 */
	public static void removeByI_T(int integer, String type) {
		getPersistence().removeByI_T(integer, type);
	}
	 ...
	 */
	public static int countByI_T(int integer, String type) {
		return getPersistence().countByI_T(integer, type);
	}
	 ...
	 */
	public static int filterCountByI_T(int integer, String type) {
		return getPersistence().filterCountByI_T(integer, type);
	}
