...
public class SXPBlueprintResourceFactoryImpl
	...
	@Override
	public SXPBlueprintResource.Builder create() {
		return new SXPBlueprintResource.Builder() {
			...
			public SXPBlueprintResource build() {
				...
				return _sxpBlueprintResourceProxyProviderFunction.apply(
			...
			@Override
			public SXPBlueprintResource.Builder checkPermissions(
			...
			@Override
			public SXPBlueprintResource.Builder httpServletRequest(
			...
			@Override
			public SXPBlueprintResource.Builder httpServletResponse(
			...
			@Override
			public SXPBlueprintResource.Builder preferredLocale(
			...
			@Override
			public SXPBlueprintResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, SXPBlueprintResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SXPBlueprintResource.class.getClassLoader(),
			SXPBlueprintResource.class);

		try {
			Constructor<SXPBlueprintResource> constructor =
				(Constructor<SXPBlueprintResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(sxpBlueprintResource);
	...
	private static final Function<InvocationHandler, SXPBlueprintResource>
		_sxpBlueprintResourceProxyProviderFunction =
			_getProxyProviderFunction();
