...
public class BrowserSnifferUtil_IW {
	...
	public java.lang.String getAccept(javax.servlet.http.HttpServletRequest httpServletRequest) {
		return BrowserSnifferUtil.getAccept(httpServletRequest);
	}

	public java.lang.String getBrowserId(javax.servlet.http.HttpServletRequest httpServletRequest) {
	...
	public java.lang.String getRevision(javax.servlet.http.HttpServletRequest httpServletRequest) {
		return BrowserSnifferUtil.getRevision(httpServletRequest);
	}

	public java.lang.String getVersion(javax.servlet.http.HttpServletRequest httpServletRequest) {
	...
	public java.lang.String parseVersion(java.lang.String userAgent, java.lang.String[] leadings, char[] separators) {
