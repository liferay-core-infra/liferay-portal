...
public class DataLayoutResourceFactoryImpl
	...
	public DataLayoutResource.Builder create() {
		return new DataLayoutResource.Builder() {
			...
			@Override
			public DataLayoutResource.Builder httpServletRequest(
			...
			@Override
			public DataLayoutResource.Builder httpServletResponse(
			...
			@Override
			public DataLayoutResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, DataLayoutResource>
		...
		try {
			Constructor<DataLayoutResource> constructor =
				(Constructor<DataLayoutResource>)proxyClass.getConstructor(
