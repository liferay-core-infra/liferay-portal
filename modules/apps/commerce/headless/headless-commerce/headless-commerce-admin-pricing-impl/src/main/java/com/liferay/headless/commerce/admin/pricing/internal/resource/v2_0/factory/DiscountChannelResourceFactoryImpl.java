...
public class DiscountChannelResourceFactoryImpl
	...
	@Override
	public DiscountChannelResource.Builder create() {
		return new DiscountChannelResource.Builder() {
			...
			public DiscountChannelResource build() {
				...
				return _discountChannelResourceProxyProviderFunction.apply(
			...
			@Override
			public DiscountChannelResource.Builder checkPermissions(
			...
			@Override
			public DiscountChannelResource.Builder httpServletRequest(
			...
			@Override
			public DiscountChannelResource.Builder httpServletResponse(
			...
			@Override
			public DiscountChannelResource.Builder preferredLocale(
			...
			@Override
			public DiscountChannelResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		DiscountChannelResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		DiscountChannelResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, DiscountChannelResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			DiscountChannelResource.class.getClassLoader(),
			DiscountChannelResource.class);

		try {
			Constructor<DiscountChannelResource> constructor =
				(Constructor<DiscountChannelResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(discountChannelResource);
	...
	private static final Function<InvocationHandler, DiscountChannelResource>
		_discountChannelResourceProxyProviderFunction =
			_getProxyProviderFunction();
