...
import com.liferay.portal.search.web.internal.facet.SearchFacetRegistryImpl;
...
public class SearchDisplayContext {
	...
	public SearchDisplayContext(
			...
			SearchFacetRegistryImpl searchFacetRegistryImpl)
		...
		_searchFacetRegistryImpl = searchFacetRegistryImpl;
	...
	public List<SearchFacet> getSearchFacets() {
		return _searchFacetRegistryImpl.getSearchFacets();
	}
	...
	private final SearchFacetRegistryImpl _searchFacetRegistryImpl;
