 ...
 */
@Component(
	service = {SamlSpIdpConnectionPersistence.class, BasePersistence.class}
)
public class SamlSpIdpConnectionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_SIEI = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByC_SIEI",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "samlIdpEntityId"}, true);

		_finderPathCountByC_SIEI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_SIEI",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPaths.put("finderPathFetchByC_SIEI", _finderPathFetchByC_SIEI);

		_finderPaths.put("finderPathCountByC_SIEI", _finderPathCountByC_SIEI);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<SamlSpIdpConnection> samlSpIdpConnections = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<SamlSpIdpConnection>> resultMap =
				new HashMap<>();
			...
			for (SamlSpIdpConnection samlSpIdpConnection :
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						samlSpIdpConnectionModelImpl.getColumnValue(
							columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), samlSpIdpConnection);
				}
				else {
					List<SamlSpIdpConnection> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(samlSpIdpConnection);
				}
			}

			for (Map.Entry<List<Object>, List<SamlSpIdpConnection>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<SamlSpIdpConnection> value = resultEntry.getValue();
	...
	@Reference
	private SamlSpIdpConnectionModelArgumentsResolver
		_samlSpIdpConnectionModelArgumentsResolver;
