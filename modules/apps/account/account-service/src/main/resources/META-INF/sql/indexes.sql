create unique index IX_FBFAF640 on AccountEntry (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create unique index IX_F7BFA1CD on AccountGroup (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create unique index IX_88B680FE on AccountRole (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
