...
public class LayoutDisplayPageObjectProviderAnalyticsReportsInfoItemTest {
	...
	@Inject(
		filter = "component.name=com.liferay.analytics.reports.layout.display.page.internal.info.item.LayoutDisplayPageObjectProviderAnalyticsReportsInfoItemImpl"
	)
