...
public class ObjectViewUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByODI_DOV() {

		return getPersistence().getFinderPathWithPaginationFindByODI_DOV();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByODI_DOV() {

		return getPersistence().getFinderPathWithoutPaginationFindByODI_DOV();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByODI_DOV() {

		return getPersistence().getFinderPathCountByODI_DOV();
	}
