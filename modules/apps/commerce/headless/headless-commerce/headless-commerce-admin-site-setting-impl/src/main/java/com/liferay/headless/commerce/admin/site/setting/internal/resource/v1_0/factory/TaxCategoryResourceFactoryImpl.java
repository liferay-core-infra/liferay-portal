...
public class TaxCategoryResourceFactoryImpl
	...
	@Override
	public TaxCategoryResource.Builder create() {
		return new TaxCategoryResource.Builder() {
			...
			public TaxCategoryResource build() {
				...
				return _taxCategoryResourceProxyProviderFunction.apply(
			...
			@Override
			public TaxCategoryResource.Builder checkPermissions(
			...
			@Override
			public TaxCategoryResource.Builder httpServletRequest(
			...
			@Override
			public TaxCategoryResource.Builder httpServletResponse(
			...
			@Override
			public TaxCategoryResource.Builder preferredLocale(
			...
			@Override
			public TaxCategoryResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		TaxCategoryResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		TaxCategoryResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, TaxCategoryResource>
		...
		try {
			Constructor<TaxCategoryResource> constructor =
				(Constructor<TaxCategoryResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(taxCategoryResource);
	...
	private static final Function<InvocationHandler, TaxCategoryResource>
		_taxCategoryResourceProxyProviderFunction = _getProxyProviderFunction();
