 ...
 * @generated
 */
@Component(service = {DefinitionPersistence.class, BasePersistence.class})
public class DefinitionPersistenceImpl
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<Definition>> resultMap = new HashMap<>();
			...
			for (Definition definition : definitions) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						definitionModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), definition);
				}
				else {
					List<Definition> resultList = resultMap.computeIfAbsent(
			...
			for (Map.Entry<List<Object>, List<Definition>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<Definition> value = resultEntry.getValue();
