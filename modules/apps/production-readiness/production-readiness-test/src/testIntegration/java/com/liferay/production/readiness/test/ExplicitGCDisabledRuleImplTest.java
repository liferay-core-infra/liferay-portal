...
public class ExplicitGCDisabledRuleImplTest {
	...
	@Test
	public void testExplicitGCDisabledRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getExplicitGCDisabledRuleServiceReference(bundleContext);
	...
	@Test
	public void testExplicitGCDisabledRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			ExplicitGCDisabledRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getExplicitGCDisabledRuleServiceReference(
	...
	private static final String _RULE_KEY = "explicit-gc-disabled";
