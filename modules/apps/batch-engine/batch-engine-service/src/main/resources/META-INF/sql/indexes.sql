create unique index IX_EAC5DE50 on BatchEngineExportTask (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create unique index IX_2BBBB941 on BatchEngineImportTask (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
