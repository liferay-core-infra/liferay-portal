...
public class ProductGroupResourceFactoryImpl
	...
	@Override
	public ProductGroupResource.Builder create() {
		return new ProductGroupResource.Builder() {
			...
			public ProductGroupResource build() {
				...
				return _productGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public ProductGroupResource.Builder checkPermissions(
			...
			@Override
			public ProductGroupResource.Builder httpServletRequest(
			...
			@Override
			public ProductGroupResource.Builder httpServletResponse(
			...
			@Override
			public ProductGroupResource.Builder preferredLocale(
			...
			@Override
			public ProductGroupResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ProductGroupResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductGroupResource.class.getClassLoader(),
			ProductGroupResource.class);

		try {
			Constructor<ProductGroupResource> constructor =
				(Constructor<ProductGroupResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(productGroupResource);
	...
	private static final Function<InvocationHandler, ProductGroupResource>
		_productGroupResourceProxyProviderFunction =
			_getProxyProviderFunction();
