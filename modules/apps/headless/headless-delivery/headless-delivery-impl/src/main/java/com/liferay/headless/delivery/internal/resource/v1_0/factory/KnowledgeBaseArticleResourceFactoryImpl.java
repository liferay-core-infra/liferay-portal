...
public class KnowledgeBaseArticleResourceFactoryImpl
	...
	public KnowledgeBaseArticleResource.Builder create() {
		return new KnowledgeBaseArticleResource.Builder() {
			...
			@Override
			public KnowledgeBaseArticleResource.Builder httpServletRequest(
			...
			@Override
			public KnowledgeBaseArticleResource.Builder httpServletResponse(
			...
			@Override
			public KnowledgeBaseArticleResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, KnowledgeBaseArticleResource>
		...
		try {
			Constructor<KnowledgeBaseArticleResource> constructor =
				(Constructor<KnowledgeBaseArticleResource>)
