...
public class CommerceWishListPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByU_LtC = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_LtC",
			new String[] {
		...
		_finderPathWithPaginationCountByU_LtC = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByU_LtC",
			new String[] {Long.class.getName(), Date.class.getName()},
			new String[] {"userId", "createDate"}, false);

		_finderPathWithPaginationFindByG_U_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_U_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_U_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_U_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_U_D = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U_D",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByU_LtC",
			_finderPathWithPaginationFindByU_LtC);

		_finderPaths.put(
			"finderPathWithPaginationCountByU_LtC",
			_finderPathWithPaginationCountByU_LtC);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_U_D",
			_finderPathWithPaginationFindByG_U_D);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_U_D",
			_finderPathWithoutPaginationFindByG_U_D);

		_finderPaths.put("finderPathCountByG_U_D", _finderPathCountByG_U_D);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<CommerceWishList> commerceWishLists = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommerceWishList>> resultMap =
				new HashMap<>();
			...
			for (CommerceWishList commerceWishList : commerceWishLists) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						commerceWishListModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), commerceWishList);
				}
				else {
					List<CommerceWishList> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commerceWishList);
				}
			}

			for (Map.Entry<List<Object>, List<CommerceWishList>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommerceWishList> value = resultEntry.getValue();
