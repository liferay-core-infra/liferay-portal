...
public abstract class BaseLayoutBranchUADExporter
	...
	@Override
	protected String toXmlString(LayoutBranch layoutBranch) throws IOException {
		...
		columnNameElement.addText("layoutBranchId");
		columnValueElement.addText(
			String.valueOf(layoutBranch.getLayoutBranchId()));
		...
		columnValueElement.addText(String.valueOf(layoutBranch.getUserId()));
		columnElement = modelElement.addElement("column");
		columnNameElement = columnElement.addElement("column-name");
		columnValueElement = columnElement.addElement("column-value");

		columnNameElement.addText("userName");
		columnValueElement.addCDATA(layoutBranch.getUserName());
