...
public class CommercePriceListAccountRelUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByCAI_CPI() {

		return getPersistence().getFinderPathFetchByCAI_CPI();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByCAI_CPI() {

		return getPersistence().getFinderPathCountByCAI_CPI();
	}
