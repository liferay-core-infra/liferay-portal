...
public class WikiPageAttachmentResourceFactoryImpl
	...
	public WikiPageAttachmentResource.Builder create() {
		return new WikiPageAttachmentResource.Builder() {
			...
			@Override
			public WikiPageAttachmentResource.Builder httpServletRequest(
			...
			@Override
			public WikiPageAttachmentResource.Builder httpServletResponse(
			...
			@Override
			public WikiPageAttachmentResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, WikiPageAttachmentResource>
		...
		try {
			Constructor<WikiPageAttachmentResource> constructor =
				(Constructor<WikiPageAttachmentResource>)
