...
public class DDLRecordSetVersionUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByRecordSetId() {

		return getPersistence().getFinderPathWithPaginationFindByRecordSetId();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByRecordSetId() {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByRecordSetId() {

		return getPersistence().getFinderPathCountByRecordSetId();
	}
	 ...
	 * @throws NoSuchRecordSetVersionException if a matching ddl record set version could not be found
	 */
	public static DDLRecordSetVersion findByRecordSetId_Last(
			long recordSetId,
			OrderByComparator<DDLRecordSetVersion> orderByComparator)
		throws com.liferay.dynamic.data.lists.exception.
			NoSuchRecordSetVersionException {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByRS_V() {

		return getPersistence().getFinderPathFetchByRS_V();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByRS_V() {

		return getPersistence().getFinderPathCountByRS_V();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByRS_S() {

		return getPersistence().getFinderPathWithPaginationFindByRS_S();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByRS_S() {

		return getPersistence().getFinderPathWithoutPaginationFindByRS_S();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByRS_S() {

		return getPersistence().getFinderPathCountByRS_S();
	}
	 ...
	 * @throws NoSuchRecordSetVersionException if a matching ddl record set version could not be found
	 */
	public static DDLRecordSetVersion findByRS_S_Last(
			long recordSetId, int status,
			OrderByComparator<DDLRecordSetVersion> orderByComparator)
		throws com.liferay.dynamic.data.lists.exception.
			NoSuchRecordSetVersionException {

		return getPersistence().findByRS_S_Last(
			recordSetId, status, orderByComparator);
	}
	 ...
	 * @return the last matching ddl record set version, or <code>null</code> if a matching ddl record set version could not be found
	 */
	public static DDLRecordSetVersion fetchByRS_S_Last(
		long recordSetId, int status,
		OrderByComparator<DDLRecordSetVersion> orderByComparator) {
