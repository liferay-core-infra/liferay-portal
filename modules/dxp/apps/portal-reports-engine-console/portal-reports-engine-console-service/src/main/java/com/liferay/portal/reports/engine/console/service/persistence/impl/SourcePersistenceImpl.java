...
public class SourcePersistenceImpl
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<Source>> resultMap = new HashMap<>();
			...
			for (Source source : sources) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(sourceModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), source);
				}
				else {
					List<Source> resultList = resultMap.computeIfAbsent(
			...
			for (Map.Entry<List<Object>, List<Source>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<Source> value = resultEntry.getValue();
