...
public class WorkflowTaskResourceFactoryImpl
	...
	public WorkflowTaskResource.Builder create() {
		return new WorkflowTaskResource.Builder() {
			...
			public WorkflowTaskResource build() {
				...
				return _workflowTaskResourceProxyProviderFunction.apply(
			...
			@Override
			public WorkflowTaskResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, WorkflowTaskResource>
		...
		try {
			Constructor<WorkflowTaskResource> constructor =
				(Constructor<WorkflowTaskResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, WorkflowTaskResource>
		_workflowTaskResourceProxyProviderFunction =
			_getProxyProviderFunction();
