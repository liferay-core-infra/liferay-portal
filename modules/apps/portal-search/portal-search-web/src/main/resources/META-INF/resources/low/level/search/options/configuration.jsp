		...
		<aui:fieldset>
			<aui:select helpMessage="connection-id-help[web]" label="connection-id" name="<%= PortletPreferencesJspUtil.getInputName(LowLevelSearchOptionsPortletPreferences.PREFERENCE_KEY_CONNECTION_ID) %>">
				...
				%>
					...
					<aui:option label="<%= HtmlUtil.escape(connectionId) %>" selected="<%= connectionId.equals(GetterUtil.getString(lowLevelSearchOptionsPortletPreferences.getConnectionId())) %>" value="<%= connectionId %>" />
			...
			<aui:input helpMessage="indexes-help" label="indexes" name="<%= PortletPreferencesJspUtil.getInputName(LowLevelSearchOptionsPortletPreferences.PREFERENCE_KEY_INDEXES) %>" type="text" value="<%= GetterUtil.getString(lowLevelSearchOptionsPortletPreferences.getIndexes()) %>" />

			<aui:input helpMessage="fields-to-return-help" label="fields-to-return" name="<%= PortletPreferencesJspUtil.getInputName(LowLevelSearchOptionsPortletPreferences.PREFERENCE_KEY_FIELDS_TO_RETURN) %>" type="text" value="<%= GetterUtil.getString(lowLevelSearchOptionsPortletPreferences.getFieldsToReturn()) %>" />

			<aui:input helpMessage="contributors-to-include-help" label="contributors-to-include" name="<%= PortletPreferencesJspUtil.getInputName(LowLevelSearchOptionsPortletPreferences.PREFERENCE_KEY_CONTRIBUTORS_TO_INCLUDE) %>" type="text" value="<%= GetterUtil.getString(lowLevelSearchOptionsPortletPreferences.getContributorsToInclude()) %>" />
