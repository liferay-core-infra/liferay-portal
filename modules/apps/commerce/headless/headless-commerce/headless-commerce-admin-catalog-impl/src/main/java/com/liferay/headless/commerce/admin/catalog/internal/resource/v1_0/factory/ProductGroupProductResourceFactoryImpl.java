...
@Generated("")
public class ProductGroupProductResourceFactoryImpl
	implements ProductGroupProductResource.Factory {

	@Override
	public ProductGroupProductResource.Builder create() {
		return new ProductGroupProductResource.Builder() {
			...
			public ProductGroupProductResource build() {
				...
				return _productGroupProductResourceProxyProviderFunction.apply(
			...
			@Override
			public ProductGroupProductResource.Builder checkPermissions(
			...
			@Override
			public ProductGroupProductResource.Builder httpServletRequest(
			...
			@Override
			public ProductGroupProductResource.Builder httpServletResponse(
			...
			@Override
			public ProductGroupProductResource.Builder preferredLocale(
			...
			@Override
			public ProductGroupProductResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ProductGroupProductResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ProductGroupProductResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, ProductGroupProductResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductGroupProductResource.class.getClassLoader(),
			ProductGroupProductResource.class);

		try {
			Constructor<ProductGroupProductResource> constructor =
				(Constructor<ProductGroupProductResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(productGroupProductResource);
	...
	private static final Function
		<InvocationHandler, ProductGroupProductResource>
			_productGroupProductResourceProxyProviderFunction =
				_getProxyProviderFunction();
