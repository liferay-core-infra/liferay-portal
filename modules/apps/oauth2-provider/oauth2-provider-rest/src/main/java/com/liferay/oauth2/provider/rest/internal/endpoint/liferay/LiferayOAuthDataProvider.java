...
public class LiferayOAuthDataProvider
	...
	protected void activate(Map<String, Object> properties) {
		HashSet<String> refreshTokenIncompatibleGrants = new HashSet<>();

		refreshTokenIncompatibleGrants.add(Constants.JWT_BEARER_GRANT);
		refreshTokenIncompatibleGrants.add(Constants.JWT_BEARER_GRANT);
		refreshTokenIncompatibleGrants.add(
			HttpUtils.urlEncode(
				OAuthConstants.CLIENT_CREDENTIALS_GRANT,
				StandardCharsets.UTF_8.name()));

		_refreshTokenIncompatibleGrants = refreshTokenIncompatibleGrants;
	...
	private static Set<String> _refreshTokenIncompatibleGrants;
