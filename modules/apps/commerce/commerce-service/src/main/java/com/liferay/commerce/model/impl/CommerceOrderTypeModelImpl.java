...
import com.liferay.commerce.model.CommerceOrderTypeModel;
...
/**
 * The base model implementation for the CommerceOrderType service. Represents a row in the &quot;CommerceOrderType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface <code>CommerceOrderTypeModel</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CommerceOrderTypeImpl}.
 * </p>
 *
 ...
 */
@JSON(strict = true)
public class CommerceOrderTypeModelImpl
	extends BaseModelImpl<CommerceOrderType> implements CommerceOrderTypeModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"displayOrder", Types.INTEGER}, {"expirationDate", Types.TIMESTAMP},
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.liferay.commerce.service.util.ServiceProps.get(
			"lock.expiration.time.com.liferay.commerce.model.CommerceOrderType"));

	public CommerceOrderTypeModelImpl() {
	}
	...
	public void setPrimaryKey(long primaryKey) {
		setCommerceOrderTypeId(primaryKey);
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		for (Map.Entry<String, Function<CommerceOrderType, Object>> entry :
				attributeGetterFunctions.entrySet()) {

			String attributeName = entry.getKey();
			Function<CommerceOrderType, Object> attributeGetterFunction =
				entry.getValue();

			attributes.put(
				attributeName,
				attributeGetterFunction.apply((CommerceOrderType)this));
		}
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<CommerceOrderType, Object>>
			attributeSetterBiConsumers = getAttributeSetterBiConsumers();

		for (Map.Entry<String, Object> entry : attributes.entrySet()) {
			String attributeName = entry.getKey();

			BiConsumer<CommerceOrderType, Object> attributeSetterBiConsumer =
				attributeSetterBiConsumers.get(attributeName);

			if (attributeSetterBiConsumer != null) {
				attributeSetterBiConsumer.accept(
					(CommerceOrderType)this, entry.getValue());
			}
		}
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			getCompanyId(), CommerceOrderType.class.getName(), getPrimaryKey());
	}
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(
			CommerceOrderType.class.getName(), getPrimaryKey(), defaultLocale,
			availableLocales);
	...
	@Override
	public CommerceOrderType toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, CommerceOrderType>
	...
	public Object clone() {
		...
		commerceOrderTypeImpl.setUuid(getUuid());
		commerceOrderTypeImpl.setExternalReferenceCode(
			getExternalReferenceCode());
		commerceOrderTypeImpl.setCommerceOrderTypeId(getCommerceOrderTypeId());
		commerceOrderTypeImpl.setCompanyId(getCompanyId());
		commerceOrderTypeImpl.setUserId(getUserId());
		commerceOrderTypeImpl.setUserName(getUserName());
		commerceOrderTypeImpl.setCreateDate(getCreateDate());
		commerceOrderTypeImpl.setModifiedDate(getModifiedDate());
		commerceOrderTypeImpl.setName(getName());
		commerceOrderTypeImpl.setDescription(getDescription());
		commerceOrderTypeImpl.setActive(isActive());
		commerceOrderTypeImpl.setDisplayDate(getDisplayDate());
		commerceOrderTypeImpl.setDisplayOrder(getDisplayOrder());
		commerceOrderTypeImpl.setExpirationDate(getExpirationDate());
		commerceOrderTypeImpl.setLastPublishDate(getLastPublishDate());
		commerceOrderTypeImpl.setStatus(getStatus());
		commerceOrderTypeImpl.setStatusByUserId(getStatusByUserId());
		commerceOrderTypeImpl.setStatusByUserName(getStatusByUserName());
		commerceOrderTypeImpl.setStatusDate(getStatusDate());
	...
	public int compareTo(CommerceOrderType commerceOrderType) {
		...
		value = DateUtil.compareTo(
			getCreateDate(), commerceOrderType.getCreateDate());
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CommerceOrderType)) {
			return false;
		}

		CommerceOrderType commerceOrderType = (CommerceOrderType)object;

		long primaryKey = commerceOrderType.getPrimaryKey();
	...
	public CacheModel<CommerceOrderType> toCacheModel() {
		...
		commerceOrderTypeCacheModel.uuid = getUuid();

		String uuid = commerceOrderTypeCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			commerceOrderTypeCacheModel.uuid = null;
		}
		...
		if ((externalReferenceCode != null) &&
			...
			commerceOrderTypeCacheModel.externalReferenceCode = null;
		}

		commerceOrderTypeCacheModel.commerceOrderTypeId =
			getCommerceOrderTypeId();

		commerceOrderTypeCacheModel.companyId = getCompanyId();

		commerceOrderTypeCacheModel.userId = getUserId();

		commerceOrderTypeCacheModel.userName = getUserName();

		String userName = commerceOrderTypeCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			commerceOrderTypeCacheModel.userName = null;
		}

		Date createDate = getCreateDate();

		if (createDate != null) {
			commerceOrderTypeCacheModel.createDate = createDate.getTime();
		}
		else {
			commerceOrderTypeCacheModel.createDate = Long.MIN_VALUE;
		}

		Date modifiedDate = getModifiedDate();

		if (modifiedDate != null) {
			commerceOrderTypeCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			commerceOrderTypeCacheModel.modifiedDate = Long.MIN_VALUE;
		}

		commerceOrderTypeCacheModel.name = getName();

		String name = commerceOrderTypeCacheModel.name;

		if ((name != null) && (name.length() == 0)) {
			commerceOrderTypeCacheModel.name = null;
		}

		commerceOrderTypeCacheModel.description = getDescription();

		String description = commerceOrderTypeCacheModel.description;

		if ((description != null) && (description.length() == 0)) {
			commerceOrderTypeCacheModel.description = null;
		}

		commerceOrderTypeCacheModel.active = isActive();

		Date displayDate = getDisplayDate();

		if (displayDate != null) {
			commerceOrderTypeCacheModel.displayDate = displayDate.getTime();
		}
		else {
			commerceOrderTypeCacheModel.displayDate = Long.MIN_VALUE;
		}

		commerceOrderTypeCacheModel.displayOrder = getDisplayOrder();

		Date expirationDate = getExpirationDate();

		if (expirationDate != null) {
			commerceOrderTypeCacheModel.expirationDate =
				expirationDate.getTime();
		}
		else {
			commerceOrderTypeCacheModel.expirationDate = Long.MIN_VALUE;
		}

		Date lastPublishDate = getLastPublishDate();

		if (lastPublishDate != null) {
			commerceOrderTypeCacheModel.lastPublishDate =
				lastPublishDate.getTime();
		}
		else {
			commerceOrderTypeCacheModel.lastPublishDate = Long.MIN_VALUE;
		}

		commerceOrderTypeCacheModel.status = getStatus();

		commerceOrderTypeCacheModel.statusByUserId = getStatusByUserId();

		commerceOrderTypeCacheModel.statusByUserName = getStatusByUserName();

		String statusByUserName = commerceOrderTypeCacheModel.statusByUserName;

		if ((statusByUserName != null) && (statusByUserName.length() == 0)) {
			commerceOrderTypeCacheModel.statusByUserName = null;
		}

		Date statusDate = getStatusDate();

		if (statusDate != null) {
			commerceOrderTypeCacheModel.statusDate = statusDate.getTime();
		}
		else {
			commerceOrderTypeCacheModel.statusDate = Long.MIN_VALUE;
		}

		return commerceOrderTypeCacheModel;
	}
	...
	public String toXmlString() {
		...
		for (Map.Entry<String, Function<CommerceOrderType, Object>> entry :
			...
			sb.append(attributeGetterFunction.apply((CommerceOrderType)this));
	...
	private static class EscapedModelProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, CommerceOrderType>
			_escapedModelProxyProviderFunction =
				ProxyUtil.getProxyProviderFunction(
					CommerceOrderType.class, ModelWrapper.class);
	...
	public <T> T getColumnValue(String columnName) {
		...
		return (T)function.apply((CommerceOrderType)this);
	}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("displayOrder", _displayOrder);
	...
	static {
		...
		columnBitmasks.put("commerceOrderTypeId", 8L);
		...
		columnBitmasks.put("displayOrder", 8192L);
