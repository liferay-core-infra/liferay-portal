...
public interface FilterFindEntryPersistence
	 ...
	 */
	public java.util.List<FilterFindEntry> findByI_T(int integer, String type);
	 ...
	 */
	public java.util.List<FilterFindEntry> findByI_T(
	 ...
	 */
	public java.util.List<FilterFindEntry> filterFindByI_T(
		int integer, String type);
