...
public class DLPreviewForkingRuleImplTest {
	...
	@Test
	public void testDLPreviewForkingRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getDLPreviewForkingRuleServiceReference(bundleContext);
	...
	@Test
	public void testDLPreviewForkingRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			DLPreviewForkingRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getDLPreviewForkingRuleServiceReference(
	...
	private static final String _RULE_KEY = "dl-preview-forking";
