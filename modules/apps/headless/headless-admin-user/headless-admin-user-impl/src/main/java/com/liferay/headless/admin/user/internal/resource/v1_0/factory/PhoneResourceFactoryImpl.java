...
public class PhoneResourceFactoryImpl implements PhoneResource.Factory {
	...
	@Override
	public PhoneResource.Builder create() {
		return new PhoneResource.Builder() {
			...
			public PhoneResource build() {
				...
				return _phoneResourceProxyProviderFunction.apply(
			...
			@Override
			public PhoneResource.Builder checkPermissions(
			...
			@Override
			public PhoneResource.Builder httpServletRequest(
			...
			@Override
			public PhoneResource.Builder httpServletResponse(
			...
			@Override
			public PhoneResource.Builder preferredLocale(
