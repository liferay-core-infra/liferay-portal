...
public class SearchResultInterpreterProviderImpl
	...
	private class AssetRendererSearchResultInterpreter
		...
		@Override
		public DDMFormValuesReader getAssetDDMFormValuesReader(
				Document document)
		...
		@Override
		public AssetEntry getAssetEntry(Document document)
			throws PortalException {
		...
		public AssetRenderer<?> getAssetRenderer(Document document) {
			AssetRendererFactory<?> assetRendererFactory =
				_getAssetRendererFactory(document);
		...
		@Override
		public String getAssetSummary(Document document)
			throws PortalException {
		...
		@Override
		public String getAssetUrlTitle(Document document)
			throws PortalException {
		...
		@Override
		public boolean isAssetLinkable(Document document)
			throws PortalException {
		...
		@Override
		public boolean isAssetSearchable(Document document)
			throws PortalException {
		...
		@Override
		public boolean isAssetSelectable(Document document)
			throws PortalException {
