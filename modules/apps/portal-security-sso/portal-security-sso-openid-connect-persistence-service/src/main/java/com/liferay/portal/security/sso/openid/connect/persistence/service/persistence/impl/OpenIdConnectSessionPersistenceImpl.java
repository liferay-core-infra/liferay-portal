...
public class OpenIdConnectSessionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByConfigurationPid = new FinderPath(
			...
			new String[] {"configurationPid"}, true, true);
