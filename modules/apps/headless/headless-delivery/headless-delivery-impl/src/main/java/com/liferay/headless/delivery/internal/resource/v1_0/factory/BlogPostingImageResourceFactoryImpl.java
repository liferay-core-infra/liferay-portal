...
public class BlogPostingImageResourceFactoryImpl
	...
	@Override
	public BlogPostingImageResource.Builder create() {
		return new BlogPostingImageResource.Builder() {
			...
			public BlogPostingImageResource build() {
				...
				return _blogPostingImageResourceProxyProviderFunction.apply(
			...
			@Override
			public BlogPostingImageResource.Builder checkPermissions(
			...
			@Override
			public BlogPostingImageResource.Builder httpServletRequest(
			...
			@Override
			public BlogPostingImageResource.Builder httpServletResponse(
			...
			@Override
			public BlogPostingImageResource.Builder preferredLocale(
			...
			@Override
			public BlogPostingImageResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		BlogPostingImageResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		BlogPostingImageResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, BlogPostingImageResource>
		...
		try {
			Constructor<BlogPostingImageResource> constructor =
				(Constructor<BlogPostingImageResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(blogPostingImageResource);
	...
	private static final Function<InvocationHandler, BlogPostingImageResource>
		_blogPostingImageResourceProxyProviderFunction =
			_getProxyProviderFunction();
