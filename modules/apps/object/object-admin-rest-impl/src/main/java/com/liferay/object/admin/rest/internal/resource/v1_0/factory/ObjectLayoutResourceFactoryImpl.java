...
public class ObjectLayoutResourceFactoryImpl
	...
	@Override
	public ObjectLayoutResource.Builder create() {
		return new ObjectLayoutResource.Builder() {
			...
			@Override
			public ObjectLayoutResource.Builder checkPermissions(
			...
			@Override
			public ObjectLayoutResource.Builder httpServletRequest(
			...
			@Override
			public ObjectLayoutResource.Builder httpServletResponse(
			...
			@Override
			public ObjectLayoutResource.Builder preferredLocale(
			...
			@Override
			public ObjectLayoutResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ObjectLayoutResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ObjectLayoutResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(objectLayoutResource);
