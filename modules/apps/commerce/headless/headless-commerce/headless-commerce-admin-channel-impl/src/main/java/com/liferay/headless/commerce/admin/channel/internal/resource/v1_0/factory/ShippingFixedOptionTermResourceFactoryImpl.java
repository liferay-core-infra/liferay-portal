...
@Generated("")
public class ShippingFixedOptionTermResourceFactoryImpl
	implements ShippingFixedOptionTermResource.Factory {

	@Override
	public ShippingFixedOptionTermResource.Builder create() {
		return new ShippingFixedOptionTermResource.Builder() {
			...
			@Override
			public ShippingFixedOptionTermResource.Builder checkPermissions(
			...
			@Override
			public ShippingFixedOptionTermResource.Builder httpServletRequest(
			...
			@Override
			public ShippingFixedOptionTermResource.Builder httpServletResponse(
			...
			@Override
			public ShippingFixedOptionTermResource.Builder preferredLocale(
			...
			@Override
			public ShippingFixedOptionTermResource.Builder user(User user) {
				_user = user;
