...
public class ObjectViewResourceFactoryImpl
	...
	@Override
	public ObjectViewResource.Builder create() {
		return new ObjectViewResource.Builder() {
			...
			@Override
			public ObjectViewResource.Builder checkPermissions(
			...
			@Override
			public ObjectViewResource.Builder httpServletRequest(
			...
			@Override
			public ObjectViewResource.Builder httpServletResponse(
			...
			@Override
			public ObjectViewResource.Builder preferredLocale(
			...
			@Override
			public ObjectViewResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ObjectViewResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ObjectViewResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, ObjectViewResource>
		...
		try {
			Constructor<ObjectViewResource> constructor =
				(Constructor<ObjectViewResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(objectViewResource);
