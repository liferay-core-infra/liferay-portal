...
public interface OverviewContentResource {
	...
	public HttpInvoker.HttpResponse getOverviewContentHttpResponse(
			String languageId, Integer rangeKey, Integer spaceId)
		throws Exception;
	...
	public static class Builder {
		...
		public OverviewContentResource build() {
			return new OverviewContentResourceImpl(this);
		}
	...
	public static class OverviewContentResourceImpl
		...
		public OverviewContent getOverviewContent(
			...
			HttpInvoker.HttpResponse httpResponse =
				getOverviewContentHttpResponse(languageId, rangeKey, spaceId);
			...
			try {
				return OverviewContentSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-cms-rest/v1.0/overview/content");
		...
		private OverviewContentResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OverviewContentResource.class.getName());
