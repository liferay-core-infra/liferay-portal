...
public class FVSActiveEntryUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByU_CDSDI_P_P() {

		return getPersistence().getFinderPathFetchByU_CDSDI_P_P();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByU_CDSDI_P_P() {

		return getPersistence().getFinderPathCountByU_CDSDI_P_P();
	}
