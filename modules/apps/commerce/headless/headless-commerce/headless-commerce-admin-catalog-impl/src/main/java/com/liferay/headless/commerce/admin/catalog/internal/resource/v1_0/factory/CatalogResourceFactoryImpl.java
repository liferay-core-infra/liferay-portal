 ...
 */
@Component(
	 immediate = true, service = CatalogResource.Factory.class
)
@Generated("")
public class CatalogResourceFactoryImpl implements CatalogResource.Factory {

	@Override
	public CatalogResource.Builder create() {
		return new CatalogResource.Builder() {
			...
			@Override
			public CatalogResource.Builder checkPermissions(
			...
			@Override
			public CatalogResource.Builder httpServletRequest(
			...
			@Override
			public CatalogResource.Builder httpServletResponse(
			...
			@Override
			public CatalogResource.Builder preferredLocale(
			...
			@Override
			public CatalogResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(catalogResource);
	...
	private ComponentServiceObjects<CatalogResource> _componentServiceObjects;
