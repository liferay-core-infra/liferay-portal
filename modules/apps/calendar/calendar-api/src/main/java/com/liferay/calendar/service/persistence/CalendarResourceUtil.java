...
public class CalendarResourceUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByC_LikeC_A() {

		return getPersistence().getFinderPathWithPaginationFindByC_LikeC_A();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationCountByC_LikeC_A() {

		return getPersistence().getFinderPathWithPaginationCountByC_LikeC_A();
	}
