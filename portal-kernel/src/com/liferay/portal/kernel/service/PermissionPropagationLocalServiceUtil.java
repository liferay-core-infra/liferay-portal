...
/**
 * Provides the local service utility for PermissionPropagation. This utility wraps
 * <code>com.liferay.portal.service.impl.PermissionPropagationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PermissionPropagationLocalServiceUtil {
	...
	public static PermissionPropagation addPermissionPropagation(
		...
		return getService().addPermissionPropagation(permissionPropagation);
	}
	 ...
	 */
	public static PermissionPropagation createPermissionPropagation(
		long permissionPropagationId) {

		return getService().createPermissionPropagation(
	 ...
	 */
	public static PermissionPropagation deletePermissionPropagation(
			long permissionPropagationId)
		throws PortalException {

		return getService().deletePermissionPropagation(
			permissionPropagationId);
	}
	...
	public static PermissionPropagation deletePermissionPropagation(
		...
		return getService().deletePermissionPropagation(permissionPropagation);
	}
	 ...
	 * @throws PortalException if a permission propagation with the primary key could not be found
	 */
	public static PermissionPropagation getPermissionPropagation(
			long permissionPropagationId)
		throws PortalException {

		return getService().getPermissionPropagation(permissionPropagationId);
	}
	 ...
	 */
	public static List<PermissionPropagation> getPermissionPropagations(
		int start, int end) {

		return getService().getPermissionPropagations(start, end);
	}
	 ...
	 */
	public static int getPermissionPropagationsCount() {
		return getService().getPermissionPropagationsCount();
	}
	...
	public static PermissionPropagation updatePermissionPropagation(
		...
		return getService().updatePermissionPropagation(permissionPropagation);
	}

	public static PermissionPropagationLocalService getService() {
		return _service;
	}

	public static void setService(PermissionPropagationLocalService service) {
		_service = service;
	}

	private static volatile PermissionPropagationLocalService _service;
