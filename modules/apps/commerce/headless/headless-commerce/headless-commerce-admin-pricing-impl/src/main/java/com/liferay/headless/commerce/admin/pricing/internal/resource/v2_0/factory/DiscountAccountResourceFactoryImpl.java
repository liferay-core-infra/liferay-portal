...
@Generated("")
public class DiscountAccountResourceFactoryImpl
	implements DiscountAccountResource.Factory {

	@Override
	public DiscountAccountResource.Builder create() {
		return new DiscountAccountResource.Builder() {
			...
			@Override
			public DiscountAccountResource.Builder checkPermissions(
			...
			@Override
			public DiscountAccountResource.Builder httpServletRequest(
			...
			@Override
			public DiscountAccountResource.Builder httpServletResponse(
			...
			@Override
			public DiscountAccountResource.Builder preferredLocale(
			...
			@Override
			public DiscountAccountResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(discountAccountResource);
