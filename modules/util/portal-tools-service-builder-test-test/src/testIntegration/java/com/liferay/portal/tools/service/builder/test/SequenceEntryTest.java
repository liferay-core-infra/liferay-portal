...
import com.liferay.portal.tools.service.builder.test.service.SequenceEntryLocalService;
...
public class SequenceEntryTest {
	...
	public void testAddSequenceEntry() {
		...
		sequenceEntry = _sequenceEntryLocalService.addSequenceEntry(
			sequenceEntry);

		Assert.assertEquals(
			sequenceEntry,
			_sequenceEntryLocalService.fetchSequenceEntry(
				sequenceEntry.getSequenceEntryId()));
	}
