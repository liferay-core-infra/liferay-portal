...
public class ObjectRelationshipResourceFactoryImpl
	...
	@Override
	public ObjectRelationshipResource.Builder create() {
		return new ObjectRelationshipResource.Builder() {
			...
			@Override
			public ObjectRelationshipResource.Builder checkPermissions(
			...
			@Override
			public ObjectRelationshipResource.Builder httpServletRequest(
			...
			@Override
			public ObjectRelationshipResource.Builder httpServletResponse(
			...
			@Override
			public ObjectRelationshipResource.Builder preferredLocale(
			...
			@Override
			public ObjectRelationshipResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(objectRelationshipResource);
