...
package com.liferay.document.library.internal.repository.cache;
 ...
 */
@Component(service = CacheRegistryItem.class)
public class PortalCacheRegistryItemImpl implements CacheRegistryItem {
