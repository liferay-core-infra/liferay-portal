...
public class SubscriptionResourceFactoryImpl
	...
	public SubscriptionResource.Builder create() {
		return new SubscriptionResource.Builder() {
			...
			public SubscriptionResource build() {
				...
				return _subscriptionResourceProxyProviderFunction.apply(
			...
			@Override
			public SubscriptionResource.Builder httpServletResponse(
			...
			@Override
			public SubscriptionResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, SubscriptionResource>
		...
		try {
			Constructor<SubscriptionResource> constructor =
				(Constructor<SubscriptionResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, SubscriptionResource>
		_subscriptionResourceProxyProviderFunction =
			_getProxyProviderFunction();
