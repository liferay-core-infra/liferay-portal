...
import com.liferay.wiki.web.internal.importer.WikiImporterRegistryImpl;
...
public class ImportPagesMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		try {
			renderRequest.setAttribute(
				WikiWebKeys.WIKI_IMPORTER_TRACKER, _wikiImporterRegistryImpl);
	...
	@Reference
	private WikiImporterRegistryImpl _wikiImporterRegistryImpl;
