...
public class AvailabilityEstimateResourceFactoryImpl
	...
	public AvailabilityEstimateResource.Builder create() {
		return new AvailabilityEstimateResource.Builder() {
			...
			public AvailabilityEstimateResource build() {
				...
				return _availabilityEstimateResourceProxyProviderFunction.apply(
			...
			@Override
			public AvailabilityEstimateResource.Builder httpServletRequest(
			...
			@Override
			public AvailabilityEstimateResource.Builder httpServletResponse(
			...
			@Override
			public AvailabilityEstimateResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, AvailabilityEstimateResource>
		...
		try {
			Constructor<AvailabilityEstimateResource> constructor =
				(Constructor<AvailabilityEstimateResource>)
	...
	private static final Function
		<InvocationHandler, AvailabilityEstimateResource>
			_availabilityEstimateResourceProxyProviderFunction =
				_getProxyProviderFunction();
