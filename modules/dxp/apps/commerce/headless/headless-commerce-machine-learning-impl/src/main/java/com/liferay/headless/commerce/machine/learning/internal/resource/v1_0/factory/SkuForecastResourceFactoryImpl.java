...
@Generated("")
public class SkuForecastResourceFactoryImpl
	implements SkuForecastResource.Factory {

	@Override
	public SkuForecastResource.Builder create() {
		return new SkuForecastResource.Builder() {
			...
			@Override
			public SkuForecastResource.Builder checkPermissions(
			...
			@Override
			public SkuForecastResource.Builder httpServletRequest(
			...
			@Override
			public SkuForecastResource.Builder httpServletResponse(
			...
			@Override
			public SkuForecastResource.Builder preferredLocale(
			...
			@Override
			public SkuForecastResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		SkuForecastResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		SkuForecastResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(skuForecastResource);
