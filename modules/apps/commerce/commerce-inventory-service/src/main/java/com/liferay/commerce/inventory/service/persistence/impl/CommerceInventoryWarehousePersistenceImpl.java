...
public class CommerceInventoryWarehousePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_A_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_A_C",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_A_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_A_C",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathCountByC_A_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A_C",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByC_A_C",
			_finderPathWithPaginationFindByC_A_C);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_A_C",
			_finderPathWithoutPaginationFindByC_A_C);

		_finderPaths.put("finderPathCountByC_A_C", _finderPathCountByC_A_C);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommerceInventoryWarehouse>> resultMap =
				new HashMap<>();
			...
			for (CommerceInventoryWarehouse commerceInventoryWarehouse :
				...
				if (Objects.equals(
					...
					List<CommerceInventoryWarehouse> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commerceInventoryWarehouse);
				}
			}

			for (Map.Entry<List<Object>, List<CommerceInventoryWarehouse>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommerceInventoryWarehouse> value = resultEntry.getValue();
