 ...
 * @generated
 */
@Component(service = {KaleoActionPersistence.class, BasePersistence.class})
public class KaleoActionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByKCN_KCPK = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByKCN_KCPK",
			new String[] {
		...
		_finderPathWithoutPaginationFindByKCN_KCPK = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByKCN_KCPK",
			new String[] {String.class.getName(), Long.class.getName()},
			new String[] {"kaleoClassName", "kaleoClassPK"}, true);

		_finderPathCountByKCN_KCPK = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByKCN_KCPK",
			new String[] {String.class.getName(), Long.class.getName()},
			new String[] {"kaleoClassName", "kaleoClassPK"}, false);

		_finderPathWithPaginationFindByC_KCN_KCPK = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_KCN_KCPK",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_KCN_KCPK = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_KCN_KCPK",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathWithPaginationFindByKCN_KCPK_ET = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByKCN_KCPK_ET",
			new String[] {
				String.class.getName(), Long.class.getName(),
		...
		_finderPathWithPaginationFindByC_KCN_KCPK_ET = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_KCN_KCPK_ET",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName(), String.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPaths.put(
			"finderPathCountByC_KCN_KCPK_ET", _finderPathCountByC_KCN_KCPK_ET);
