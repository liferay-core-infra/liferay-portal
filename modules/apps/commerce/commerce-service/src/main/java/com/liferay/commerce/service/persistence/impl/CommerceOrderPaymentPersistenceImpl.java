 ...
 */
@Component(
	service = {CommerceOrderPaymentPersistence.class, BasePersistence.class}
)
public class CommerceOrderPaymentPersistenceImpl
	...
	@Reference
	private CommerceOrderPaymentModelArgumentsResolver
		_commerceOrderPaymentModelArgumentsResolver;
