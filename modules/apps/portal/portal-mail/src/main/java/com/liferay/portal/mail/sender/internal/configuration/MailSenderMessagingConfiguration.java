...
package com.liferay.portal.mail.sender.internal.configuration;
 ...
 */
@ExtendedObjectClassDefinition(category = "mail-sender")
@Meta.OCD(
	id = "com.liferay.portal.mail.sender.internal.configuration.MailSenderMessagingConfiguration",
	localization = "content/Language", name = "mail-sender-configuration-name"
)
public interface MailSenderMessagingConfiguration {
