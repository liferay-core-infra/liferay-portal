 ...
 * @generated
 */
@Component(service = {CommerceDiscountPersistence.class, BasePersistence.class})
public class CommerceDiscountPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByLtE_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByLtE_S",
			new String[] {
				Date.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithPaginationCountByLtE_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByLtE_S",
			new String[] {Date.class.getName(), Integer.class.getName()},
			new String[] {"expirationDate", "status"}, false);

		_finderPathFetchByC_C_A = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByC_C_A",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathCountByC_C_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_C_A",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_L_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_L_A_S",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_L_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_L_A_S",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByC_L_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_L_A_S",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPaths.put("finderPathFetchByC_C_A", _finderPathFetchByC_C_A);

		_finderPaths.put("finderPathCountByC_C_A", _finderPathCountByC_C_A);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_L_A_S",
			_finderPathWithPaginationFindByC_L_A_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_L_A_S",
			_finderPathWithoutPaginationFindByC_L_A_S);

		_finderPaths.put("finderPathCountByC_L_A_S", _finderPathCountByC_L_A_S);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<CommerceDiscount> commerceDiscounts = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommerceDiscount>> resultMap =
				new HashMap<>();
			...
			for (CommerceDiscount commerceDiscount : commerceDiscounts) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						commerceDiscountModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), commerceDiscount);
				}
				else {
					List<CommerceDiscount> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commerceDiscount);
				}
			}

			for (Map.Entry<List<Object>, List<CommerceDiscount>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommerceDiscount> value = resultEntry.getValue();
