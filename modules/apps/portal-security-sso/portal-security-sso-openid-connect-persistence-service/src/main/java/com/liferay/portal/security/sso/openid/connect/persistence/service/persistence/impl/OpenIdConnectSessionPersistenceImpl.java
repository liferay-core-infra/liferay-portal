...
public class OpenIdConnectSessionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByU_A_C = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByU_A_C",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
		...
		_finderPathCountByU_A_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_A_C",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
		...
		_finderPaths.put("finderPathFetchByU_A_C", _finderPathFetchByU_A_C);

		_finderPaths.put("finderPathCountByU_A_C", _finderPathCountByU_A_C);
