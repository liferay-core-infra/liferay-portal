...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + FragmentEntryLinkInstanceableTestPortlet.ALIAS,
...
public class FragmentEntryLinkInstanceableTestPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "fragment-entry-link-instanceable";
