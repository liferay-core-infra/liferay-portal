...
import com.liferay.sharing.web.internal.filter.SharedAssetsFilterItemRegistryImpl;
...
public class ViewSharedAssetsDisplayContext {
	...
	public ViewSharedAssetsDisplayContext(
		...
		SharedAssetsFilterItemRegistryImpl sharedAssetsFilterItemRegistryImpl,
		...
		_sharedAssetsFilterItemRegistryImpl =
			sharedAssetsFilterItemRegistryImpl;
	...
	private String _getClassNameLabel(String className) {
		if (Validator.isNotNull(className)) {
			SharedAssetsFilterItem sharedAssetsFilterItem =
				_sharedAssetsFilterItemRegistryImpl.getSharedAssetsFilterItem(
					className);
	...
	private final SharedAssetsFilterItemRegistryImpl
		_sharedAssetsFilterItemRegistryImpl;
