...
public class CPDefinitionOptionValueRelPersistenceImpl
	...
	@Override
	public FinderPath getFinderPathWithPaginationFindByKey() {
		return _finderPathWithPaginationFindByKey;
	}
	...
	@Override
	public FinderPath getFinderPathWithPaginationFindByCDORI_P() {
		return _finderPathWithPaginationFindByCDORI_P;
	}
