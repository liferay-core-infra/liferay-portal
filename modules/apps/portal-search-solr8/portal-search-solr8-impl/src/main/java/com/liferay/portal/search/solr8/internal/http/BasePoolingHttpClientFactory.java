...
import com.liferay.portal.search.solr8.internal.interceptor.PreemptiveAuthInterceptor;
...
public abstract class BasePoolingHttpClientFactory
	...
	protected void applyProperties(HttpClientBuilder httpClientBuilder) {
		httpClientBuilder.addInterceptorFirst(_preemptiveAuthInterceptor);
	}
	...
	@Reference
	private PreemptiveAuthInterceptor _preemptiveAuthInterceptor;
