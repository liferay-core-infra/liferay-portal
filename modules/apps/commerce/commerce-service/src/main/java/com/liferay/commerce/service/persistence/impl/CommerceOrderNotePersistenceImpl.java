 ...
 */
@Component(
	service = {CommerceOrderNotePersistence.class, BasePersistence.class}
)
public class CommerceOrderNotePersistenceImpl
	...
	@Reference
	private CommerceOrderNoteModelArgumentsResolver
		_commerceOrderNoteModelArgumentsResolver;
