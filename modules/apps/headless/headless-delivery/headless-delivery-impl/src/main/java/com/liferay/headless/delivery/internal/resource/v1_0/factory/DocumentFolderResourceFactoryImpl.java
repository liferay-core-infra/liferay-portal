...
public class DocumentFolderResourceFactoryImpl
	...
	@Override
	public DocumentFolderResource.Builder create() {
		return new DocumentFolderResource.Builder() {
			...
			public DocumentFolderResource build() {
				...
				return _documentFolderResourceProxyProviderFunction.apply(
			...
			@Override
			public DocumentFolderResource.Builder checkPermissions(
			...
			@Override
			public DocumentFolderResource.Builder httpServletRequest(
			...
			@Override
			public DocumentFolderResource.Builder httpServletResponse(
			...
			@Override
			public DocumentFolderResource.Builder preferredLocale(
			...
			@Override
			public DocumentFolderResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		DocumentFolderResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		DocumentFolderResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, DocumentFolderResource>
		...
		try {
			Constructor<DocumentFolderResource> constructor =
				(Constructor<DocumentFolderResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(documentFolderResource);
	...
	private static final Function<InvocationHandler, DocumentFolderResource>
		_documentFolderResourceProxyProviderFunction =
			_getProxyProviderFunction();
