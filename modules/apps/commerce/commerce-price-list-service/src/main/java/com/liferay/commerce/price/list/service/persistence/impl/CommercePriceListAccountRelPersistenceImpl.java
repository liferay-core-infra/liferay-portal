...
public class CommercePriceListAccountRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByCAI_CPI = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByCAI_CPI",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"commerceAccountId", "commercePriceListId"}, true);

		_finderPathCountByCAI_CPI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCAI_CPI",
			new String[] {Long.class.getName(), Long.class.getName()},
		...
		_finderPaths.put("finderPathFetchByCAI_CPI", _finderPathFetchByCAI_CPI);

		_finderPaths.put("finderPathCountByCAI_CPI", _finderPathCountByCAI_CPI);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommercePriceListAccountRel>> resultMap =
				new HashMap<>();
			...
			for (CommercePriceListAccountRel commercePriceListAccountRel :
				...
				if (Objects.equals(
					...
					List<CommercePriceListAccountRel> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commercePriceListAccountRel);
				}
			}

			for (Map.Entry<List<Object>, List<CommercePriceListAccountRel>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommercePriceListAccountRel> value =
