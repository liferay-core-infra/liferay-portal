...
@Generated("")
public class OrderTypeChannelResourceFactoryImpl
	implements OrderTypeChannelResource.Factory {

	@Override
	public OrderTypeChannelResource.Builder create() {
		return new OrderTypeChannelResource.Builder() {
			...
			public OrderTypeChannelResource build() {
				...
				return _orderTypeChannelResourceProxyProviderFunction.apply(
			...
			@Override
			public OrderTypeChannelResource.Builder checkPermissions(
			...
			@Override
			public OrderTypeChannelResource.Builder httpServletRequest(
			...
			@Override
			public OrderTypeChannelResource.Builder httpServletResponse(
			...
			@Override
			public OrderTypeChannelResource.Builder preferredLocale(
			...
			@Override
			public OrderTypeChannelResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		OrderTypeChannelResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		OrderTypeChannelResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, OrderTypeChannelResource>
		...
		try {
			Constructor<OrderTypeChannelResource> constructor =
				(Constructor<OrderTypeChannelResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(orderTypeChannelResource);
	...
	private static final Function<InvocationHandler, OrderTypeChannelResource>
		_orderTypeChannelResourceProxyProviderFunction =
			_getProxyProviderFunction();
