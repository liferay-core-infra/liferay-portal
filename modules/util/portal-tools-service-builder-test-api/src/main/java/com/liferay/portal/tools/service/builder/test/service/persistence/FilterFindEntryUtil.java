...
public class FilterFindEntryUtil {
	 ...
	 */
	public static List<FilterFindEntry> findByG_I_T(
		long groupId, int integer, String type) {

		return getPersistence().findByG_I_T(groupId, integer, type);
	}
	...
	public static List<FilterFindEntry> findByG_I_T(
		...
		return getPersistence().findByG_I_T(groupId, integer, type, start, end);
	}
	...
	public static List<FilterFindEntry> findByG_I_T(
		...
		return getPersistence().findByG_I_T(
	 ...
	 */
	public static FilterFindEntry findByG_I_T_First(
			long groupId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().findByG_I_T_First(
	 ...
	 */
	public static FilterFindEntry fetchByG_I_T_First(
		long groupId, int integer, String type,
		OrderByComparator<FilterFindEntry> orderByComparator) {

		return getPersistence().fetchByG_I_T_First(
			groupId, integer, type, orderByComparator);
	}
	 ...
	 * @throws NoSuchFilterFindEntryException if a matching filter find entry could not be found
	 */
	public static FilterFindEntry findByG_I_T_Last(
			long groupId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().findByG_I_T_Last(
			groupId, integer, type, orderByComparator);
	}
	 ...
	 */
	public static FilterFindEntry fetchByG_I_T_Last(
		long groupId, int integer, String type,
		OrderByComparator<FilterFindEntry> orderByComparator) {

		return getPersistence().fetchByG_I_T_Last(
			groupId, integer, type, orderByComparator);
	}
	 ...
	 */
	public static FilterFindEntry[] findByG_I_T_PrevAndNext(
			long filterFindEntryId, long groupId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().findByG_I_T_PrevAndNext(
	 ...
	 */
	public static List<FilterFindEntry> filterFindByG_I_T(
		long groupId, int integer, String type) {

		return getPersistence().filterFindByG_I_T(groupId, integer, type);
	}
	...
	public static List<FilterFindEntry> filterFindByG_I_T(
		...
		return getPersistence().filterFindByG_I_T(
			groupId, integer, type, start, end);
	}
	 ...
	 * @throws NoSuchFilterFindEntryException if a filter find entry with the primary key could not be found
	 */
	public static FilterFindEntry[] filterFindByG_I_T_PrevAndNext(
			long filterFindEntryId, long groupId, int integer, String type,
			OrderByComparator<FilterFindEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchFilterFindEntryException {

		return getPersistence().filterFindByG_I_T_PrevAndNext(
			filterFindEntryId, groupId, integer, type, orderByComparator);
	}
	...
	public static List<FilterFindEntry> filterFindByG_I_T(
		...
		return getPersistence().filterFindByG_I_T(groupId, integer, types);
	}
	...
	public static List<FilterFindEntry> filterFindByG_I_T(
		...
		return getPersistence().filterFindByG_I_T(
			groupId, integer, types, start, end);
	}
	...
	public static List<FilterFindEntry> findByG_I_T(
		...
		return getPersistence().findByG_I_T(groupId, integer, types);
	}
	 ...
	 * @param type the type
	 */
	public static void removeByG_I_T(long groupId, int integer, String type) {
		getPersistence().removeByG_I_T(groupId, integer, type);
	}
	 ...
	 */
	public static int countByG_I_T(long groupId, int integer, String type) {
		return getPersistence().countByG_I_T(groupId, integer, type);
	}
	 ...
	 * @return the number of matching filter find entries
	 */
	public static int countByG_I_T(long groupId, int integer, String[] types) {
		return getPersistence().countByG_I_T(groupId, integer, types);
	}
	 ...
	 */
	public static int filterCountByG_I_T(
		long groupId, int integer, String type) {

		return getPersistence().filterCountByG_I_T(groupId, integer, type);
	}
	...
	public static int filterCountByG_I_T(
		...
		return getPersistence().filterCountByG_I_T(groupId, integer, types);
	}
