...
public class CommerceWishListUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByU_LtC() {

		return getPersistence().getFinderPathWithPaginationFindByU_LtC();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationCountByU_LtC() {

		return getPersistence().getFinderPathWithPaginationCountByU_LtC();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByG_U_D() {

		return getPersistence().getFinderPathWithPaginationFindByG_U_D();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByG_U_D() {

		return getPersistence().getFinderPathWithoutPaginationFindByG_U_D();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByG_U_D() {

		return getPersistence().getFinderPathCountByG_U_D();
	}
