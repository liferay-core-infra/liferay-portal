...
public final class CompanyWebIdConsoleAppender extends AbstractAppender {
	...
	public static class Builder
		...
		public CompanyWebIdConsoleAppender build() {
			return new CompanyWebIdConsoleAppender(
				_bufferedIo, _bufferSize, _direct, _enabled, getFilter(),
				_follow, _immediateFlush, getLayout(), getName(), _target);
		}
		...
		@PluginBuilderAttribute("enabled")
		@Required
	...
	private CompanyWebIdConsoleAppender(
		boolean bufferedIo, int bufferSize, boolean direct, boolean enabled,
		Filter filter, boolean follow, boolean immediateFlush,
