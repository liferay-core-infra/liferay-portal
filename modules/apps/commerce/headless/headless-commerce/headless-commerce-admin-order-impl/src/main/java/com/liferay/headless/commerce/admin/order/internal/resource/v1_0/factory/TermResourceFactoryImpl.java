 ...
 */
@Component(
	 immediate = true, service = TermResource.Factory.class
)
@Generated("")
public class TermResourceFactoryImpl implements TermResource.Factory {

	@Override
	public TermResource.Builder create() {
		return new TermResource.Builder() {
			...
			@Override
			public TermResource.Builder checkPermissions(
			...
			@Override
			public TermResource.Builder httpServletRequest(
			...
			@Override
			public TermResource.Builder httpServletResponse(
			...
			@Override
			public TermResource.Builder preferredLocale(
			...
			@Override
			public TermResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(termResource);
	...
	private ComponentServiceObjects<TermResource> _componentServiceObjects;
