...
@Generated("")
public class DiscountSkuResourceFactoryImpl
	implements DiscountSkuResource.Factory {

	@Override
	public DiscountSkuResource.Builder create() {
		return new DiscountSkuResource.Builder() {
			...
			@Override
			public DiscountSkuResource.Builder checkPermissions(
			...
			@Override
			public DiscountSkuResource.Builder httpServletRequest(
			...
			@Override
			public DiscountSkuResource.Builder httpServletResponse(
			...
			@Override
			public DiscountSkuResource.Builder preferredLocale(
			...
			@Override
			public DiscountSkuResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		DiscountSkuResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		DiscountSkuResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, DiscountSkuResource>
		...
		try {
			Constructor<DiscountSkuResource> constructor =
				(Constructor<DiscountSkuResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(discountSkuResource);
