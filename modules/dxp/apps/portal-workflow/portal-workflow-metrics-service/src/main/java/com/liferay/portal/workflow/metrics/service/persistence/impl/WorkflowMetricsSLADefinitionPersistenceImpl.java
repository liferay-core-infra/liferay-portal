...
public class WorkflowMetricsSLADefinitionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByWMSLAD_A = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByWMSLAD_A",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"wmSLADefinitionId", "active_"}, true);

		_finderPathCountByWMSLAD_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByWMSLAD_A",
			new String[] {Long.class.getName(), Boolean.class.getName()},
		...
		_finderPathWithPaginationFindByC_A_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_A_P",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_A_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_A_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathCountByC_A_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_A_N_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_A_N_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_A_N_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_A_N_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Long.class.getName()
			},
		...
		_finderPathCountByC_A_N_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A_N_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Long.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_A_P_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_A_P_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_A_P_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_A_P_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByC_A_P_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A_P_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_A_P_NotPV_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_A_P_NotPV_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPaths.put(
			"finderPathFetchByWMSLAD_A", _finderPathFetchByWMSLAD_A);

		_finderPaths.put(
			"finderPathCountByWMSLAD_A", _finderPathCountByWMSLAD_A);
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByC_A_P",
			_finderPathWithPaginationFindByC_A_P);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_A_P",
			_finderPathWithoutPaginationFindByC_A_P);

		_finderPaths.put("finderPathCountByC_A_P", _finderPathCountByC_A_P);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_A_N_P",
			_finderPathWithPaginationFindByC_A_N_P);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_A_N_P",
			_finderPathWithoutPaginationFindByC_A_N_P);

		_finderPaths.put("finderPathCountByC_A_N_P", _finderPathCountByC_A_N_P);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_A_P_S",
			_finderPathWithPaginationFindByC_A_P_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_A_P_S",
			_finderPathWithoutPaginationFindByC_A_P_S);

		_finderPaths.put("finderPathCountByC_A_P_S", _finderPathCountByC_A_P_S);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_A_P_NotPV_S",
			_finderPathWithPaginationFindByC_A_P_NotPV_S);

		_finderPaths.put(
			"finderPathWithPaginationCountByC_A_P_NotPV_S",
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<WorkflowMetricsSLADefinition>> resultMap =
				new HashMap<>();
			...
			for (WorkflowMetricsSLADefinition workflowMetricsSLADefinition :
				...
				if (Objects.equals(
					...
					List<WorkflowMetricsSLADefinition> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(workflowMetricsSLADefinition);
				}
			}

			for (Map.Entry<List<Object>, List<WorkflowMetricsSLADefinition>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<WorkflowMetricsSLADefinition> value =
