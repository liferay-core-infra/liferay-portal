...
public class SXPElementPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_R = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_R",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_R = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_R",
		...
		_finderPathWithPaginationFindByC_T_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_T_S",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_T_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_T_S",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
		...
		_finderPathCountByC_T_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_T_S",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByC_T_S",
			_finderPathWithPaginationFindByC_T_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_T_S",
			_finderPathWithoutPaginationFindByC_T_S);

		_finderPaths.put("finderPathCountByC_T_S", _finderPathCountByC_T_S);
