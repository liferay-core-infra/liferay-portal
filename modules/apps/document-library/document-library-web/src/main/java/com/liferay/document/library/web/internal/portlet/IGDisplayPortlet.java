...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + IGDisplayPortlet.ALIAS,
...
public class IGDisplayPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "media-gallery";
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, DLPortletKeys.MEDIA_GALLERY_DISPLAY);
	}
