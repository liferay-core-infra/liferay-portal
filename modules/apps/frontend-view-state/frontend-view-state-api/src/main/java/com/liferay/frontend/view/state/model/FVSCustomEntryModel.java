...
/**
 * The base model interface for the FVSCustomEntry service. Represents a row in the &quot;FVSCustomEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.frontend.view.state.model.impl.FVSCustomEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.frontend.view.state.model.impl.FVSCustomEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FVSCustomEntryModel
	extends BaseModel<FVSCustomEntry>, ContainerModel, MVCCModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a fvs custom entry model instance should use the {@link FVSCustomEntry} interface instead.
	 */
