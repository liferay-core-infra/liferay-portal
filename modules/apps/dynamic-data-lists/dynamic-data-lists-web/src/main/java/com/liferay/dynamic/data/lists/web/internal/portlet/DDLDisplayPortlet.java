...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + DDLDisplayPortlet.ALIAS,
...
public class DDLDisplayPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "dynamic-data-list";
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, DDLPortletKeys.DYNAMIC_DATA_LISTS_DISPLAY);
	}
