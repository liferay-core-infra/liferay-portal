...
public class MBBanPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByBanUserId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByBanUserId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathWithoutPaginationFindByBanUserId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByBanUserId",
			new String[] {Long.class.getName()}, new String[] {"banUserId"},
			true);

		_finderPathCountByBanUserId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByBanUserId",
			new String[] {Long.class.getName()}, new String[] {"banUserId"},
			false);

		_finderPathFetchByG_B = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByG_B",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"groupId", "banUserId"}, true);

		_finderPathCountByG_B = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_B",
			new String[] {Long.class.getName(), Long.class.getName()},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByBanUserId",
			_finderPathWithPaginationFindByBanUserId);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByBanUserId",
			_finderPathWithoutPaginationFindByBanUserId);

		_finderPaths.put(
			"finderPathCountByBanUserId", _finderPathCountByBanUserId);

		_finderPaths.put("finderPathFetchByG_B", _finderPathFetchByG_B);

		_finderPaths.put("finderPathCountByG_B", _finderPathCountByG_B);
