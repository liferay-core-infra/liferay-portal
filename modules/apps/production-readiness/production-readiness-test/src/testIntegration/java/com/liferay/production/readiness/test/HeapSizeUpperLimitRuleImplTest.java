...
public class HeapSizeUpperLimitRuleImplTest {
	...
	@Test
	public void testHeapSizeUpperLimitRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getHeapSizeUpperLimitRuleServiceReference(bundleContext);
	...
	@Test
	public void testHeapSizeUpperLimitRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			HeapSizeUpperLimitRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getHeapSizeUpperLimitRuleServiceReference(
	...
	private static final String _RULE_KEY = "heap-size-upper-limit";
