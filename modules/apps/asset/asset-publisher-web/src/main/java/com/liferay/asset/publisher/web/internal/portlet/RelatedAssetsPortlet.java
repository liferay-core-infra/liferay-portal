...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + RelatedAssetsPortlet.ALIAS,
...
public class RelatedAssetsPortlet extends AssetPublisherPortlet {
	...
	public static final String ALIAS = "related-assets";

	@Activate
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, AssetPublisherPortletKeys.RELATED_ASSETS);
	}
