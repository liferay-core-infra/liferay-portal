...
import com.liferay.translation.internal.importer.XLIFFInfoFormTranslationImporter;
...
public class XLIFFTranslationImporterUtil {
	...
	public static TranslationSnapshot getTranslationSnapshot(
	...
	private static InfoField _createInfoField(Locale locale, String value) {
	...
	private static InfoItemFieldValues _getInfoItemFieldValuesXLIFFv12(
	...
	private static InfoItemFieldValues _getInfoItemFieldValuesXLIFFv20(
		...
		return InfoItemFieldValues.builder(
			...
			_getInfoItemReference((List<Event>)xliffDocument)
		).build();
	}

	private static InfoItemReference _getInfoItemReference(List<Event> events)
		throws XLIFFFileException {
	...
	private static String[] _getNamespaceAndNameArray(String value) {
	...
	private static long _getSegmentsExperienceClassPK(
	...
	private static Locale _getSourceLocale(StartSubDocument startSubDocument) {
	...
	private static StartSubDocument _getStartSubdocument(List<Event> events) {
		for (Event event : events) {
			if (event.isStartSubDocument()) {
	...
	private static Locale _getTargetLocale(StartSubDocument startSubDocument) {
	...
	private static boolean _isVersion20(List<Event> events) {
		for (Event event : events) {
	...
	private static void _produceInfoFieldValuesXLIFFv12(
	...
	private static void _produceInfoFieldValuesXLIFFv20(
			UnsafeConsumer<InfoFieldValue<Object>, XLIFFFileException>
				unsafeConsumer,
	...
	private static void _validateDocumentPartVersion(List<Event> events)
	...
	private static void _validateWellFormedTextUnit(
	...
	private static void _validateXLIFFCompletion(
	...
	private static void _validateXLIFFDocumentName(
	...
	private static void _validateXLIFFFile(
			long groupId, InfoItemReference infoItemReference,
	...
	private static void _validateXLIFFFileNode(
	...
	private static void _validateXLIFFStartSubdocument(
			InfoItemReference infoItemReference,
			StartSubDocument startSubDocument)
		throws XLIFFFileException {
