...
@Generated("")
public class ShippingFixedOptionOrderTypeResourceFactoryImpl
	implements ShippingFixedOptionOrderTypeResource.Factory {

	@Override
	public ShippingFixedOptionOrderTypeResource.Builder create() {
		return new ShippingFixedOptionOrderTypeResource.Builder() {
			...
			@Override
			public ShippingFixedOptionOrderTypeResource.Builder
			...
			@Override
			public ShippingFixedOptionOrderTypeResource.Builder preferredLocale(
			...
			@Override
			public ShippingFixedOptionOrderTypeResource.Builder user(
				User user) {
	...
	protected void activate() {
		ShippingFixedOptionOrderTypeResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ShippingFixedOptionOrderTypeResource.FactoryHolder.factory = null;
	}
