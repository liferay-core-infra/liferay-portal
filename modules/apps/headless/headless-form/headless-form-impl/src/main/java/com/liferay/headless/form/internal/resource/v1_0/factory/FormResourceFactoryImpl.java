...
public class FormResourceFactoryImpl implements FormResource.Factory {
	...
	@Override
	public FormResource.Builder create() {
		return new FormResource.Builder() {
			...
			@Override
			public FormResource.Builder checkPermissions(
			...
			@Override
			public FormResource.Builder httpServletRequest(
			...
			@Override
			public FormResource.Builder httpServletResponse(
			...
			@Override
			public FormResource.Builder preferredLocale(
			...
			@Override
			public FormResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		FormResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		FormResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(formResource);
	...
	private ComponentServiceObjects<FormResource> _componentServiceObjects;
