...
@Component(
	...
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + AssetPublisherPortlet.ALIAS,
...
public class AssetPublisherPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "asset-list";
	...
	protected void activate(Map<String, Object> properties) {
		...
		portletRegistry.registerAlias(
			ALIAS, AssetPublisherPortletKeys.ASSET_PUBLISHER);
	}
