...
public class PriceModifierProductGroupResourceFactoryImpl
	implements PriceModifierProductGroupResource.Factory {

	@Override
	public PriceModifierProductGroupResource.Builder create() {
		return new PriceModifierProductGroupResource.Builder() {
			...
			@Override
			public PriceModifierProductGroupResource.Builder checkPermissions(
			...
			@Override
			public PriceModifierProductGroupResource.Builder httpServletRequest(
			...
			@Override
			public PriceModifierProductGroupResource.Builder preferredLocale(
			...
			@Override
			public PriceModifierProductGroupResource.Builder user(User user) {
				_user = user;
