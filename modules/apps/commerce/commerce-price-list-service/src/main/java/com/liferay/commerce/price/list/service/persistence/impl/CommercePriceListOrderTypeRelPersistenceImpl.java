...
@Component(
	service = {
		CommercePriceListOrderTypeRelPersistence.class, BasePersistence.class
	}
)
public class CommercePriceListOrderTypeRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByCPI_COTI = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByCPI_COTI",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"commercePriceListId", "commerceOrderTypeId"}, true);

		_finderPathCountByCPI_COTI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCPI_COTI",
			new String[] {Long.class.getName(), Long.class.getName()},
		...
		_finderPaths.put(
			"finderPathFetchByCPI_COTI", _finderPathFetchByCPI_COTI);

		_finderPaths.put(
			"finderPathCountByCPI_COTI", _finderPathCountByCPI_COTI);
