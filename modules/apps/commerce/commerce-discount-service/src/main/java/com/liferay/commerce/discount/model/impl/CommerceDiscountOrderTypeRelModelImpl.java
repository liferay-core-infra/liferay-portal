...
/**
 * The base model implementation for the CommerceDiscountOrderTypeRel service. Represents a row in the &quot;CommerceDiscountOrderTypeRel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface <code>CommerceDiscountOrderTypeRelModel</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CommerceDiscountOrderTypeRelImpl}.
 * </p>
 *
 * @author Marco Leo
 ...
 */
@JSON(strict = true)
public class CommerceDiscountOrderTypeRelModelImpl
	extends BaseModelImpl<CommerceDiscountOrderTypeRel>
	implements CommerceDiscountOrderTypeRelModel {
	 ...
	 */
	public static final String TABLE_NAME = "CommerceDiscountOrderTypeRel";

	public static final Object[][] TABLE_COLUMNS = {
		{"mvccVersion", Types.BIGINT}, {"uuid_", Types.VARCHAR},
		{"commerceDiscountOrderTypeRelId", Types.BIGINT},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("commerceDiscountOrderTypeRelId", Types.BIGINT);
	...
	public void setPrimaryKey(long primaryKey) {
		setCommerceDiscountOrderTypeRelId(primaryKey);
	}
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<CommerceDiscountOrderTypeRel, Object>>
			attributeSetterBiConsumers = getAttributeSetterBiConsumers();

		for (Map.Entry<String, Object> entry : attributes.entrySet()) {
			String attributeName = entry.getKey();

			BiConsumer<CommerceDiscountOrderTypeRel, Object>
				attributeSetterBiConsumer = attributeSetterBiConsumers.get(
					attributeName);

			if (attributeSetterBiConsumer != null) {
				attributeSetterBiConsumer.accept(
					(CommerceDiscountOrderTypeRel)this, entry.getValue());
			}
		}
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			getCompanyId(), CommerceDiscountOrderTypeRel.class.getName(),
			getPrimaryKey());
	}
	...
	@Override
	public CommerceDiscountOrderTypeRel toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, CommerceDiscountOrderTypeRel>
	...
	public Object clone() {
		...
		commerceDiscountOrderTypeRelImpl.setMvccVersion(getMvccVersion());
		commerceDiscountOrderTypeRelImpl.setUuid(getUuid());
		commerceDiscountOrderTypeRelImpl.setCommerceDiscountOrderTypeRelId(
			getCommerceDiscountOrderTypeRelId());
		commerceDiscountOrderTypeRelImpl.setCompanyId(getCompanyId());
		commerceDiscountOrderTypeRelImpl.setUserId(getUserId());
		commerceDiscountOrderTypeRelImpl.setUserName(getUserName());
		commerceDiscountOrderTypeRelImpl.setCreateDate(getCreateDate());
		commerceDiscountOrderTypeRelImpl.setModifiedDate(getModifiedDate());
		...
		commerceDiscountOrderTypeRelImpl.setPriority(getPriority());
	...
	public CommerceDiscountOrderTypeRel cloneWithOriginalValues() {
		...
		commerceDiscountOrderTypeRelImpl.setMvccVersion(
	...
	public int compareTo(
		...
		if (getPriority() < commerceDiscountOrderTypeRel.getPriority()) {
			value = -1;
		}
		else if (getPriority() > commerceDiscountOrderTypeRel.getPriority()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CommerceDiscountOrderTypeRel)) {
			return false;
		}

		CommerceDiscountOrderTypeRel commerceDiscountOrderTypeRel =
			(CommerceDiscountOrderTypeRel)object;

		long primaryKey = commerceDiscountOrderTypeRel.getPrimaryKey();
	...
	@Override
	public CacheModel<CommerceDiscountOrderTypeRel> toCacheModel() {
		CommerceDiscountOrderTypeRelCacheModel
			commerceDiscountOrderTypeRelCacheModel =
				new CommerceDiscountOrderTypeRelCacheModel();

		commerceDiscountOrderTypeRelCacheModel.mvccVersion = getMvccVersion();

		commerceDiscountOrderTypeRelCacheModel.uuid = getUuid();

		String uuid = commerceDiscountOrderTypeRelCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			commerceDiscountOrderTypeRelCacheModel.uuid = null;
		}

		commerceDiscountOrderTypeRelCacheModel.commerceDiscountOrderTypeRelId =
			getCommerceDiscountOrderTypeRelId();

		commerceDiscountOrderTypeRelCacheModel.companyId = getCompanyId();

		commerceDiscountOrderTypeRelCacheModel.userId = getUserId();

		commerceDiscountOrderTypeRelCacheModel.userName = getUserName();

		String userName = commerceDiscountOrderTypeRelCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			commerceDiscountOrderTypeRelCacheModel.userName = null;
		}

		Date createDate = getCreateDate();

		if (createDate != null) {
			commerceDiscountOrderTypeRelCacheModel.createDate =
				createDate.getTime();
		}
		else {
			commerceDiscountOrderTypeRelCacheModel.createDate = Long.MIN_VALUE;
		}

		Date modifiedDate = getModifiedDate();

		if (modifiedDate != null) {
			commerceDiscountOrderTypeRelCacheModel.modifiedDate =
		...
		commerceDiscountOrderTypeRelCacheModel.commerceDiscountId =
			getCommerceDiscountId();

		commerceDiscountOrderTypeRelCacheModel.commerceOrderTypeId =
			getCommerceOrderTypeId();

		commerceDiscountOrderTypeRelCacheModel.priority = getPriority();

		Date lastPublishDate = getLastPublishDate();

		if (lastPublishDate != null) {
			commerceDiscountOrderTypeRelCacheModel.lastPublishDate =
		...
		return commerceDiscountOrderTypeRelCacheModel;
	}
	...
	public <T> T getColumnValue(String columnName) {
		...
		return (T)function.apply((CommerceDiscountOrderTypeRel)this);
	}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put(
			"commerceDiscountOrderTypeRelId", _commerceDiscountOrderTypeRelId);
	...
	static {
		...
		columnBitmasks.put("commerceDiscountOrderTypeRelId", 4L);
