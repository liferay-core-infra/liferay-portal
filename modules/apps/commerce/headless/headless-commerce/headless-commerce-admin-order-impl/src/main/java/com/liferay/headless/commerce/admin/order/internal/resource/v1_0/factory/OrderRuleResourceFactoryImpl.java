 ...
 */
@Component(
	 immediate = true, service = OrderRuleResource.Factory.class
)
@Generated("")
public class OrderRuleResourceFactoryImpl implements OrderRuleResource.Factory {

	@Override
	public OrderRuleResource.Builder create() {
		return new OrderRuleResource.Builder() {
			...
			public OrderRuleResource build() {
				...
				return _orderRuleResourceProxyProviderFunction.apply(
			...
			@Override
			public OrderRuleResource.Builder checkPermissions(
			...
			@Override
			public OrderRuleResource.Builder httpServletRequest(
			...
			@Override
			public OrderRuleResource.Builder httpServletResponse(
			...
			@Override
			public OrderRuleResource.Builder preferredLocale(
			...
			@Override
			public OrderRuleResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, OrderRuleResource>
		...
		try {
			Constructor<OrderRuleResource> constructor =
				(Constructor<OrderRuleResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(orderRuleResource);
	...
	private static final Function<InvocationHandler, OrderRuleResource>
		_orderRuleResourceProxyProviderFunction = _getProxyProviderFunction();

	@Reference
	private CompanyLocalService _companyLocalService;

	@Reference(scope = ReferenceScope.PROTOTYPE_REQUIRED)
	private ComponentServiceObjects<OrderRuleResource> _componentServiceObjects;
