...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + SiteNavigationMenuPortlet.ALIAS,
...
public class SiteNavigationMenuPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "nav";

	@Activate
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, SiteNavigationMenuPortletKeys.SITE_NAVIGATION_MENU);
	}
