...
@Generated("")
public class PlacedOrderItemShipmentResourceFactoryImpl
	implements PlacedOrderItemShipmentResource.Factory {

	@Override
	public PlacedOrderItemShipmentResource.Builder create() {
		return new PlacedOrderItemShipmentResource.Builder() {
			...
			@Override
			public PlacedOrderItemShipmentResource.Builder checkPermissions(
			...
			@Override
			public PlacedOrderItemShipmentResource.Builder httpServletRequest(
			...
			@Override
			public PlacedOrderItemShipmentResource.Builder httpServletResponse(
			...
			@Override
			public PlacedOrderItemShipmentResource.Builder preferredLocale(
			...
			@Override
			public PlacedOrderItemShipmentResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PlacedOrderItemShipmentResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PlacedOrderItemShipmentResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, PlacedOrderItemShipmentResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PlacedOrderItemShipmentResource.class.getClassLoader(),
			PlacedOrderItemShipmentResource.class);

		try {
			Constructor<PlacedOrderItemShipmentResource> constructor =
				(Constructor<PlacedOrderItemShipmentResource>)
