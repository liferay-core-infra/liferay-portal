...
public class SegmentUserResourceFactoryImpl
	...
	@Override
	public SegmentUserResource.Builder create() {
		return new SegmentUserResource.Builder() {
			...
			@Override
			public SegmentUserResource.Builder checkPermissions(
			...
			@Override
			public SegmentUserResource.Builder httpServletRequest(
			...
			@Override
			public SegmentUserResource.Builder httpServletResponse(
			...
			@Override
			public SegmentUserResource.Builder preferredLocale(
			...
			@Override
			public SegmentUserResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		SegmentUserResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		SegmentUserResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, SegmentUserResource>
		...
		try {
			Constructor<SegmentUserResource> constructor =
				(Constructor<SegmentUserResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(segmentUserResource);
