...
/**
 * Provides the local service interface for BadColumnNameEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BadColumnNameEntryLocalServiceUtil
 * @generated
 */
@OSGiBeanProperties(
	property = {
		"model.class.name=com.liferay.portal.tools.service.builder.test.model.BadColumnNameEntry"
	}
)
@ProviderType
@Transactional(
...
public interface BadColumnNameEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.BadColumnNameEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bad column name entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BadColumnNameEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BadColumnNameEntry> getBadColumnNameEntries(int start, int end);
