...
public class SocialActivityLimitPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByG_U_C_C_A_A = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByG_U_C_C_A_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Long.class.getName(),
		...
		_finderPaths.put(
			"finderPathFetchByG_U_C_C_A_A", _finderPathFetchByG_U_C_C_A_A);

		_finderPaths.put(
			"finderPathCountByG_U_C_C_A_A", _finderPathCountByG_U_C_C_A_A);
