...
public class ViewFileVersionContentDashboardItemVersionActionProviderTest {
	...
	public void testGetContentDashboardItemAction() throws Exception {
		...
		Assert.assertEquals(
			"view", contentDashboardItemVersionAction.getName());
		Assert.assertEquals(
			"view", contentDashboardItemVersionAction.getIcon());
		Assert.assertEquals(
			_language.get(LocaleUtil.US, "view"),
		...
		Assert.assertTrue(
			url.contains(
				"mvcRenderCommandName=" +
					HtmlUtil.escapeURL("/document_library/view_file_entry")));
	...
	@Inject(
		filter = "component.name=com.liferay.content.dashboard.document.library.internal.item.action.provider.ViewFileVersionContentDashboardItemVersionActionProvider"
	)
