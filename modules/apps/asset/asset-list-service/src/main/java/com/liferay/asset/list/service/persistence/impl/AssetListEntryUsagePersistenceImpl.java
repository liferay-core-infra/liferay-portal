...
public class AssetListEntryUsagePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByA_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByA_C",
			new String[] {
		...
		_finderPathWithoutPaginationFindByA_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA_C",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"assetListEntryId", "classNameId"}, true);

		_finderPathCountByA_C = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_C",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"assetListEntryId", "classNameId"}, false);

		_finderPathWithPaginationFindByG_C_K = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_C_K",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_C_K = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_C_K",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_C_K = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_C_K",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			},
		...
		_finderPathWithPaginationFindByCK_CT_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCK_CT_P",
			new String[] {
				String.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByCK_CT_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCK_CT_P",
			new String[] {
				String.class.getName(), Long.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathCountByCK_CT_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCK_CT_P",
			new String[] {
				String.class.getName(), Long.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_C_K_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_C_K_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_C_K_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_C_K_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByG_C_K_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_C_K_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Integer.class.getName()
			},
		...
		_finderPathFetchByG_C_CK_CT_K_P = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByG_C_CK_CT_K_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Long.class.getName(),
				String.class.getName(), Long.class.getName()
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByA_C",
			_finderPathWithPaginationFindByA_C);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByA_C",
			_finderPathWithoutPaginationFindByA_C);

		_finderPaths.put("finderPathCountByA_C", _finderPathCountByA_C);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_C_K",
			_finderPathWithPaginationFindByG_C_K);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_C_K",
			_finderPathWithoutPaginationFindByG_C_K);

		_finderPaths.put("finderPathCountByG_C_K", _finderPathCountByG_C_K);
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_C_K_T",
			_finderPathWithPaginationFindByG_C_K_T);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_C_K_T",
			_finderPathWithoutPaginationFindByG_C_K_T);

		_finderPaths.put("finderPathCountByG_C_K_T", _finderPathCountByG_C_K_T);

		_finderPaths.put(
			"finderPathFetchByG_C_CK_CT_K_P", _finderPathFetchByG_C_CK_CT_K_P);

		_finderPaths.put(
			"finderPathCountByG_C_CK_CT_K_P", _finderPathCountByG_C_CK_CT_K_P);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<AssetListEntryUsage> assetListEntryUsages = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<AssetListEntryUsage>> resultMap =
				new HashMap<>();
			...
			for (AssetListEntryUsage assetListEntryUsage :
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						assetListEntryUsageModelImpl.getColumnValue(
							columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), assetListEntryUsage);
				}
				else {
					List<AssetListEntryUsage> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(assetListEntryUsage);
				}
			}

			for (Map.Entry<List<Object>, List<AssetListEntryUsage>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<AssetListEntryUsage> value = resultEntry.getValue();
