...
@Component(
	service = {
		CommerceInventoryWarehouseItemPersistence.class, BasePersistence.class
	}
)
public class CommerceInventoryWarehouseItemPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByCompanyId_Sku = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCompanyId_Sku",
			new String[] {
