...
public class CommercePriceListAccountRelPersistenceImpl
	...
	@Override
	public FinderPath getFinderPathFetchByCAI_CPI() {
		return _finderPathFetchByCAI_CPI;
	}

	private FinderPath _finderPathCountByCAI_CPI;

	@Override
	public FinderPath getFinderPathCountByCAI_CPI() {
		return _finderPathCountByCAI_CPI;
	}
