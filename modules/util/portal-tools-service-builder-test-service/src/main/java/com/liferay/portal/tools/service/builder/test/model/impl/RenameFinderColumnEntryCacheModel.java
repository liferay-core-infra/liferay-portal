...
public class RenameFinderColumnEntryCacheModel
	...
	public boolean equals(Object object) {
		...
		if (renameFinderEntryId ==
				renameFinderColumnEntryCacheModel.renameFinderEntryId) {
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, renameFinderEntryId);
	}
	...
	public RenameFinderColumnEntry toEntityModel() {
		...
		renameFinderColumnEntryImpl.setRenameFinderEntryId(renameFinderEntryId);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		renameFinderEntryId = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		objectOutput.writeLong(renameFinderEntryId);
	...
	public long renameFinderEntryId;
	public long groupId;
