...
public class WebUrlResourceFactoryImpl implements WebUrlResource.Factory {
	...
	@Override
	public WebUrlResource.Builder create() {
		return new WebUrlResource.Builder() {
			...
			@Override
			public WebUrlResource.Builder checkPermissions(
			...
			@Override
			public WebUrlResource.Builder httpServletRequest(
			...
			@Override
			public WebUrlResource.Builder httpServletResponse(
			...
			@Override
			public WebUrlResource.Builder preferredLocale(
			...
			@Override
			public WebUrlResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		WebUrlResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		WebUrlResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, WebUrlResource>
		...
		try {
			Constructor<WebUrlResource> constructor =
				(Constructor<WebUrlResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(webUrlResource);
	...
	private ComponentServiceObjects<WebUrlResource> _componentServiceObjects;
