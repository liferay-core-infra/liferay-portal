...
@Generated("")
public class PlacedOrderCommentResourceFactoryImpl
	implements PlacedOrderCommentResource.Factory {

	@Override
	public PlacedOrderCommentResource.Builder create() {
		return new PlacedOrderCommentResource.Builder() {
			...
			@Override
			public PlacedOrderCommentResource.Builder checkPermissions(
			...
			@Override
			public PlacedOrderCommentResource.Builder httpServletRequest(
			...
			@Override
			public PlacedOrderCommentResource.Builder httpServletResponse(
			...
			@Override
			public PlacedOrderCommentResource.Builder preferredLocale(
			...
			@Override
			public PlacedOrderCommentResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PlacedOrderCommentResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PlacedOrderCommentResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, PlacedOrderCommentResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PlacedOrderCommentResource.class.getClassLoader(),
			PlacedOrderCommentResource.class);

		try {
			Constructor<PlacedOrderCommentResource> constructor =
				(Constructor<PlacedOrderCommentResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(placedOrderCommentResource);
