...
/**
 * Provides the local service utility for FilterFindEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.FilterFindEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FilterFindEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.FilterFindEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FilterFindEntry addFilterFindEntry(
		FilterFindEntry filterFindEntry) {

		return getService().addFilterFindEntry(filterFindEntry);
	}
	 ...
	 */
	public static FilterFindEntry createFilterFindEntry(
		long filterFindEntryId) {

		return getService().createFilterFindEntry(filterFindEntryId);
	}
	 ...
	 */
	public static FilterFindEntry deleteFilterFindEntry(
		FilterFindEntry filterFindEntry) {

		return getService().deleteFilterFindEntry(filterFindEntry);
	}
	 ...
	 */
	public static FilterFindEntry deleteFilterFindEntry(long filterFindEntryId)
		throws PortalException {

		return getService().deleteFilterFindEntry(filterFindEntryId);
	}
	...
	public static FilterFindEntry fetchFilterFindEntry(long filterFindEntryId) {
		return getService().fetchFilterFindEntry(filterFindEntryId);
	}
	 ...
	 */
	public static List<FilterFindEntry> getFilterFindEntries(
		int start, int end) {

		return getService().getFilterFindEntries(start, end);
	}
	 ...
	 */
	public static int getFilterFindEntriesCount() {
		return getService().getFilterFindEntriesCount();
	}
	 ...
	 * @throws PortalException if a filter find entry with the primary key could not be found
	 */
	public static FilterFindEntry getFilterFindEntry(long filterFindEntryId)
		throws PortalException {

		return getService().getFilterFindEntry(filterFindEntryId);
	}
	 ...
	 */
	public static FilterFindEntry updateFilterFindEntry(
		FilterFindEntry filterFindEntry) {

		return getService().updateFilterFindEntry(filterFindEntry);
	}

	public static FilterFindEntryLocalService getService() {
		return _service;
	}

	public static void setService(FilterFindEntryLocalService service) {
		_service = service;
	}

	private static volatile FilterFindEntryLocalService _service;
