...
public class RenameFinderColumnEntryUtil {
	 ...
	 */
	public static RenameFinderColumnEntry create(long renameFinderEntryId) {
		return getPersistence().create(renameFinderEntryId);
	}
	 ...
	 */
	public static RenameFinderColumnEntry remove(long renameFinderEntryId)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchRenameFinderColumnEntryException {

		return getPersistence().remove(renameFinderEntryId);
	}
	...
	public static RenameFinderColumnEntry findByPrimaryKey(
			long renameFinderEntryId)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchRenameFinderColumnEntryException {

		return getPersistence().findByPrimaryKey(renameFinderEntryId);
	}
	...
	public static RenameFinderColumnEntry fetchByPrimaryKey(
		...
		return getPersistence().fetchByPrimaryKey(renameFinderEntryId);
	}
