...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + DDMFormPortlet.ALIAS,
...
public class DDMFormPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "form";
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, DDMPortletKeys.DYNAMIC_DATA_MAPPING_FORM);
	}
