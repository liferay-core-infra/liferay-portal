...
public class BillingAddressResourceFactoryImpl
	...
	public BillingAddressResource.Builder create() {
		return new BillingAddressResource.Builder() {
			...
			@Override
			public BillingAddressResource.Builder httpServletRequest(
			...
			@Override
			public BillingAddressResource.Builder httpServletResponse(
			...
			@Override
			public BillingAddressResource.Builder preferredLocale(
