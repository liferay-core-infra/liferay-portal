...
create unique index IX_10690B19 on DispatchTrigger (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create index IX_EF08D30 on DispatchTrigger (uuid_[$COLUMN_LENGTH:75$]);