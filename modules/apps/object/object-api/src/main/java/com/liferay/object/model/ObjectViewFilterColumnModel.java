...
/**
 * The base model interface for the ObjectViewFilterColumn service. Represents a row in the &quot;ObjectViewFilterColumn&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.object.model.impl.ObjectViewFilterColumnModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.object.model.impl.ObjectViewFilterColumnImpl</code>.
 * </p>
 *
 * @author Marco Leo
 ...
 */
@ProviderType
public interface ObjectViewFilterColumnModel
	extends BaseModel<ObjectViewFilterColumn>, MVCCModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a object view filter column model instance should use the {@link ObjectViewFilterColumn} interface instead.
	 */
