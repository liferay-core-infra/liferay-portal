create unique index IX_A6BA8E81 on OAuthClientASLocalMetadata (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create unique index IX_5A4A92AB on OAuthClientEntry (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
create index IX_29A83E50 on OAuthClientEntry (userId);
create index IX_999928DE on OAuthClientEntry (uuid_[$COLUMN_LENGTH:75$]);

create unique index IX_AA37A6B1 on OAuthClientPRLocalMetadata (companyId, externalReferenceCode[$COLUMN_LENGTH:500$]);
