...
@Generated("")
public class ProductSubscriptionConfigurationResourceFactoryImpl
	implements ProductSubscriptionConfigurationResource.Factory {

	@Override
	public ProductSubscriptionConfigurationResource.Builder create() {
		return new ProductSubscriptionConfigurationResource.Builder() {
			...
			@Override
			public ProductSubscriptionConfigurationResource.Builder
	...
	protected void activate() {
		ProductSubscriptionConfigurationResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ProductSubscriptionConfigurationResource.FactoryHolder.factory = null;
	}
	...
	private static Function
		...
		try {
			Constructor<ProductSubscriptionConfigurationResource> constructor =
				(Constructor<ProductSubscriptionConfigurationResource>)
