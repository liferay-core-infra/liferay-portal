...
This affects anyone using the `dl.file.entry.processors` property.
...
It is not required anymore since all out od the box DLProcessor implementations are an OSGi service.