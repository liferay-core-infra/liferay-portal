...
public class IndexResourceFactoryImpl implements IndexResource.Factory {
	...
	@Override
	public IndexResource.Builder create() {
		return new IndexResource.Builder() {
			...
			@Override
			public IndexResource.Builder checkPermissions(
			...
			@Override
			public IndexResource.Builder httpServletRequest(
			...
			@Override
			public IndexResource.Builder httpServletResponse(
			...
			@Override
			public IndexResource.Builder preferredLocale(
			...
			@Override
			public IndexResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(indexResource);
	...
	private ComponentServiceObjects<IndexResource> _componentServiceObjects;
