...
public class FolderPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByAccountId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByAccountId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByAccountId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByAccountId",
			new String[] {Long.class.getName()}, new String[] {"accountId"},
			true);

		_finderPathCountByAccountId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByAccountId",
			new String[] {Long.class.getName()}, new String[] {"accountId"},
			false);

		_finderPathFetchByA_F = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByA_F",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"accountId", "fullName"}, true);

		_finderPathCountByA_F = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_F",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByAccountId",
			_finderPathWithPaginationFindByAccountId);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByAccountId",
			_finderPathWithoutPaginationFindByAccountId);

		_finderPaths.put(
			"finderPathCountByAccountId", _finderPathCountByAccountId);

		_finderPaths.put("finderPathFetchByA_F", _finderPathFetchByA_F);

		_finderPaths.put("finderPathCountByA_F", _finderPathCountByA_F);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<Folder>> resultMap = new HashMap<>();
			...
			for (Folder folder : folders) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(folderModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), folder);
				}
				else {
					List<Folder> resultList = resultMap.computeIfAbsent(
			...
			for (Map.Entry<List<Object>, List<Folder>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<Folder> value = resultEntry.getValue();
