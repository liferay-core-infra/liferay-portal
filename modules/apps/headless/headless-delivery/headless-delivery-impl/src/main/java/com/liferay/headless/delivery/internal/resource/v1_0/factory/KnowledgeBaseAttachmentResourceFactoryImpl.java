...
public class KnowledgeBaseAttachmentResourceFactoryImpl
	...
	public KnowledgeBaseAttachmentResource.Builder create() {
		return new KnowledgeBaseAttachmentResource.Builder() {
			...
			@Override
			public KnowledgeBaseAttachmentResource.Builder httpServletResponse(
			...
			@Override
			public KnowledgeBaseAttachmentResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, KnowledgeBaseAttachmentResource>
		...
		try {
			Constructor<KnowledgeBaseAttachmentResource> constructor =
				(Constructor<KnowledgeBaseAttachmentResource>)
