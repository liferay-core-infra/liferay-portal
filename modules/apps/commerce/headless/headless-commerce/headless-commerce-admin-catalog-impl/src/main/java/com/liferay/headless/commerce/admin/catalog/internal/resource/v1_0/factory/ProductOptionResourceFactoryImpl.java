...
public class ProductOptionResourceFactoryImpl
	...
	public ProductOptionResource.Builder create() {
		return new ProductOptionResource.Builder() {
			...
			public ProductOptionResource build() {
				...
				return _productOptionResourceProxyProviderFunction.apply(
			...
			@Override
			public ProductOptionResource.Builder httpServletRequest(
			...
			@Override
			public ProductOptionResource.Builder httpServletResponse(
			...
			@Override
			public ProductOptionResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, ProductOptionResource>
		...
		try {
			Constructor<ProductOptionResource> constructor =
				(Constructor<ProductOptionResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, ProductOptionResource>
		_productOptionResourceProxyProviderFunction =
			_getProxyProviderFunction();
