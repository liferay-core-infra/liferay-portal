...
import com.liferay.portal.tools.service.builder.spring.sample.service.persistence.impl.constants.SpringEntryPersistenceConstants;
 ...
 * @generated
 */
@Component(service = {SpringEntryPersistence.class, BasePersistence.class})
public class SpringEntryPersistenceImpl
	...
	@Override
	@Reference(
		target = SpringEntryPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = SpringEntryPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	@Reference
	private SpringEntryModelArgumentsResolver
		_springEntryModelArgumentsResolver;
