...
public class ProcessVersionResourceFactoryImpl
	...
	@Override
	public ProcessVersionResource.Builder create() {
		return new ProcessVersionResource.Builder() {
			...
			@Override
			public ProcessVersionResource.Builder checkPermissions(
			...
			@Override
			public ProcessVersionResource.Builder httpServletRequest(
			...
			@Override
			public ProcessVersionResource.Builder httpServletResponse(
			...
			@Override
			public ProcessVersionResource.Builder preferredLocale(
			...
			@Override
			public ProcessVersionResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ProcessVersionResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ProcessVersionResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, ProcessVersionResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProcessVersionResource.class.getClassLoader(),
			ProcessVersionResource.class);

		try {
			Constructor<ProcessVersionResource> constructor =
				(Constructor<ProcessVersionResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(processVersionResource);
