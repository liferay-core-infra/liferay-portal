...
public class RadioDDMFormFieldValueAccessor
	...
	public String getValue(DDMFormFieldValue ddmFormFieldValue, Locale locale) {
		return RadioDDMFormFieldValueUtil.getOptionValue(
	...
	public String getValueForEvaluation(
		...
		String optionValue = RadioDDMFormFieldValueUtil.getOptionValue(
			ddmFormFieldValue, locale);
		...
		return RadioDDMFormFieldValueUtil.getOptionLabel(
			ddmFormFieldValue, locale);
	}
