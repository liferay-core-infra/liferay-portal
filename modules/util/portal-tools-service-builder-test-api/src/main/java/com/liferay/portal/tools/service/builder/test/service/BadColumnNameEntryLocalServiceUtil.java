...
/**
 * Provides the local service utility for BadColumnNameEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.BadColumnNameEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BadColumnNameEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.BadColumnNameEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static BadColumnNameEntry addBadColumnNameEntry(
		BadColumnNameEntry badColumnNameEntry) {

		return getService().addBadColumnNameEntry(badColumnNameEntry);
	}
	 ...
	 */
	public static BadColumnNameEntry createBadColumnNameEntry(
		long badColumnNameEntryId) {

		return getService().createBadColumnNameEntry(badColumnNameEntryId);
	}
	 ...
	 */
	public static BadColumnNameEntry deleteBadColumnNameEntry(
		BadColumnNameEntry badColumnNameEntry) {

		return getService().deleteBadColumnNameEntry(badColumnNameEntry);
	}
	...
	public static BadColumnNameEntry deleteBadColumnNameEntry(
		...
		return getService().deleteBadColumnNameEntry(badColumnNameEntryId);
	}
	...
	public static BadColumnNameEntry fetchBadColumnNameEntry(
		long badColumnNameEntryId) {

		return getService().fetchBadColumnNameEntry(badColumnNameEntryId);
	}
	 ...
	 */
	public static List<BadColumnNameEntry> getBadColumnNameEntries(
		int start, int end) {

		return getService().getBadColumnNameEntries(start, end);
	}
	 ...
	 */
	public static int getBadColumnNameEntriesCount() {
		return getService().getBadColumnNameEntriesCount();
	}
	 ...
	 * @throws PortalException if a bad column name entry with the primary key could not be found
	 */
	public static BadColumnNameEntry getBadColumnNameEntry(
			long badColumnNameEntryId)
		throws PortalException {

		return getService().getBadColumnNameEntry(badColumnNameEntryId);
	}
	 ...
	 */
	public static BadColumnNameEntry updateBadColumnNameEntry(
		BadColumnNameEntry badColumnNameEntry) {

		return getService().updateBadColumnNameEntry(badColumnNameEntry);
	}

	public static BadColumnNameEntryLocalService getService() {
		return _service;
	}

	public static void setService(BadColumnNameEntryLocalService service) {
		_service = service;
	}

	private static volatile BadColumnNameEntryLocalService _service;
