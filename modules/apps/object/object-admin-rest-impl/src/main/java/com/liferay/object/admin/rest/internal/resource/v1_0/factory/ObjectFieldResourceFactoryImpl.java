...
public class ObjectFieldResourceFactoryImpl
	...
	@Override
	public ObjectFieldResource.Builder create() {
		return new ObjectFieldResource.Builder() {
			...
			@Override
			public ObjectFieldResource.Builder checkPermissions(
			...
			@Override
			public ObjectFieldResource.Builder httpServletRequest(
			...
			@Override
			public ObjectFieldResource.Builder httpServletResponse(
			...
			@Override
			public ObjectFieldResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		objectFieldResource.setContextAcceptLanguage(
			new AcceptLanguageImpl(httpServletRequest, preferredLocale, user));

		Company company = _companyLocalService.getCompany(user.getCompanyId());

		objectFieldResource.setContextCompany(company);
		...
		try {
			...
			_componentServiceObjects.ungetService(objectFieldResource);
