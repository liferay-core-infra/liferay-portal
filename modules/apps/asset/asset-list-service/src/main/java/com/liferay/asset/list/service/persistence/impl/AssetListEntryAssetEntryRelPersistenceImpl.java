...
@Component(
	service = {
		AssetListEntryAssetEntryRelPersistence.class, BasePersistence.class
	}
)
public class AssetListEntryAssetEntryRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByA_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByA_S",
			new String[] {
		...
		_finderPathWithoutPaginationFindByA_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA_S",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"assetListEntryId", "segmentsEntryId"}, true);

		_finderPathCountByA_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_S",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"assetListEntryId", "segmentsEntryId"}, false);

		_finderPathWithPaginationCountByA_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByA_S",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"assetListEntryId", "segmentsEntryId"}, false);

		_finderPathFetchByA_S_P = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByA_S_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByA_S_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_S_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByA_S_GtP = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByA_S_GtP",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithPaginationCountByA_S_GtP = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByA_S_GtP",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByA_S",
			_finderPathWithPaginationFindByA_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByA_S",
			_finderPathWithoutPaginationFindByA_S);

		_finderPaths.put("finderPathCountByA_S", _finderPathCountByA_S);

		_finderPaths.put(
			"finderPathWithPaginationCountByA_S",
			_finderPathWithPaginationCountByA_S);

		_finderPaths.put("finderPathFetchByA_S_P", _finderPathFetchByA_S_P);

		_finderPaths.put("finderPathCountByA_S_P", _finderPathCountByA_S_P);

		_finderPaths.put(
			"finderPathWithPaginationFindByA_S_GtP",
			_finderPathWithPaginationFindByA_S_GtP);

		_finderPaths.put(
			"finderPathWithPaginationCountByA_S_GtP",
			_finderPathWithPaginationCountByA_S_GtP);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<AssetListEntryAssetEntryRel>> resultMap =
				new HashMap<>();
			...
			for (AssetListEntryAssetEntryRel assetListEntryAssetEntryRel :
				...
				if (Objects.equals(
					...
					List<AssetListEntryAssetEntryRel> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(assetListEntryAssetEntryRel);
				}
			}

			for (Map.Entry<List<Object>, List<AssetListEntryAssetEntryRel>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<AssetListEntryAssetEntryRel> value =
