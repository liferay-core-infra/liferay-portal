...
KBDisplayPortletInstanceConfiguration kbDisplayPortletInstanceConfiguration = ConfigurationProviderUtil.getPortletInstanceConfiguration(KBDisplayPortletInstanceConfiguration.class, themeDisplay.getLayout(), portletDisplay.getPortletId());
