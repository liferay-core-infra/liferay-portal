...
public class BlogsEntryAnalyticsReportsInfoItem
	...
	@Reference(
		target = "(component.name=com.liferay.analytics.reports.layout.display.page.internal.info.item.LayoutDisplayPageObjectProviderAnalyticsReportsInfoItemImpl)"
	)
