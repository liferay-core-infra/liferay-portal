...
public class DLImagePreviewDPIRuleImplTest {
	...
	@Test
	public void testDLImagePreviewDPIRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getDLImagePreviewDPIRuleServiceReference(bundleContext);
	...
	@Test
	public void testDLImagePreviewDPIRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			DLImagePreviewDPIRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getDLImagePreviewDPIRuleServiceReference(
	...
	private static final String _RULE_KEY = "dl-image-preview-dpi";
