...
public class CPMeasurementUnitPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByC_P_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_P_T",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_P_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_P_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByC_P_T",
			_finderPathWithPaginationFindByC_P_T);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_P_T",
			_finderPathWithoutPaginationFindByC_P_T);
