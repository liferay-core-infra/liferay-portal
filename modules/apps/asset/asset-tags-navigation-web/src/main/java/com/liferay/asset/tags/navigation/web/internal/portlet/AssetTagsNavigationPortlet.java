...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + AssetTagsNavigationPortlet.ALIAS,
...
public class AssetTagsNavigationPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "tags-nav";
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, AssetTagsNavigationPortletKeys.ASSET_TAGS_NAVIGATION);
	}
