 ...
 */
@Component(
	 immediate = true, service = OrderResource.Factory.class
)
@Generated("")
public class OrderResourceFactoryImpl implements OrderResource.Factory {

	@Override
	public OrderResource.Builder create() {
		return new OrderResource.Builder() {
			...
			@Override
			public OrderResource.Builder checkPermissions(
			...
			@Override
			public OrderResource.Builder httpServletRequest(
			...
			@Override
			public OrderResource.Builder httpServletResponse(
			...
			@Override
			public OrderResource.Builder preferredLocale(
			...
			@Override
			public OrderResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, OrderResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			OrderResource.class.getClassLoader(), OrderResource.class);

		try {
			Constructor<OrderResource> constructor =
				(Constructor<OrderResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(orderResource);
	...
	private ComponentServiceObjects<OrderResource> _componentServiceObjects;
