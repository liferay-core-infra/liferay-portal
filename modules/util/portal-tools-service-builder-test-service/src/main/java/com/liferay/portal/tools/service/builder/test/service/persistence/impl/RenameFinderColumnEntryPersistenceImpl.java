...
public class RenameFinderColumnEntryPersistenceImpl
	 ...
	 *
	 * @param renameFinderEntryId the primary key for the new rename finder column entry
	 * @return the new rename finder column entry
	 */
	@Override
	public RenameFinderColumnEntry create(long renameFinderEntryId) {
		RenameFinderColumnEntry renameFinderColumnEntry =
			new RenameFinderColumnEntryImpl();

		renameFinderColumnEntry.setNew(true);
		renameFinderColumnEntry.setPrimaryKey(renameFinderEntryId);
	 ...
	 *
	 * @param renameFinderEntryId the primary key of the rename finder column entry
	 * @return the rename finder column entry that was removed
	 * @throws NoSuchRenameFinderColumnEntryException if a rename finder column entry with the primary key could not be found
	 */
	@Override
	public RenameFinderColumnEntry remove(long renameFinderEntryId)
		throws NoSuchRenameFinderColumnEntryException {

		return remove((Serializable)renameFinderEntryId);
	}
	 ...
	 */
	@Override
	public RenameFinderColumnEntry findByPrimaryKey(long renameFinderEntryId)
		throws NoSuchRenameFinderColumnEntryException {

		return findByPrimaryKey((Serializable)renameFinderEntryId);
	}
	 ...
	 */
	@Override
	public RenameFinderColumnEntry fetchByPrimaryKey(long renameFinderEntryId) {
		return fetchByPrimaryKey((Serializable)renameFinderEntryId);
	}
