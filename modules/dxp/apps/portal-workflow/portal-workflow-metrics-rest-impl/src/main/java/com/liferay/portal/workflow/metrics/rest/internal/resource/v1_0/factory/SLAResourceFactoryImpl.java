...
public class SLAResourceFactoryImpl implements SLAResource.Factory {
	...
	@Override
	public SLAResource.Builder create() {
		return new SLAResource.Builder() {
			...
			@Override
			public SLAResource.Builder checkPermissions(
			...
			@Override
			public SLAResource.Builder httpServletRequest(
			...
			@Override
			public SLAResource.Builder httpServletResponse(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(slaResource);
	...
	private ComponentServiceObjects<SLAResource> _componentServiceObjects;
