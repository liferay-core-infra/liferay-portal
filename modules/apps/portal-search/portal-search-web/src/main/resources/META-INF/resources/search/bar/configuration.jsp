...
>
	...
	<liferay-frontend:edit-form-body>
		...
		>
			...
			<aui:input helpMessage="destination-page-help" label="destination-page" name="<%= PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_KEY_DESTINATION) %>" value="<%= searchBarPortletPreferences.getDestination(StringPool.BLANK) %>" />
		</liferay-frontend:fieldset>
