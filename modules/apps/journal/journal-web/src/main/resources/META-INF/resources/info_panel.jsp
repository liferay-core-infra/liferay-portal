		...
		>
			...
			<clay:tabs-panel>
				<ul class="list-group sidebar-list-group">
					...
					<%
					for (JournalArticle articleVersion : JournalArticleServiceUtil.getArticlesByArticleId(article.getGroupId(), article.getArticleId(), 0, 10, new ArticleVersionComparator(false))) {
					%>
