...
public class MBBanUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByBanUserId() {

		return getPersistence().getFinderPathWithPaginationFindByBanUserId();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByBanUserId() {

		return getPersistence().getFinderPathWithoutPaginationFindByBanUserId();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByBanUserId() {

		return getPersistence().getFinderPathCountByBanUserId();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByG_B() {

		return getPersistence().getFinderPathFetchByG_B();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByG_B() {

		return getPersistence().getFinderPathCountByG_B();
	}
