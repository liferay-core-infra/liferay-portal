...
public class CommerceDiscountPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByC_C = new FinderPath(
			...
			new String[] {"companyId", "couponCode"}, true, true);
		...
		_finderPathCountByC_C = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "couponCode"}, false, true);
		...
		_finderPathFetchByC_C_A = new FinderPath(
			...
			new String[] {"companyId", "couponCode", "active_"}, true, true);
		...
		_finderPathCountByC_C_A = new FinderPath(
			...
			new String[] {"companyId", "couponCode", "active_"}, false, true);
