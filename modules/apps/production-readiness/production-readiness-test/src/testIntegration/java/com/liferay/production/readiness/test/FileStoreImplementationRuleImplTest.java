...
public class FileStoreImplementationRuleImplTest {
	...
	@Test
	public void testFileStoreImplementationRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getFileStoreImplementationRuleServiceReference(bundleContext);
		...
		try {
			...
			Assert.assertNotNull(result.getCurrentValue());
		}
		finally {
	...
	@Test
	public void testFileStoreImplementationRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			FileStoreImplementationRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getFileStoreImplementationRuleServiceReference(
	...
	private static final String _RULE_KEY = "file-store-implementation";
