...
public class ContentElementResourceFactoryImpl
	...
	public ContentElementResource.Builder create() {
		return new ContentElementResource.Builder() {
			...
			public ContentElementResource build() {
				...
				return _contentElementResourceProxyProviderFunction.apply(
			...
			@Override
			public ContentElementResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, ContentElementResource>
		...
		try {
			Constructor<ContentElementResource> constructor =
				(Constructor<ContentElementResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, ContentElementResource>
		_contentElementResourceProxyProviderFunction =
			_getProxyProviderFunction();
