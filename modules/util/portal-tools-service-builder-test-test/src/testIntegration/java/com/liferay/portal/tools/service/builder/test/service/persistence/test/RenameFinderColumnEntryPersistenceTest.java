...
public class RenameFinderColumnEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingRenameFinderColumnEntry.getRenameFinderEntryId(),
			newRenameFinderColumnEntry.getRenameFinderEntryId());
		Assert.assertEquals(
	...
	protected OrderByComparator<RenameFinderColumnEntry>
		...
		return OrderByComparatorFactoryUtil.create(
			"RenameFinderColumnEntry", "renameFinderEntryId", true, "groupId",
			true, "columnToRename", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"renameFinderEntryId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("renameFinderEntryId"));

		Object newRenameFinderEntryId =
			newRenameFinderColumnEntry.getRenameFinderEntryId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"renameFinderEntryId", new Object[] {newRenameFinderEntryId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingRenameFinderEntryId = result.get(0);

		Assert.assertEquals(
			existingRenameFinderEntryId, newRenameFinderEntryId);
	}
