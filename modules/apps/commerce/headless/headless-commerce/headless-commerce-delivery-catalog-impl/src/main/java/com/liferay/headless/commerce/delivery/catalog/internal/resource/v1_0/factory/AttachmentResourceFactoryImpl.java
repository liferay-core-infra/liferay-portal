...
public class AttachmentResourceFactoryImpl
	...
	public AttachmentResource.Builder create() {
		return new AttachmentResource.Builder() {
			...
			public AttachmentResource build() {
				...
				return _attachmentResourceProxyProviderFunction.apply(
			...
			@Override
			public AttachmentResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, AttachmentResource>
		...
		try {
			Constructor<AttachmentResource> constructor =
				(Constructor<AttachmentResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, AttachmentResource>
		_attachmentResourceProxyProviderFunction = _getProxyProviderFunction();
