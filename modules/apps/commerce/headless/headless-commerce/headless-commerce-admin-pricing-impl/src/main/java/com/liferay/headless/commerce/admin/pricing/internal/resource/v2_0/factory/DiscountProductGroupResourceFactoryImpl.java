...
@Generated("")
public class DiscountProductGroupResourceFactoryImpl
	implements DiscountProductGroupResource.Factory {

	@Override
	public DiscountProductGroupResource.Builder create() {
		return new DiscountProductGroupResource.Builder() {
			...
			public DiscountProductGroupResource build() {
				...
				return _discountProductGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public DiscountProductGroupResource.Builder checkPermissions(
			...
			@Override
			public DiscountProductGroupResource.Builder httpServletRequest(
			...
			@Override
			public DiscountProductGroupResource.Builder httpServletResponse(
			...
			@Override
			public DiscountProductGroupResource.Builder preferredLocale(
			...
			@Override
			public DiscountProductGroupResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		DiscountProductGroupResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		DiscountProductGroupResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, DiscountProductGroupResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			DiscountProductGroupResource.class.getClassLoader(),
			DiscountProductGroupResource.class);

		try {
			Constructor<DiscountProductGroupResource> constructor =
				(Constructor<DiscountProductGroupResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(discountProductGroupResource);
	...
	private static final Function
		<InvocationHandler, DiscountProductGroupResource>
			_discountProductGroupResourceProxyProviderFunction =
				_getProxyProviderFunction();
