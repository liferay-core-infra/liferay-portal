...
@Component(
	service = {
		CommerceNotificationAttachmentPersistence.class, BasePersistence.class
	}
)
public class CommerceNotificationAttachmentPersistenceImpl
	...
	public void activate() {
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByCommerceNotificationQueueEntryId",
			_finderPathWithPaginationFindByCommerceNotificationQueueEntryId);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByCommerceNotificationQueueEntryId",
			_finderPathWithoutPaginationFindByCommerceNotificationQueueEntryId);

		_finderPaths.put(
			"finderPathCountByCommerceNotificationQueueEntryId",
			_finderPathCountByCommerceNotificationQueueEntryId);
