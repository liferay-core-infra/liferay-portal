...
public abstract class BaseSegmentsEntryProvider
	...
	public long[] getSegmentsEntryClassPKs(
		...
		if (Validator.isNull(filterString)) {
			Long[] segmentsEntryClassPKs = TransformUtil.transformToArray(
				segmentsEntryRelLocalService.getSegmentsEntryRels(
					segmentsEntryId, start, end, null),
				segmentsEntryRel -> segmentsEntryRel.getClassPK(), Long.class);

			return ArrayUtil.toArray(segmentsEntryClassPKs);
		}
		...
		Long[] segmentsEntryClassPKs = TransformUtil.transformToArray(
			...
			baseModel -> (Long)baseModel.getPrimaryKeyObj(), Long.class);
