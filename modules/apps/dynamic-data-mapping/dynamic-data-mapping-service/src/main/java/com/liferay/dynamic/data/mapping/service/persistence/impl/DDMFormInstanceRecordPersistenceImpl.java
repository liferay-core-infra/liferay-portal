...
public class DDMFormInstanceRecordPersistenceImpl
	...
	public FinderPath getFinderPathWithPaginationFindByFormInstanceId() {
		return _finderPathWithPaginationFindByFormInstanceId;
	}
	...
	public FinderPath getFinderPathWithPaginationFindByU_F() {
		return _finderPathWithPaginationFindByU_F;
	}
	...
	public FinderPath getFinderPathWithPaginationFindByF_F() {
		return _finderPathWithPaginationFindByF_F;
	}
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		...
		List<DDMFormInstanceRecord> ddmFormInstanceRecords = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<DDMFormInstanceRecord>> resultMap =
				new HashMap<>();
			...
			for (DDMFormInstanceRecord ddmFormInstanceRecord :
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						ddmFormInstanceRecordModelImpl.getColumnValue(
							columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), ddmFormInstanceRecord);
				}
				else {
					List<DDMFormInstanceRecord> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(ddmFormInstanceRecord);
				}
			}

			for (Map.Entry<List<Object>, List<DDMFormInstanceRecord>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<DDMFormInstanceRecord> value = resultEntry.getValue();
