...
public class InstantIndexesTest {
	...
	private void _registerEventsIndexDefinition() {
		_serviceRegistrations.add(
			_bundleContext.registerService(
				IndexDefinition.class, new EventsIndexDefinition(),
				HashMapDictionaryBuilder.put(
					IndexDefinition.PROPERTY_KEY_INDEX_NAME,
					EventsIndexDefinition.INDEX_NAME_WORKFLOW_EVENTS
				).put(
					IndexDefinition.PROPERTY_KEY_INDEX_SETTINGS_RESOURCE_NAME,
					EventsIndexDefinition.TYPE_MAPPING_FILE_NAME_WORKFLOW_EVENTS
				).build()));
	}
	...
	private void _registerTasksIndexDefinition() {
		_serviceRegistrations.add(
			_bundleContext.registerService(
				IndexDefinition.class, new TasksIndexDefinition(),
				HashMapDictionaryBuilder.put(
					IndexDefinition.PROPERTY_KEY_INDEX_NAME,
					TasksIndexDefinition.INDEX_NAME_WORKFLOW_TASKS
				).put(
					IndexDefinition.PROPERTY_KEY_INDEX_SETTINGS_RESOURCE_NAME,
					TasksIndexDefinition.TYPE_MAPPING_FILE_NAME_WORKFLOW_TASKS
				).build()));
	}
