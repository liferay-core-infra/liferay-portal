...
public abstract class BaseIndexResourceTestCase {
	...
	protected java.lang.reflect.Field[] getDeclaredFields(Class clazz)
		...
		java.lang.reflect.Field[] tempField = ReflectionUtil.getDeclaredFields(
			clazz);
		...
		java.lang.reflect.Field[] fields =
			new java.lang.reflect.Field[fieldsList.size()];
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("key")) {
			sb.append("'");
			sb.append(String.valueOf(index.getKey()));
			sb.append("'");
		...
		if (entityFieldName.equals("label")) {
			sb.append("'");
			sb.append(String.valueOf(index.getLabel()));
			sb.append("'");
