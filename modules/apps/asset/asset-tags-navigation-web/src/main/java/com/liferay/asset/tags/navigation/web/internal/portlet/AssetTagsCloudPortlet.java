...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + AssetTagsCloudPortlet.ALIAS,
...
public class AssetTagsCloudPortlet extends MVCPortlet {
	...
	public static final String ALIAS = "tag-cloud";
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			ALIAS, AssetTagsNavigationPortletKeys.ASSET_TAGS_CLOUD);
	}
