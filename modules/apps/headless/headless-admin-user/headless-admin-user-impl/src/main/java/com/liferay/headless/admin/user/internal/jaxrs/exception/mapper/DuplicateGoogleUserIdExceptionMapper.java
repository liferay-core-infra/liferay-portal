...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.DuplicateGoogleUserIdExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateGoogleUserIdExceptionMapper
	extends BaseExceptionMapper<DuplicateGoogleUserIdException> {

	@Override
	protected Problem getProblem(
		DuplicateGoogleUserIdException duplicateGoogleUserIdException) {
