...
public class CommerceAvailabilityEstimatePersistenceImpl
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommerceAvailabilityEstimate>> resultMap =
				new HashMap<>();
			...
			for (CommerceAvailabilityEstimate commerceAvailabilityEstimate :
				...
				if (Objects.equals(
					...
					List<CommerceAvailabilityEstimate> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commerceAvailabilityEstimate);
				}
			}

			for (Map.Entry<List<Object>, List<CommerceAvailabilityEstimate>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommerceAvailabilityEstimate> value =
