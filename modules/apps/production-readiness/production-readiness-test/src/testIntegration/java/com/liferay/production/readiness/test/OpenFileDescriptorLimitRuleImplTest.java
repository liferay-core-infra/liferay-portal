...
public class OpenFileDescriptorLimitRuleImplTest {
	...
	@Test
	public void testOpenFileDescriptorLimitRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getOpenFileDescriptorLimitRuleServiceReference(bundleContext);
	...
	@Test
	public void testOpenFileDescriptorLimitRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			OpenFileDescriptorLimitRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getOpenFileDescriptorLimitRuleServiceReference(
	...
	private static final String _RULE_KEY = "open-file-descriptor-limit";
