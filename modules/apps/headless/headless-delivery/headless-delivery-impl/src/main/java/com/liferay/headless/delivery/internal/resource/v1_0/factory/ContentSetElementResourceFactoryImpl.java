...
public class ContentSetElementResourceFactoryImpl
	...
	@Override
	public ContentSetElementResource.Builder create() {
		return new ContentSetElementResource.Builder() {
			...
			public ContentSetElementResource build() {
				...
				return _contentSetElementResourceProxyProviderFunction.apply(
			...
			@Override
			public ContentSetElementResource.Builder checkPermissions(
			...
			@Override
			public ContentSetElementResource.Builder httpServletRequest(
			...
			@Override
			public ContentSetElementResource.Builder httpServletResponse(
			...
			@Override
			public ContentSetElementResource.Builder preferredLocale(
			...
			@Override
			public ContentSetElementResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ContentSetElementResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ContentSetElementResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, ContentSetElementResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ContentSetElementResource.class.getClassLoader(),
			ContentSetElementResource.class);

		try {
			Constructor<ContentSetElementResource> constructor =
				(Constructor<ContentSetElementResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(contentSetElementResource);
	...
	private static final Function<InvocationHandler, ContentSetElementResource>
		_contentSetElementResourceProxyProviderFunction =
			_getProxyProviderFunction();
