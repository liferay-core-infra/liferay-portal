		...
		<liferay-ui:section>
			<div class="sidebar-body">
				<ul class="list-group sidebar-list-group">
					...
					<%
					for (WikiPage curPage : WikiPageLocalServiceUtil.getPages(wikiPage.getNodeId(), wikiPage.getTitle(), QueryUtil.ALL_POS, QueryUtil.ALL_POS, new PageVersionComparator(false))) {
					%>
