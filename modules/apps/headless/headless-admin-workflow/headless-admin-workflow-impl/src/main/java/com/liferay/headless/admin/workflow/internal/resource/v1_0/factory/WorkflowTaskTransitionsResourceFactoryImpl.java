...
public class WorkflowTaskTransitionsResourceFactoryImpl
	...
	public WorkflowTaskTransitionsResource.Builder create() {
		return new WorkflowTaskTransitionsResource.Builder() {
			...
			@Override
			public WorkflowTaskTransitionsResource.Builder httpServletRequest(
			...
			@Override
			public WorkflowTaskTransitionsResource.Builder httpServletResponse(
			...
			@Override
			public WorkflowTaskTransitionsResource.Builder preferredLocale(
