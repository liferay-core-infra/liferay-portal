 ...
 */
@Component(
	 immediate = true, service = OrderTypeResource.Factory.class
)
@Generated("")
public class OrderTypeResourceFactoryImpl implements OrderTypeResource.Factory {

	@Override
	public OrderTypeResource.Builder create() {
		return new OrderTypeResource.Builder() {
			...
			@Override
			public OrderTypeResource.Builder checkPermissions(
			...
			@Override
			public OrderTypeResource.Builder httpServletRequest(
			...
			@Override
			public OrderTypeResource.Builder httpServletResponse(
			...
			@Override
			public OrderTypeResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		orderTypeResource.setContextAcceptLanguage(
			new AcceptLanguageImpl(httpServletRequest, preferredLocale, user));

		Company company = _companyLocalService.getCompany(user.getCompanyId());

		orderTypeResource.setContextCompany(company);
		...
		try {
			...
			_componentServiceObjects.ungetService(orderTypeResource);
	...
	private ComponentServiceObjects<OrderTypeResource> _componentServiceObjects;
