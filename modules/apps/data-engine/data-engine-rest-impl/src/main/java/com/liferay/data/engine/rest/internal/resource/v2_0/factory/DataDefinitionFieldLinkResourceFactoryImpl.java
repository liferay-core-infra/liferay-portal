...
public class DataDefinitionFieldLinkResourceFactoryImpl
	implements DataDefinitionFieldLinkResource.Factory {

	@Override
	public DataDefinitionFieldLinkResource.Builder create() {
		return new DataDefinitionFieldLinkResource.Builder() {
			...
			@Override
			public DataDefinitionFieldLinkResource.Builder checkPermissions(
			...
			@Override
			public DataDefinitionFieldLinkResource.Builder httpServletRequest(
			...
			@Override
			public DataDefinitionFieldLinkResource.Builder httpServletResponse(
			...
			@Override
			public DataDefinitionFieldLinkResource.Builder preferredLocale(
			...
			@Override
			public DataDefinitionFieldLinkResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		DataDefinitionFieldLinkResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		DataDefinitionFieldLinkResource.FactoryHolder.factory = null;
	}
