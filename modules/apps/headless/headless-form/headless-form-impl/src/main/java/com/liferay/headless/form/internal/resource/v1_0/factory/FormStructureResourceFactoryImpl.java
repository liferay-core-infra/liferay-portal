...
public class FormStructureResourceFactoryImpl
	...
	public FormStructureResource.Builder create() {
		return new FormStructureResource.Builder() {
			...
			@Override
			public FormStructureResource.Builder httpServletRequest(
			...
			@Override
			public FormStructureResource.Builder httpServletResponse(
			...
			@Override
			public FormStructureResource.Builder preferredLocale(
