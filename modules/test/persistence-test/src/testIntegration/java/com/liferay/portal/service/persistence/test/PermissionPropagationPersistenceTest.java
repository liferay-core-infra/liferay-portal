...
public class PermissionPropagationPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPermissionPropagation.setPropagation(RandomTestUtil.randomBoolean());
		...
		Assert.assertEquals(
			existingPermissionPropagation.isPropagation(),
			newPermissionPropagation.isPropagation());
	}
	...
	protected OrderByComparator<PermissionPropagation> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "classNameId", true, "classPK", true, "propagation", true);
	}
	...
	protected PermissionPropagation addPermissionPropagation()
		...
		permissionPropagation.setPropagation(RandomTestUtil.randomBoolean());
