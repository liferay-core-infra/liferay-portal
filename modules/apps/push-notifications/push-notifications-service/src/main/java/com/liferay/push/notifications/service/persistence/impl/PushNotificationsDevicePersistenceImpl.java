...
public class PushNotificationsDevicePersistenceImpl
	...
	public void activate() {
		...
		_finderPaths.put("finderPathFetchByToken", _finderPathFetchByToken);

		_finderPaths.put("finderPathCountByToken", _finderPathCountByToken);
		...
		_finderPaths.put("finderPathCountByU_P", _finderPathCountByU_P);
