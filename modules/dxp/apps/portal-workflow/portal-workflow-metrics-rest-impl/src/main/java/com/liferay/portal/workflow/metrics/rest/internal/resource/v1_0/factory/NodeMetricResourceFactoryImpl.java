...
public class NodeMetricResourceFactoryImpl
	...
	@Override
	public NodeMetricResource.Builder create() {
		return new NodeMetricResource.Builder() {
			...
			@Override
			public NodeMetricResource.Builder checkPermissions(
			...
			@Override
			public NodeMetricResource.Builder httpServletRequest(
			...
			@Override
			public NodeMetricResource.Builder httpServletResponse(
			...
			@Override
			public NodeMetricResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(nodeMetricResource);
