...
public class ProcessResourceFactoryImpl implements ProcessResource.Factory {
	...
	public ProcessResource.Builder create() {
		return new ProcessResource.Builder() {
			...
			@Override
			public ProcessResource.Builder checkPermissions(
			...
			@Override
			public ProcessResource.Builder httpServletRequest(
			...
			@Override
			public ProcessResource.Builder httpServletResponse(
			...
			@Override
			public ProcessResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(processResource);
