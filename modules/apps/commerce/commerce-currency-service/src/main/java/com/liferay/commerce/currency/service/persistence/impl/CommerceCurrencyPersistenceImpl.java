...
public class CommerceCurrencyPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_C = new FinderPath(
			...
			new String[] {"companyId", "code_"}, true, true);

		_finderPathCountByC_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_C",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "code_"}, false, true);
		...
		_finderPathWithPaginationFindByC_P = new FinderPath(
			...
			new String[] {"companyId", "primary_"}, true, true);
		...
		_finderPathCountByC_P = new FinderPath(
			...
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"companyId", "primary_"}, false, true);
		...
		_finderPathWithPaginationFindByC_P_A = new FinderPath(
			...
			new String[] {"companyId", "primary_", "active_"}, true, true);
		...
		_finderPathCountByC_P_A = new FinderPath(
			...
			new String[] {"companyId", "primary_", "active_"}, false, true);
