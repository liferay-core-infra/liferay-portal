...
public class QueryPrefilterContributorResourceFactoryImpl
	implements QueryPrefilterContributorResource.Factory {

	@Override
	public QueryPrefilterContributorResource.Builder create() {
		return new QueryPrefilterContributorResource.Builder() {
			...
			@Override
			public QueryPrefilterContributorResource.Builder checkPermissions(
			...
			@Override
			public QueryPrefilterContributorResource.Builder httpServletRequest(
			...
			@Override
			public QueryPrefilterContributorResource.Builder
			...
			@Override
			public QueryPrefilterContributorResource.Builder preferredLocale(
