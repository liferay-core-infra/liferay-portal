...
public class ContainerLPKGUtilTest {
	...
	public void testDeploy() throws Exception {
		...
		try {
			File innerLPKGFile = new File(testPath.toFile(), "inner.lpkg");

			List<File> expected = Arrays.asList(innerLPKGFile);

			List<File> tmpFileList = ContainerLPKGUtil.deploy(
				lpkgContainerFile, null);

			Assert.assertEquals(expected, tmpFileList);
	...
	public void testDeployWithZipSlip() throws Exception {
		...
		try (LogCapture logCapture = LoggerTestUtil.configureJDKLogger(
			...
			File goodLPKGFile = new File(testPath.toFile(), "good.lpkg");

			List<File> expected = Arrays.asList(goodLPKGFile);
