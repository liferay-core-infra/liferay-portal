...
public class WorkflowMetricsRESTTestHelper {
	...
	public Instance addInstance(long companyId, Instance instance)
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstants.POSTFIX_INSTANCE,
	...
	public Node addNode(
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstants.POSTFIX_NODE,
	...
	public Process addProcess(long companyId, Process process)
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstants.POSTFIX_PROCESS,
	...
	public Task addTask(
		...
		_assertCount(
			_indexNameBuilder.getIndexName(addTaskRequest.getCompanyId()) +
				WorkflowMetricsIndexEntityNameConstants.POSTFIX_TASK,
	...
	public Task addTask(long companyId, Instance instance, Task task, User user)
		...
		_assertCount(
			indexName + WorkflowMetricsIndexEntityNameConstants.POSTFIX_TASK,
