...
public class RenameFinderColumnEntryModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"renameFinderEntryId", Types.BIGINT}, {"groupId", Types.BIGINT},
	...
	static {
		TABLE_COLUMNS_MAP.put("renameFinderEntryId", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("groupId", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("columnToRename", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE =
		"create table RenameFinderColumnEntry (renameFinderEntryId LONG not null primary key,groupId LONG,columnToRename VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table RenameFinderColumnEntry";

	public static final String ORDER_BY_JPQL =
		" ORDER BY renameFinderColumnEntry.renameFinderEntryId ASC";
	 ...
	 */
	@Deprecated
	public static final long RENAMEFINDERENTRYID_COLUMN_BITMASK = 2L;
	...
	public long getPrimaryKey() {
		return _renameFinderEntryId;
	}

	@Override
	public void setPrimaryKey(long primaryKey) {
		setRenameFinderEntryId(primaryKey);
	}
	...
	static {
		...
		attributeGetterFunctions.put(
			"renameFinderEntryId",
			RenameFinderColumnEntry::getRenameFinderEntryId);
		attributeSetterBiConsumers.put(
			"renameFinderEntryId",
			(BiConsumer<RenameFinderColumnEntry, Long>)
				RenameFinderColumnEntry::setRenameFinderEntryId);
		attributeGetterFunctions.put(
	...
	public void setRenameFinderEntryId(long renameFinderEntryId) {
		...
		_renameFinderEntryId = renameFinderEntryId;
	}
	...
	public Object clone() {
		...
		renameFinderColumnEntryImpl.setRenameFinderEntryId(
			getRenameFinderEntryId());
	...
	public RenameFinderColumnEntry cloneWithOriginalValues() {
		...
		renameFinderColumnEntryImpl.setRenameFinderEntryId(
			this.<Long>getColumnOriginalValue("renameFinderEntryId"));
	...
	private long _renameFinderEntryId;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("renameFinderEntryId", _renameFinderEntryId);
	...
	static {
		...
		columnBitmasks.put("renameFinderEntryId", 1L);
