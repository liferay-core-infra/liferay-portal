 ...
 */
@Component(
	 immediate = true, service = OrderNoteResource.Factory.class
)
@Generated("")
public class OrderNoteResourceFactoryImpl implements OrderNoteResource.Factory {

	@Override
	public OrderNoteResource.Builder create() {
		return new OrderNoteResource.Builder() {
			...
			public OrderNoteResource build() {
				...
				return _orderNoteResourceProxyProviderFunction.apply(
			...
			@Override
			public OrderNoteResource.Builder checkPermissions(
			...
			@Override
			public OrderNoteResource.Builder httpServletRequest(
			...
			@Override
			public OrderNoteResource.Builder httpServletResponse(
			...
			@Override
			public OrderNoteResource.Builder preferredLocale(
			...
			@Override
			public OrderNoteResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		OrderNoteResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		OrderNoteResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, OrderNoteResource>
		...
		try {
			Constructor<OrderNoteResource> constructor =
				(Constructor<OrderNoteResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(orderNoteResource);
	...
	private static final Function<InvocationHandler, OrderNoteResource>
		_orderNoteResourceProxyProviderFunction = _getProxyProviderFunction();

	@Reference
	private CompanyLocalService _companyLocalService;

	@Reference(scope = ReferenceScope.PROTOTYPE_REQUIRED)
	private ComponentServiceObjects<OrderNoteResource> _componentServiceObjects;
