...
@Generated("")
public class SXPParameterContributorDefinitionResourceFactoryImpl
	implements SXPParameterContributorDefinitionResource.Factory {

	@Override
	public SXPParameterContributorDefinitionResource.Builder create() {
		return new SXPParameterContributorDefinitionResource.Builder() {
			...
			@Override
			public SXPParameterContributorDefinitionResource.Builder
			...
			@Override
			public SXPParameterContributorDefinitionResource.Builder user(
				User user) {
	...
	protected void activate() {
		SXPParameterContributorDefinitionResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		SXPParameterContributorDefinitionResource.FactoryHolder.factory = null;
	}
