...
public class OrganizationResourceFactoryImpl
	...
	public OrganizationResource.Builder create() {
		return new OrganizationResource.Builder() {
			...
			public OrganizationResource build() {
				...
				return _organizationResourceProxyProviderFunction.apply(
			...
			@Override
			public OrganizationResource.Builder httpServletResponse(
			...
			@Override
			public OrganizationResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, OrganizationResource>
		...
		try {
			Constructor<OrganizationResource> constructor =
				(Constructor<OrganizationResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, OrganizationResource>
		_organizationResourceProxyProviderFunction =
			_getProxyProviderFunction();
