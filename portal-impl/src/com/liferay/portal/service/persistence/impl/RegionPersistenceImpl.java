...
public class RegionPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByC_A = new FinderPath(
			...
			new String[] {"countryId", "active_"}, true, true);
