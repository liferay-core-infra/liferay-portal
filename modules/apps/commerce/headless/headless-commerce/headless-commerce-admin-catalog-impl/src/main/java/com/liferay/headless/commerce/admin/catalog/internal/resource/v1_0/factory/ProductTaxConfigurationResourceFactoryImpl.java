...
public class ProductTaxConfigurationResourceFactoryImpl
	...
	public ProductTaxConfigurationResource.Builder create() {
		return new ProductTaxConfigurationResource.Builder() {
			...
			@Override
			public ProductTaxConfigurationResource.Builder httpServletRequest(
			...
			@Override
			public ProductTaxConfigurationResource.Builder httpServletResponse(
			...
			@Override
			public ProductTaxConfigurationResource.Builder preferredLocale(
