...
public class DepotAppCustomizationPersistenceImpl
	...
	public void activate() {
		...
		_finderPaths.put("finderPathFetchByD_E", _finderPathFetchByD_E);

		_finderPaths.put("finderPathCountByD_E", _finderPathCountByD_E);

		_finderPaths.put("finderPathFetchByD_P", _finderPathFetchByD_P);

		_finderPaths.put("finderPathCountByD_P", _finderPathCountByD_P);
