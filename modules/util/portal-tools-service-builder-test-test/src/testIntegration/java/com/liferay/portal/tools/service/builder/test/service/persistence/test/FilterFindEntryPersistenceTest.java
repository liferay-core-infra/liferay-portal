...
public class FilterFindEntryPersistenceTest {
	...
	@Test
	public void testCountByI_T() throws Exception {
		_persistence.countByI_T(RandomTestUtil.nextInt(), "");

		_persistence.countByI_T(0, "null");

		_persistence.countByI_T(0, (String)null);
	}
	...
	protected OrderByComparator<FilterFindEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"FilterFindEntry", "filterFindEntryId", true, "integer", true,
			"type", true);
	}
