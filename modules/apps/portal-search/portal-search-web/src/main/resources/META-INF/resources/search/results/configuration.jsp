...
>
	...
	<liferay-frontend:edit-form-body>
		...
		>
			...
			<aui:input helpMessage="fields-to-display-help" label="fields-to-display" name="<%= PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_FIELDS_TO_DISPLAY) %>" type="text" value="<%= GetterUtil.getString(searchResultsPortletPreferences.getFieldsToDisplay()) %>" />
