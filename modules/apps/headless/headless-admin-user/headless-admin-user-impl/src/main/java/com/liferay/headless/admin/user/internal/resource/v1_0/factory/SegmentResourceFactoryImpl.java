...
public class SegmentResourceFactoryImpl implements SegmentResource.Factory {
	...
	public SegmentResource.Builder create() {
		return new SegmentResource.Builder() {
			...
			@Override
			public SegmentResource.Builder httpServletResponse(
	...
	private Object _invoke(
		...
		segmentResource.setContextHttpServletResponse(httpServletResponse);
		segmentResource.setContextUser(user);
		segmentResource.setExpressionConvert(_expressionConvert);
		segmentResource.setFilterParserProvider(_filterParserProvider);
