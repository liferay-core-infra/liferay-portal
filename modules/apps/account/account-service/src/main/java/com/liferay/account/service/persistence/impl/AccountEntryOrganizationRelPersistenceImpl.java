...
public class AccountEntryOrganizationRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByOrganizationId = new FinderPath(
			...
			new String[] {"organizationId"}, true, true);
