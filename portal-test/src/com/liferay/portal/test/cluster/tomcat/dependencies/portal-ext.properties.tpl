...
configuration.override.com.liferay.portal.search.elasticsearch8.configuration.ElasticsearchConfiguration_networkHostAddresses=["${NETWORK_HOST_ADDRESSES}"]
configuration.override.com.liferay.portal.search.elasticsearch8.configuration.ElasticsearchConfiguration_productionModeEnabled=B"true"
