...
@Generated("")
public class ProductSpecificationResourceFactoryImpl
	implements ProductSpecificationResource.Factory {

	@Override
	public ProductSpecificationResource.Builder create() {
		return new ProductSpecificationResource.Builder() {
			...
			@Override
			public ProductSpecificationResource.Builder checkPermissions(
			...
			@Override
			public ProductSpecificationResource.Builder httpServletRequest(
			...
			@Override
			public ProductSpecificationResource.Builder httpServletResponse(
			...
			@Override
			public ProductSpecificationResource.Builder preferredLocale(
			...
			@Override
			public ProductSpecificationResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(productSpecificationResource);
