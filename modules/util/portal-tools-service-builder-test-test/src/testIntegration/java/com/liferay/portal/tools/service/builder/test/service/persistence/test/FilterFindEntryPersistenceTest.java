...
public class FilterFindEntryPersistenceTest {
	...
	@Test
	public void testCountByG_I_T() throws Exception {
		_persistence.countByG_I_T(
			RandomTestUtil.nextLong(), RandomTestUtil.nextInt(), "");

		_persistence.countByG_I_T(0L, 0, "null");

		_persistence.countByG_I_T(0L, 0, (String)null);
	}

	@Test
	public void testCountByG_I_TArrayable() throws Exception {
		_persistence.countByG_I_T(
			RandomTestUtil.nextLong(), RandomTestUtil.nextInt(),
			new String[] {
