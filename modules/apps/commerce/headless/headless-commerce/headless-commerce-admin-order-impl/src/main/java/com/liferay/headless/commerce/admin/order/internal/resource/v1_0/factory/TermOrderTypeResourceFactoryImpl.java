...
@Generated("")
public class TermOrderTypeResourceFactoryImpl
	implements TermOrderTypeResource.Factory {

	@Override
	public TermOrderTypeResource.Builder create() {
		return new TermOrderTypeResource.Builder() {
			...
			public TermOrderTypeResource build() {
				...
				return _termOrderTypeResourceProxyProviderFunction.apply(
			...
			@Override
			public TermOrderTypeResource.Builder checkPermissions(
			...
			@Override
			public TermOrderTypeResource.Builder httpServletRequest(
			...
			@Override
			public TermOrderTypeResource.Builder httpServletResponse(
			...
			@Override
			public TermOrderTypeResource.Builder preferredLocale(
			...
			@Override
			public TermOrderTypeResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		TermOrderTypeResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		TermOrderTypeResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, TermOrderTypeResource>
		...
		try {
			Constructor<TermOrderTypeResource> constructor =
				(Constructor<TermOrderTypeResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(termOrderTypeResource);
	...
	private static final Function<InvocationHandler, TermOrderTypeResource>
		_termOrderTypeResourceProxyProviderFunction =
			_getProxyProviderFunction();
