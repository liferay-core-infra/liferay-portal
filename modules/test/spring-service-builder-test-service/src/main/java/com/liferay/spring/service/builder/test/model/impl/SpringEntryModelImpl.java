...
package com.liferay.spring.service.builder.test.model.impl;
...
import com.liferay.spring.service.builder.test.model.SpringEntryModel;
...
public class SpringEntryModelImpl
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.liferay.spring.service.builder.test.service.util.ServiceProps.get(
			"lock.expiration.time.com.liferay.spring.service.builder.test.model.SpringEntry"));
	...
	private static Function<InvocationHandler, SpringEntry>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SpringEntry.class.getClassLoader(), SpringEntry.class,
			ModelWrapper.class);

		try {
			Constructor<SpringEntry> constructor =
				(Constructor<SpringEntry>)proxyClass.getConstructor(
