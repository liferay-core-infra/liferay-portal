...
public class MessageBoardSectionResourceFactoryImpl
	...
	public MessageBoardSectionResource.Builder create() {
		return new MessageBoardSectionResource.Builder() {
			...
			public MessageBoardSectionResource build() {
				...
				return _messageBoardSectionResourceProxyProviderFunction.apply(
			...
			@Override
			public MessageBoardSectionResource.Builder httpServletRequest(
			...
			@Override
			public MessageBoardSectionResource.Builder httpServletResponse(
			...
			@Override
			public MessageBoardSectionResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, MessageBoardSectionResource>
		...
		try {
			Constructor<MessageBoardSectionResource> constructor =
				(Constructor<MessageBoardSectionResource>)
	...
	private static final Function
		<InvocationHandler, MessageBoardSectionResource>
			_messageBoardSectionResourceProxyProviderFunction =
				_getProxyProviderFunction();
