...
public class AnalyzerPluginsRuleImplTest {
	...
	@Test
	public void testAnalyzerPluginsRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getAnalyzerPluginsRuleServiceReference(bundleContext);
	...
	@Test
	public void testAnalyzerPluginsRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private ServiceReference<ProductionReadinessRule>
			_getAnalyzerPluginsRuleServiceReference(BundleContext bundleContext)
		throws Exception {
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			AnalyzerPluginsRuleImplTest.class
		).getBundleContext();
	}

	private static final String _RULE_KEY = "analyzer-plugins";
