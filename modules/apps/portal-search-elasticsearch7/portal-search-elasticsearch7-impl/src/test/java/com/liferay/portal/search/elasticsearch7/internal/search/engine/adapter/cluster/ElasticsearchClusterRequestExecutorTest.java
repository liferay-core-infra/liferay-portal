...
public class ElasticsearchClusterRequestExecutorTest {
	...
	public void setUp() throws Exception {
		ElasticsearchClusterRequestExecutor
			elasticsearchClusterRequestExecutor =
				new ElasticsearchClusterRequestExecutor();

		ReflectionTestUtil.setFieldValue(
			elasticsearchClusterRequestExecutor,
			"_healthClusterRequestExecutor", _healthClusterRequestExecutor);
		ReflectionTestUtil.setFieldValue(
			elasticsearchClusterRequestExecutor, "_stateClusterRequestExecutor",
			_stateClusterRequestExecutor);
		ReflectionTestUtil.setFieldValue(
			elasticsearchClusterRequestExecutor, "_statsClusterRequestExecutor",
			_statsClusterRequestExecutor);

		_clusterRequestExecutor = elasticsearchClusterRequestExecutor;
	}
