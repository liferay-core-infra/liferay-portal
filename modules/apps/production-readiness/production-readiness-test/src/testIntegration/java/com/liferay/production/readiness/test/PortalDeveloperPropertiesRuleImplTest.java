...
public class PortalDeveloperPropertiesRuleImplTest {
	...
	@Test
	public void testPortalDeveloperPropertiesRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getPortalDeveloperPropertiesRuleServiceReference(bundleContext);
	...
	@Test
	public void testPortalDeveloperPropertiesRuleIsRegistered()
		throws Exception {
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			PortalDeveloperPropertiesRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getPortalDeveloperPropertiesRuleServiceReference(
	...
	private static final String _RULE_KEY = "portal-developer-properties";
