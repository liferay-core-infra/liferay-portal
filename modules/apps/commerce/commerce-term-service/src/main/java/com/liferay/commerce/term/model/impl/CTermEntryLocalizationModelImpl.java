...
public class CTermEntryLocalizationModelImpl
	...
	private static Function<InvocationHandler, CTermEntryLocalization>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CTermEntryLocalization.class.getClassLoader(),
			CTermEntryLocalization.class, ModelWrapper.class);

		try {
			Constructor<CTermEntryLocalization> constructor =
				(Constructor<CTermEntryLocalization>)proxyClass.getConstructor(
