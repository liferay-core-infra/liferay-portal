...
package com.liferay.headless.portal.instances.internal.resource.v1_0.factory;
...
public class PortalInstanceResourceFactoryImpl
	...
	@Override
	public PortalInstanceResource.Builder create() {
		return new PortalInstanceResource.Builder() {
			...
			public PortalInstanceResource build() {
				...
				return _portalInstanceResourceProxyProviderFunction.apply(
			...
			@Override
			public PortalInstanceResource.Builder checkPermissions(
			...
			@Override
			public PortalInstanceResource.Builder httpServletRequest(
			...
			@Override
			public PortalInstanceResource.Builder httpServletResponse(
			...
			@Override
			public PortalInstanceResource.Builder preferredLocale(
			...
			@Override
			public PortalInstanceResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PortalInstanceResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PortalInstanceResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, PortalInstanceResource>
		...
		try {
			Constructor<PortalInstanceResource> constructor =
				(Constructor<PortalInstanceResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, PortalInstanceResource>
		_portalInstanceResourceProxyProviderFunction =
			_getProxyProviderFunction();
