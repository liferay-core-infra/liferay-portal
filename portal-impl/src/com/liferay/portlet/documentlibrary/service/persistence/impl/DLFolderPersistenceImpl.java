...
public class DLFolderPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByR_M = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByR_M",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"repositoryId", "mountPoint"}, true);

		_finderPathCountByR_M = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByR_M",
			new String[] {Long.class.getName(), Boolean.class.getName()},
		...
		_finderPathWithPaginationFindByGtF_C_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByGtF_C_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithPaginationCountByGtF_C_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByGtF_C_P",
			new String[] {
		...
		_finderPathWithPaginationFindByG_M_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_M_P",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_M_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_M_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathCountByG_M_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_M_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathFetchByG_P_N = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByG_P_N",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_P_N = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P_N",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			},
		...
		_finderPathWithPaginationFindByGtF_C_P_NotS = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByGtF_C_P_NotS",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithPaginationCountByGtF_C_P_NotS = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByGtF_C_P_NotS",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_M_P_H = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_M_P_H",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_M_P_H = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_M_P_H",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Boolean.class.getName()
			},
		...
		_finderPathCountByG_M_P_H = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_M_P_H",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Boolean.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_M_LikeT_H = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_M_LikeT_H",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathWithPaginationCountByG_M_LikeT_H = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_M_LikeT_H",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Boolean.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_P_H_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_P_H_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_P_H_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_P_H_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByG_P_H_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P_H_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_M_P_H_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_M_P_H_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_M_P_H_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_M_P_H_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathCountByG_M_P_H_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_M_P_H_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName()
		...
		_finderPaths.put("finderPathCountByR_P", _finderPathCountByR_P);
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByGtF_C_P",
			_finderPathWithPaginationFindByGtF_C_P);

		_finderPaths.put(
			"finderPathWithPaginationCountByGtF_C_P",
			_finderPathWithPaginationCountByGtF_C_P);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_M_P",
			_finderPathWithPaginationFindByG_M_P);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_M_P",
			_finderPathWithoutPaginationFindByG_M_P);

		_finderPaths.put("finderPathCountByG_M_P", _finderPathCountByG_M_P);
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_M_P_H",
			_finderPathWithPaginationFindByG_M_P_H);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_M_P_H",
			_finderPathWithoutPaginationFindByG_M_P_H);

		_finderPaths.put("finderPathCountByG_M_P_H", _finderPathCountByG_M_P_H);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_M_LikeT_H",
			_finderPathWithPaginationFindByG_M_LikeT_H);

		_finderPaths.put(
			"finderPathWithPaginationCountByG_M_LikeT_H",
			_finderPathWithPaginationCountByG_M_LikeT_H);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_P_H_S",
			_finderPathWithPaginationFindByG_P_H_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_P_H_S",
			_finderPathWithoutPaginationFindByG_P_H_S);

		_finderPaths.put("finderPathCountByG_P_H_S", _finderPathCountByG_P_H_S);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_M_P_H_S",
			_finderPathWithPaginationFindByG_M_P_H_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_M_P_H_S",
			_finderPathWithoutPaginationFindByG_M_P_H_S);

		_finderPaths.put(
			"finderPathCountByG_M_P_H_S", _finderPathCountByG_M_P_H_S);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_M_LikeT_H_NotS",
			_finderPathWithPaginationFindByG_M_LikeT_H_NotS);

		_finderPaths.put(
			"finderPathWithPaginationCountByG_M_LikeT_H_NotS",
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<DLFolder> dlFolders = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<DLFolder>> resultMap = new HashMap<>();
			...
			for (DLFolder dlFolder : dlFolders) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					DLFolderModelImpl dlFolderModelImpl =
						(DLFolderModelImpl)dlFolder;

					arguments.add(dlFolderModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					FinderCacheUtil.putResult(
						finderPath, arguments.toArray(), dlFolder);
				}
				else {
					List<DLFolder> resultList = resultMap.computeIfAbsent(
						arguments, key -> new ArrayList<>());

					resultList.add(dlFolder);
				}
			}

			for (Map.Entry<List<Object>, List<DLFolder>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<DLFolder> value = resultEntry.getValue();
