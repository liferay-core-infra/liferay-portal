...
public class DEDataListViewPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_C_DDMSI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_C_DDMSI",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_C_DDMSI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_C_DDMSI",
			new String[] {
		...
		_finderPathCountByG_C_DDMSI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_C_DDMSI",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_C_DDMSI",
			_finderPathWithPaginationFindByG_C_DDMSI);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_C_DDMSI",
			_finderPathWithoutPaginationFindByG_C_DDMSI);

		_finderPaths.put(
			"finderPathCountByG_C_DDMSI", _finderPathCountByG_C_DDMSI);
