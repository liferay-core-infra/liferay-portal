...
public class DLFileRankPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByFileEntryId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByFileEntryId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_U_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_U_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_U_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_U_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_U_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPathFetchByC_U_F = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByC_U_F",
			new String[] {
		...
		_finderPathCountByC_U_F = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_U_F",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_U_A",
			_finderPathWithPaginationFindByG_U_A);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_U_A",
			_finderPathWithoutPaginationFindByG_U_A);

		_finderPaths.put("finderPathCountByG_U_A", _finderPathCountByG_U_A);

		_finderPaths.put("finderPathFetchByC_U_F", _finderPathFetchByC_U_F);

		_finderPaths.put("finderPathCountByC_U_F", _finderPathCountByC_U_F);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<DLFileRank> dlFileRanks = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<DLFileRank>> resultMap = new HashMap<>();
			...
			for (DLFileRank dlFileRank : dlFileRanks) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						dlFileRankModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), dlFileRank);
				}
				else {
					List<DLFileRank> resultList = resultMap.computeIfAbsent(
						arguments, key -> new ArrayList<>());

					resultList.add(dlFileRank);
				}
			}

			for (Map.Entry<List<Object>, List<DLFileRank>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<DLFileRank> value = resultEntry.getValue();
