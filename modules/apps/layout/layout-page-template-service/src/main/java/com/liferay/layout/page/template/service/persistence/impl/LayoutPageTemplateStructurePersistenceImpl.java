...
@Component(
	service = {
		LayoutPageTemplateStructurePersistence.class, BasePersistence.class
	}
)
public class LayoutPageTemplateStructurePersistenceImpl
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<LayoutPageTemplateStructure>> resultMap =
				new HashMap<>();
			...
			for (LayoutPageTemplateStructure layoutPageTemplateStructure :
				...
				if (Objects.equals(
					...
					List<LayoutPageTemplateStructure> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(layoutPageTemplateStructure);
				}
			}

			for (Map.Entry<List<Object>, List<LayoutPageTemplateStructure>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<LayoutPageTemplateStructure> value =
