...
public class JSPReloadingRuleImplTest {
	...
	@Test
	public void testJSPReloadingRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getJSPReloadingRuleServiceReference(bundleContext);
	...
	@Test
	public void testJSPReloadingRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			JSPReloadingRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getJSPReloadingRuleServiceReference(BundleContext bundleContext)
		throws Exception {
	...
	private static final String _RULE_KEY = "jsp-reloading";
