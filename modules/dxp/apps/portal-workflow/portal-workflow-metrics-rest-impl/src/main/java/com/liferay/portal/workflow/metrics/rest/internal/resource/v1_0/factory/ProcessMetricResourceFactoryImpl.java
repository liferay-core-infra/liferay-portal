...
public class ProcessMetricResourceFactoryImpl
	...
	@Override
	public ProcessMetricResource.Builder create() {
		return new ProcessMetricResource.Builder() {
			...
			@Override
			public ProcessMetricResource.Builder checkPermissions(
			...
			@Override
			public ProcessMetricResource.Builder httpServletRequest(
			...
			@Override
			public ProcessMetricResource.Builder httpServletResponse(
			...
			@Override
			public ProcessMetricResource.Builder preferredLocale(
			...
			@Override
			public ProcessMetricResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(processMetricResource);
