...
public class ObjectDefinitionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindBySystem = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBySystem",
			new String[] {
		...
		_finderPathWithoutPaginationFindBySystem = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBySystem",
			new String[] {Boolean.class.getName()}, new String[] {"system_"},
			true);

		_finderPathCountBySystem = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBySystem",
			new String[] {Boolean.class.getName()}, new String[] {"system_"},
			false);
		...
		_finderPathFetchByC_N = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByC_N",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "name"}, true);

		_finderPathCountByC_N = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_N",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "name"}, false);

		_finderPathWithPaginationFindByS_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_S",
			new String[] {
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_A_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathCountByC_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_A_S_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_A_S_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_A_S_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_A_S_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByC_A_S_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A_S_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindBySystem",
			_finderPathWithPaginationFindBySystem);

		_finderPaths.put(
			"finderPathWithoutPaginationFindBySystem",
			_finderPathWithoutPaginationFindBySystem);

		_finderPaths.put("finderPathCountBySystem", _finderPathCountBySystem);
		...
		_finderPaths.put("finderPathCountByC_A_S", _finderPathCountByC_A_S);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_A_S_S",
			_finderPathWithPaginationFindByC_A_S_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_A_S_S",
			_finderPathWithoutPaginationFindByC_A_S_S);

		_finderPaths.put("finderPathCountByC_A_S_S", _finderPathCountByC_A_S_S);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<ObjectDefinition> objectDefinitions = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<ObjectDefinition>> resultMap =
				new HashMap<>();
			...
			for (ObjectDefinition objectDefinition : objectDefinitions) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						objectDefinitionModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), objectDefinition);
				}
				else {
					List<ObjectDefinition> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(objectDefinition);
				}
			}

			for (Map.Entry<List<Object>, List<ObjectDefinition>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<ObjectDefinition> value = resultEntry.getValue();
