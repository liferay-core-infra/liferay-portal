...
public class ESHeapSizeUpperLimitRuleImplTest {
	...
	@Test
	public void testESHeapSizeUpperLimitRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getESHeapSizeUpperLimitRuleServiceReference(bundleContext);
	...
	@Test
	public void testESHeapSizeUpperLimitRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			ESHeapSizeUpperLimitRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getESHeapSizeUpperLimitRuleServiceReference(
	...
	private static final String _RULE_KEY = "es-heap-size-upper-limit";
