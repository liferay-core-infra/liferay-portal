...
public class MessageBoardAttachmentResourceFactoryImpl
	...
	public MessageBoardAttachmentResource.Builder create() {
		return new MessageBoardAttachmentResource.Builder() {
			...
			@Override
			public MessageBoardAttachmentResource.Builder httpServletResponse(
			...
			@Override
			public MessageBoardAttachmentResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, MessageBoardAttachmentResource>
		...
		try {
			Constructor<MessageBoardAttachmentResource> constructor =
				(Constructor<MessageBoardAttachmentResource>)
