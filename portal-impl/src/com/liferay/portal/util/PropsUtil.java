...
public class PropsUtil {
	...
	public static String getLibDir(ClassLoader classLoader, String className) {
	...
	static {
		...
		String globalSharedLibDir = getLibDir(
		...
		String portalShieldedContainerLibDir = getLibDir(
