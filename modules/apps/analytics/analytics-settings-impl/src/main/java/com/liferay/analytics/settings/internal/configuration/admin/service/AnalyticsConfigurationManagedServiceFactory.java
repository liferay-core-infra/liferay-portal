...
package com.liferay.analytics.settings.internal.configuration.admin.service;
...
public class AnalyticsConfigurationManagedServiceFactory
	implements ManagedServiceFactory {

	@Override
	public void deleted(String pid) {
		long companyId = _analyticsConfigurationRegistry.getCompanyId(pid);
	...
	private void _unmapPid(String pid) {
		Long companyId = AnalyticsConfigurationRegistryUtil.removeCompanyId(
			pid);

		if (companyId != null) {
			AnalyticsConfigurationRegistryUtil.removeAnalyticsConfiguration(
				companyId);
		}
	}
	...
	private void _updated(
		...
		if (companyId != CompanyConstants.SYSTEM) {
			AnalyticsConfigurationRegistryUtil.updateAnalyticsConfiguration(
				ConfigurableUtil.createConfigurable(
					AnalyticsConfiguration.class, dictionary),
				companyId);
			AnalyticsConfigurationRegistryUtil.updateEntrySetCompanyIds(
				pid, companyId);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AnalyticsConfigurationManagedServiceFactory.class);
