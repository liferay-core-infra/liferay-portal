...
public class ModelPrefilterContributorResourceFactoryImpl
	implements ModelPrefilterContributorResource.Factory {

	@Override
	public ModelPrefilterContributorResource.Builder create() {
		return new ModelPrefilterContributorResource.Builder() {
			...
			@Override
			public ModelPrefilterContributorResource.Builder checkPermissions(
			...
			@Override
			public ModelPrefilterContributorResource.Builder httpServletRequest(
			...
			@Override
			public ModelPrefilterContributorResource.Builder
			...
			@Override
			public ModelPrefilterContributorResource.Builder preferredLocale(
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ModelPrefilterContributorResource.class.getClassLoader(),
			ModelPrefilterContributorResource.class);

		try {
			Constructor<ModelPrefilterContributorResource> constructor =
				(Constructor<ModelPrefilterContributorResource>)
