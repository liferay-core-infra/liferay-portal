...
create unique index IX_43C6D14B on DDMStructure (groupId, classNameId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
...
create unique index IX_35AC1D1E on DDMTemplate (groupId, externalReferenceCode[$COLUMN_LENGTH:500$], ctCollectionId);
