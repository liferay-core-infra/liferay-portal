 ...
 */
@Component(
	service = {KaleoInstanceTokenPersistence.class, BasePersistence.class}
)
public class KaleoInstanceTokenPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_PKITI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_PKITI",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_PKITI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_PKITI",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"companyId", "parentKaleoInstanceTokenId"}, true);

		_finderPathCountByC_PKITI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_PKITI",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"companyId", "parentKaleoInstanceTokenId"}, false);

		_finderPathWithPaginationFindByC_PKITI_CD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_PKITI_CD",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_PKITI_CD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_PKITI_CD",
			new String[] {
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByC_PKITI",
			_finderPathWithPaginationFindByC_PKITI);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_PKITI",
			_finderPathWithoutPaginationFindByC_PKITI);

		_finderPaths.put("finderPathCountByC_PKITI", _finderPathCountByC_PKITI);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_PKITI_CD",
			_finderPathWithPaginationFindByC_PKITI_CD);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_PKITI_CD",
			_finderPathWithoutPaginationFindByC_PKITI_CD);

		_finderPaths.put(
			"finderPathCountByC_PKITI_CD", _finderPathCountByC_PKITI_CD);
