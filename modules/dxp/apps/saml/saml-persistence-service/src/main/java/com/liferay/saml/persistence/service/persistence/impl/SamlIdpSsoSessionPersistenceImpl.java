 ...
 */
@Component(
	service = {SamlIdpSsoSessionPersistence.class, BasePersistence.class}
)
public class SamlIdpSsoSessionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchBySamlIdpSsoSessionKey = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchBySamlIdpSsoSessionKey",
		...
		_finderPaths.put(
			"finderPathFetchBySamlIdpSsoSessionKey",
			_finderPathFetchBySamlIdpSsoSessionKey);

		_finderPaths.put(
			"finderPathCountBySamlIdpSsoSessionKey",
			_finderPathCountBySamlIdpSsoSessionKey);
