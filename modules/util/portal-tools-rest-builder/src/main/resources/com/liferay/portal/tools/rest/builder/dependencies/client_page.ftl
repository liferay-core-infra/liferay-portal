	...
	public static class PageJSONParser<T> extends BaseJSONParser<Page> {
		...
		private List<Facet> _getFacet(Object jsonParserFieldValue){
			...
			for(String string : toStrings((Object[])jsonParserFieldValue)){
				...
				Map<String, Object> jsonParserFieldValuesMap = this.parseToMap(string);

				for(Object object : (Object[])jsonParserFieldValuesMap.get("facetValues")){
					Map<String, Object> facetValueMap = this.parseToMap((String)object);
