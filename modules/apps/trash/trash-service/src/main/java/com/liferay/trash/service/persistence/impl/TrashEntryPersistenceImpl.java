...
public class TrashEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_LtCD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_LtCD",
			new String[] {
		...
		_finderPathWithPaginationCountByG_LtCD = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_LtCD",
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_LtCD",
			_finderPathWithPaginationFindByG_LtCD);

		_finderPaths.put(
			"finderPathWithPaginationCountByG_LtCD",
