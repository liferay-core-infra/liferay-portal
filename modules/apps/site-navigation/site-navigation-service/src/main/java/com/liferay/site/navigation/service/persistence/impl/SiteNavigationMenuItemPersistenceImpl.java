...
public class SiteNavigationMenuItemPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByS_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_P",
			new String[] {
		...
		_finderPathWithoutPaginationFindByS_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByS_P",
		...
		_finderPathCountByS_P = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByS_P",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {
				"siteNavigationMenuId", "parentSiteNavigationMenuItemId"
			},
		...
		_finderPathWithPaginationFindByS_LikeN = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_LikeN",
			new String[] {
		...
		_finderPathWithPaginationCountByS_LikeN = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByS_LikeN",
		...
		_finderPaths.put("finderPathCountByS_P", _finderPathCountByS_P);
