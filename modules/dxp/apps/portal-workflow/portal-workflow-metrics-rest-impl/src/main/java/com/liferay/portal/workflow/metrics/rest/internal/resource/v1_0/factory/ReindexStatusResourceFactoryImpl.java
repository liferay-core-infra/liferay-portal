...
public class ReindexStatusResourceFactoryImpl
	...
	@Override
	public ReindexStatusResource.Builder create() {
		return new ReindexStatusResource.Builder() {
			...
			public ReindexStatusResource build() {
				...
				return _reindexStatusResourceProxyProviderFunction.apply(
			...
			@Override
			public ReindexStatusResource.Builder checkPermissions(
			...
			@Override
			public ReindexStatusResource.Builder httpServletRequest(
			...
			@Override
			public ReindexStatusResource.Builder httpServletResponse(
			...
			@Override
			public ReindexStatusResource.Builder preferredLocale(
			...
			@Override
			public ReindexStatusResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ReindexStatusResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ReindexStatusResource.class.getClassLoader(),
			ReindexStatusResource.class);

		try {
			Constructor<ReindexStatusResource> constructor =
				(Constructor<ReindexStatusResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(reindexStatusResource);
	...
	private static final Function<InvocationHandler, ReindexStatusResource>
		_reindexStatusResourceProxyProviderFunction =
			_getProxyProviderFunction();
