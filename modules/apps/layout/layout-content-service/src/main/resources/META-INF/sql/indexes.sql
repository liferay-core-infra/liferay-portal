...
create unique index IX_D4C862E2 on LayoutContentVersion (groupId, externalReferenceCode[$COLUMN_LENGTH:500$]);
...
create unique index IX_CC10F2C6 on LayoutContentVersionPreview (layoutContentVersionId, segmentsExperienceERC[$COLUMN_LENGTH:500$], languageId[$COLUMN_LENGTH:75$]);