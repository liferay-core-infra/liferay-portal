...
public class UserUtil {
	 ...
	 * @return the matching users
	 */
	public static List<User> findByC_GUID(long companyId, String googleUserId) {
	 ...
	 * @return the range of matching users
	 */
	public static List<User> findByC_GUID(
		long companyId, String googleUserId, int start, int end) {

		return getPersistence().findByC_GUID(
			companyId, googleUserId, start, end);
	}
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_GUID_First(
			long companyId, String googleUserId,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_GUID_First(
	 ...
	 * @return the first matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_GUID_First(
		long companyId, String googleUserId,
		OrderByComparator<User> orderByComparator) {

		return getPersistence().fetchByC_GUID_First(
			companyId, googleUserId, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_GUID_Last(
			long companyId, String googleUserId,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_GUID_Last(
			companyId, googleUserId, orderByComparator);
	}
	 ...
	 * @return the last matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_GUID_Last(
		long companyId, String googleUserId,
		OrderByComparator<User> orderByComparator) {

		return getPersistence().fetchByC_GUID_Last(
			companyId, googleUserId, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a user with the primary key could not be found
	 */
	public static User[] findByC_GUID_PrevAndNext(
			long userId, long companyId, String googleUserId,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_GUID_PrevAndNext(
			userId, companyId, googleUserId, orderByComparator);
	}
	 ...
	 * @param googleUserId the google user ID
	 */
	public static void removeByC_GUID(long companyId, String googleUserId) {
		getPersistence().removeByC_GUID(companyId, googleUserId);
	}
	 ...
	 * @return the matching users
	 */
	public static List<User> findByC_O(long companyId, String openId) {
	 ...
	 * @return the range of matching users
	 */
	public static List<User> findByC_O(
		long companyId, String openId, int start, int end) {

		return getPersistence().findByC_O(companyId, openId, start, end);
	}
	...
	public static List<User> findByC_O(
		...
		return getPersistence().findByC_O(
	...
	public static List<User> findByC_O(
		...
		return getPersistence().findByC_O(
			companyId, openId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_O_First(
			long companyId, String openId,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_O_First(
			companyId, openId, orderByComparator);
	}
	 ...
	 * @return the first matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_O_First(
		long companyId, String openId,
		OrderByComparator<User> orderByComparator) {

		return getPersistence().fetchByC_O_First(
			companyId, openId, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a matching user could not be found
	 */
	public static User findByC_O_Last(
			long companyId, String openId,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_O_Last(
			companyId, openId, orderByComparator);
	}
	 ...
	 * @return the last matching user, or <code>null</code> if a matching user could not be found
	 */
	public static User fetchByC_O_Last(
		long companyId, String openId,
		OrderByComparator<User> orderByComparator) {

		return getPersistence().fetchByC_O_Last(
			companyId, openId, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserException if a user with the primary key could not be found
	 */
	public static User[] findByC_O_PrevAndNext(
			long userId, long companyId, String openId,
			OrderByComparator<User> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchUserException {

		return getPersistence().findByC_O_PrevAndNext(
			userId, companyId, openId, orderByComparator);
	}
	 ...
	 * @param openId the open ID
	 */
	public static void removeByC_O(long companyId, String openId) {
