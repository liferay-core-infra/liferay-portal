...
public class SortedFinderEntryPersistenceTest {
	...
	private void _assertOriginalValues(SortedFinderEntry sortedFinderEntry) {
		Assert.assertEquals(
			Long.valueOf(sortedFinderEntry.getGroupId()),
			ReflectionTestUtil.<Long>invoke(
				sortedFinderEntry, "getColumnOriginalValue",
