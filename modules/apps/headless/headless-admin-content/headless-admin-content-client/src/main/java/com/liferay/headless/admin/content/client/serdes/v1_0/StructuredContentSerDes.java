			...
			if (Objects.equals(jsonParserFieldName, "actions")) {
				...
				if (jsonParserFieldValue != null) {
					...
					for (int i = 0; i < ContentFields.length; i++) {
						ContentFields[i] = ContentFieldSerDes.toDTO(
				...
				if (jsonParserFieldValue != null) {
					...
					structuredContent.setCustomFields(CustomFields);
				}
			}
				...
				if (jsonParserFieldValue != null) {
					...
					structuredContent.setRelatedContents(RelatedContents);
				}
			}
				...
				if (jsonParserFieldValue != null) {
					...
					structuredContent.setRenderedContents(RenderedContents);
				}
			}
