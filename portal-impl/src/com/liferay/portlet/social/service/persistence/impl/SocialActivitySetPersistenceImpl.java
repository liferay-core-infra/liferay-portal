...
public class SocialActivitySetPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_U_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_U_T",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_U_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_U_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_U_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_U_C_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_U_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_U_C_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_U_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByG_U_C_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathWithPaginationFindByU_C_C_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_C_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByU_C_C_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByU_C_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByU_C_C_T = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_C_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Integer.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_U_T",
			_finderPathWithPaginationFindByG_U_T);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_U_T",
			_finderPathWithoutPaginationFindByG_U_T);

		_finderPaths.put("finderPathCountByG_U_T", _finderPathCountByG_U_T);
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_U_C_T",
			_finderPathWithPaginationFindByG_U_C_T);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_U_C_T",
			_finderPathWithoutPaginationFindByG_U_C_T);

		_finderPaths.put("finderPathCountByG_U_C_T", _finderPathCountByG_U_C_T);

		_finderPaths.put(
			"finderPathWithPaginationFindByU_C_C_T",
			_finderPathWithPaginationFindByU_C_C_T);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByU_C_C_T",
			_finderPathWithoutPaginationFindByU_C_C_T);

		_finderPaths.put("finderPathCountByU_C_C_T", _finderPathCountByU_C_C_T);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<SocialActivitySet> socialActivitySets = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<SocialActivitySet>> resultMap =
				new HashMap<>();
			...
			for (SocialActivitySet socialActivitySet : socialActivitySets) {
				...
				for (String columnName : finderPath.getColumnNames()) {
					...
					arguments.add(
						socialActivitySetModelImpl.getColumnValue(columnName));
				}
				...
				if (Objects.equals(
					...
					FinderCacheUtil.putResult(
						finderPath, arguments.toArray(), socialActivitySet);
				}
				else {
					List<SocialActivitySet> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(socialActivitySet);
				}
			}

			for (Map.Entry<List<Object>, List<SocialActivitySet>> resultEntry :
					resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<SocialActivitySet> value = resultEntry.getValue();
