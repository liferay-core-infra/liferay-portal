...
public class DLFileShortcutPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByToFileEntryId = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByToFileEntryId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_F_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_F_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_F_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_F_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_F_A = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_F_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_F_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_F_A_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_F_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_F_A_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPathCountByG_F_A_S = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_F_A_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName()
			},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByToFileEntryId",
			_finderPathWithPaginationFindByToFileEntryId);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByToFileEntryId",
			_finderPathWithoutPaginationFindByToFileEntryId);

		_finderPaths.put(
			"finderPathCountByToFileEntryId", _finderPathCountByToFileEntryId);
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByG_F_A",
			_finderPathWithPaginationFindByG_F_A);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_F_A",
			_finderPathWithoutPaginationFindByG_F_A);

		_finderPaths.put("finderPathCountByG_F_A", _finderPathCountByG_F_A);

		_finderPaths.put(
			"finderPathWithPaginationFindByG_F_A_S",
			_finderPathWithPaginationFindByG_F_A_S);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByG_F_A_S",
			_finderPathWithoutPaginationFindByG_F_A_S);

		_finderPaths.put("finderPathCountByG_F_A_S", _finderPathCountByG_F_A_S);
