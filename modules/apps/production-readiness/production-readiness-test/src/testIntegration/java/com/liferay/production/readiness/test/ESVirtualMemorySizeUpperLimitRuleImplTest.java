...
public class ESVirtualMemorySizeUpperLimitRuleImplTest {
	...
	@Test
	public void testESVirtualMemorySizeUpperLimitRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getESVirtualMemorySizeUpperLimitRuleServiceReference(
				bundleContext);
	...
	@Test
	public void testESVirtualMemorySizeUpperLimitRuleIsRegistered()
		throws Exception {
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			ESVirtualMemorySizeUpperLimitRuleImplTest.class
		).getBundleContext();
	}
	...
	private static final String _RULE_KEY =
		"es-virtual-memory-size-upper-limit";
