...
public class LayoutPageTemplateCollectionUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathFetchByG_LPTCK() {

		return getPersistence().getFinderPathFetchByG_LPTCK();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByG_LPTCK() {

		return getPersistence().getFinderPathCountByG_LPTCK();
	}
