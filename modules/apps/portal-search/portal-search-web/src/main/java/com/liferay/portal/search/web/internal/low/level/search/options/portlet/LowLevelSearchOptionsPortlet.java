...
@Component(
	property = {
		...
		"jakarta.portlet.display-name=Low Level Search Options",
		"jakarta.portlet.expiration-cache=0",
		"jakarta.portlet.init-param.template-path=/META-INF/resources/",
		"jakarta.portlet.init-param.view-template=/low/level/search/options/view.jsp",
		"jakarta.portlet.name=" + LowLevelSearchOptionsPortletKeys.LOW_LEVEL_SEARCH_OPTIONS,
