...
@Generated("")
public class ReplenishmentItemResourceFactoryImpl
	implements ReplenishmentItemResource.Factory {

	@Override
	public ReplenishmentItemResource.Builder create() {
		return new ReplenishmentItemResource.Builder() {
			...
			public ReplenishmentItemResource build() {
				...
				return _replenishmentItemResourceProxyProviderFunction.apply(
			...
			@Override
			public ReplenishmentItemResource.Builder checkPermissions(
			...
			@Override
			public ReplenishmentItemResource.Builder httpServletRequest(
			...
			@Override
			public ReplenishmentItemResource.Builder httpServletResponse(
			...
			@Override
			public ReplenishmentItemResource.Builder preferredLocale(
			...
			@Override
			public ReplenishmentItemResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ReplenishmentItemResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ReplenishmentItemResource.class.getClassLoader(),
			ReplenishmentItemResource.class);

		try {
			Constructor<ReplenishmentItemResource> constructor =
				(Constructor<ReplenishmentItemResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(replenishmentItemResource);
	...
	private static final Function<InvocationHandler, ReplenishmentItemResource>
		_replenishmentItemResourceProxyProviderFunction =
			_getProxyProviderFunction();
