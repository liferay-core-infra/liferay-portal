...
public class SamlIdpSpConnectionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByC_SSEI = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByC_SSEI",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "samlSpEntityId"}, true);

		_finderPathCountByC_SSEI = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_SSEI",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPaths.put("finderPathFetchByC_SSEI", _finderPathFetchByC_SSEI);

		_finderPaths.put("finderPathCountByC_SSEI", _finderPathCountByC_SSEI);
