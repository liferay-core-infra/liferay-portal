 ...
 */
@Component(
	 immediate = true, service = OptionResource.Factory.class
)
@Generated("")
public class OptionResourceFactoryImpl implements OptionResource.Factory {

	@Override
	public OptionResource.Builder create() {
		return new OptionResource.Builder() {
			...
			@Override
			public OptionResource.Builder checkPermissions(
			...
			@Override
			public OptionResource.Builder httpServletRequest(
			...
			@Override
			public OptionResource.Builder httpServletResponse(
			...
			@Override
			public OptionResource.Builder preferredLocale(
			...
			@Override
			public OptionResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		OptionResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		OptionResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, OptionResource>
		...
		try {
			Constructor<OptionResource> constructor =
				(Constructor<OptionResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(optionResource);
	...
	private ComponentServiceObjects<OptionResource> _componentServiceObjects;
