...
public class RoleConstants {
	...
	public static final String[] SYSTEM_ROLES = {
		ADMINISTRATOR, ANALYTICS_ADMINISTRATOR, CMS_ADMINISTRATOR, GUEST, OWNER,
		POWER_USER, PUBLICATIONS_ADMIN, PUBLICATIONS_EDITOR,
		PUBLICATIONS_PUBLISHER, PUBLICATIONS_USER, PUBLICATIONS_VIEWER,
		RoleConstants.USER
	};
