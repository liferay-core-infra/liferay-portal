...
@Component(
	property = {
		"com.liferay.fragment.entry.processor.portlet.alias=" + FragmentEntryLinkPortletKeys.FRAGMENT_ENTRY_LINK_INSTANCEABLE,
...
public class FragmentEntryLinkInstanceableTestPortlet extends MVCPortlet {
	...
	protected void activate() {
		_portletRegistry.registerAlias(
			FragmentEntryLinkPortletKeys.FRAGMENT_ENTRY_LINK_INSTANCEABLE,
