...
public interface FilterFindEntryPersistence
	 ...
	 */
	public java.util.List<FilterFindEntry> findByGroupId(long groupId);
	 ...
	 */
	public java.util.List<FilterFindEntry> findByGroupId(
	 ...
	 */
	public java.util.List<FilterFindEntry> filterFindByGroupId(long groupId);
	 ...
	 */
	public java.util.List<FilterFindEntry> filterFindByGroupId(
		long groupId, int start, int end);
