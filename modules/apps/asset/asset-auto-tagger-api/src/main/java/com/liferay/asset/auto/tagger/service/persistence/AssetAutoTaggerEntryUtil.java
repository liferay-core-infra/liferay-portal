...
public class AssetAutoTaggerEntryUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByAssetEntryId() {

		return getPersistence().getFinderPathWithPaginationFindByAssetEntryId();
	}
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithPaginationFindByAssetTagId() {

		return getPersistence().getFinderPathWithPaginationFindByAssetTagId();
	}
