...
@Generated("")
public class PaymentMethodGroupRelTermResourceFactoryImpl
	implements PaymentMethodGroupRelTermResource.Factory {

	@Override
	public PaymentMethodGroupRelTermResource.Builder create() {
		return new PaymentMethodGroupRelTermResource.Builder() {
			...
			@Override
			public PaymentMethodGroupRelTermResource.Builder checkPermissions(
			...
			@Override
			public PaymentMethodGroupRelTermResource.Builder httpServletRequest(
			...
			@Override
			public PaymentMethodGroupRelTermResource.Builder
			...
			@Override
			public PaymentMethodGroupRelTermResource.Builder preferredLocale(
			...
			@Override
			public PaymentMethodGroupRelTermResource.Builder user(User user) {
				_user = user;
