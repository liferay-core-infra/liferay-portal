...
public class CommerceInventoryWarehouseRelPersistenceImpl
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		...
		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CommerceInventoryWarehouseRel>> resultMap =
				new HashMap<>();
			...
			for (CommerceInventoryWarehouseRel commerceInventoryWarehouseRel :
				...
				if (Objects.equals(
					...
					List<CommerceInventoryWarehouseRel> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(commerceInventoryWarehouseRel);
				}
			}

			for (Map.Entry<List<Object>, List<CommerceInventoryWarehouseRel>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CommerceInventoryWarehouseRel> value =
