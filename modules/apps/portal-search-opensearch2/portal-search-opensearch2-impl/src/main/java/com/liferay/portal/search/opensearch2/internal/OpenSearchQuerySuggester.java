 ...
 */
@Component(
	property = "search.engine.impl=OpenSearch", service = QuerySuggester.class
)
public class OpenSearchQuerySuggester implements QuerySuggester {
	...
	public Map<String, List<String>> spellCheckKeywords(
		...
		entries.forEach(
			suggestSearchResultEntry -> {
				...
				List<String> words = results.computeIfAbsent(
	...
	public String[] suggestKeywordQueries(
		...
		SuggestSearchResponse suggestSearchResponse =
			_executeSuggestSearchRequest(
				searchContext, _createQuerySuggester(max, searchContext));
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OpenSearchQuerySuggester.class);
