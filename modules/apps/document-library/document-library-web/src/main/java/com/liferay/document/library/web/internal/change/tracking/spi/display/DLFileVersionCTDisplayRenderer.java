...
public class DLFileVersionCTDisplayRenderer
	...
	public InputStream getDownloadInputStream(
		...
		return getDownloadInputStream(
			_store, (AudioProcessor)_audioProcessor, _dlAppLocalService,
			dlFileVersion, _imageProcessor, key, _pdfProcessor,
	...
	public String renderPreview(DisplayContext<DLFileVersion> displayContext)
		...
		AudioProcessor audioProcessor = (AudioProcessor)_audioProcessor;
		...
		VideoProcessor videoProcessor = (VideoProcessor)_videoProcessor;
