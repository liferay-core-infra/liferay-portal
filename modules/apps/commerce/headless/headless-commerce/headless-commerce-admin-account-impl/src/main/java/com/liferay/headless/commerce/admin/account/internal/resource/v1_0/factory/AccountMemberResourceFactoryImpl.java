...
public class AccountMemberResourceFactoryImpl
	...
	@Override
	public AccountMemberResource.Builder create() {
		return new AccountMemberResource.Builder() {
			...
			public AccountMemberResource build() {
				...
				return _accountMemberResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountMemberResource.Builder checkPermissions(
			...
			@Override
			public AccountMemberResource.Builder httpServletRequest(
			...
			@Override
			public AccountMemberResource.Builder httpServletResponse(
			...
			@Override
			public AccountMemberResource.Builder preferredLocale(
			...
			@Override
			public AccountMemberResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, AccountMemberResource>
		...
		try {
			Constructor<AccountMemberResource> constructor =
				(Constructor<AccountMemberResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(accountMemberResource);
	...
	private static final Function<InvocationHandler, AccountMemberResource>
		_accountMemberResourceProxyProviderFunction =
			_getProxyProviderFunction();
