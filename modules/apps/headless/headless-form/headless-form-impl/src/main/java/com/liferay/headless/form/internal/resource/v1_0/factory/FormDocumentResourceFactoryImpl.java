...
public class FormDocumentResourceFactoryImpl
	...
	@Override
	public FormDocumentResource.Builder create() {
		return new FormDocumentResource.Builder() {
			...
			public FormDocumentResource build() {
				...
				return _formDocumentResourceProxyProviderFunction.apply(
			...
			@Override
			public FormDocumentResource.Builder checkPermissions(
			...
			@Override
			public FormDocumentResource.Builder httpServletRequest(
			...
			@Override
			public FormDocumentResource.Builder httpServletResponse(
			...
			@Override
			public FormDocumentResource.Builder preferredLocale(
			...
			@Override
			public FormDocumentResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		FormDocumentResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		FormDocumentResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, FormDocumentResource>
		...
		try {
			Constructor<FormDocumentResource> constructor =
				(Constructor<FormDocumentResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(formDocumentResource);
	...
	private static final Function<InvocationHandler, FormDocumentResource>
		_formDocumentResourceProxyProviderFunction =
			_getProxyProviderFunction();
