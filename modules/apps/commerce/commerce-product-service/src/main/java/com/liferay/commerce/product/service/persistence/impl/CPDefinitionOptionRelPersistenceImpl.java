...
public class CPDefinitionOptionRelPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByCPDI_R = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCPDI_R",
			new String[] {
		...
		_finderPathWithoutPaginationFindByCPDI_R = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCPDI_R",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"CPDefinitionId", "required"}, true);

		_finderPathCountByCPDI_R = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCPDI_R",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"CPDefinitionId", "required"}, false);

		_finderPathWithPaginationFindByC_SC = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_SC",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_SC = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_SC",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"CPDefinitionId", "skuContributor"}, true);

		_finderPathCountByC_SC = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_SC",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"CPDefinitionId", "skuContributor"}, false);

		_finderPathFetchByC_K = new FinderPath(
			this, FINDER_CLASS_NAME_ENTITY, "fetchByC_K",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"CPDefinitionId", "key_"}, true);

		_finderPathCountByC_K = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_K",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPaths.put(
			"finderPathWithPaginationFindByCPDI_R",
			_finderPathWithPaginationFindByCPDI_R);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByCPDI_R",
			_finderPathWithoutPaginationFindByCPDI_R);

		_finderPaths.put("finderPathCountByCPDI_R", _finderPathCountByCPDI_R);

		_finderPaths.put(
			"finderPathWithPaginationFindByC_SC",
			_finderPathWithPaginationFindByC_SC);

		_finderPaths.put(
			"finderPathWithoutPaginationFindByC_SC",
			_finderPathWithoutPaginationFindByC_SC);

		_finderPaths.put("finderPathCountByC_SC", _finderPathCountByC_SC);
	...
	public void populateFinderCache(FinderPath... finderPaths) {
		List<CPDefinitionOptionRel> cpDefinitionOptionRels = findAll();

		for (FinderPath finderPath : finderPaths) {
			Map<List<Object>, List<CPDefinitionOptionRel>> resultMap =
				new HashMap<>();
			...
			for (CPDefinitionOptionRel cpDefinitionOptionRel :
				...
				if (Objects.equals(
					...
					finderCache.putResult(
						finderPath, arguments.toArray(), cpDefinitionOptionRel);
				}
				else {
					List<CPDefinitionOptionRel> resultList =
						resultMap.computeIfAbsent(
							arguments, key -> new ArrayList<>());

					resultList.add(cpDefinitionOptionRel);
				}
			}

			for (Map.Entry<List<Object>, List<CPDefinitionOptionRel>>
					resultEntry : resultMap.entrySet()) {

				List<Object> key = resultEntry.getKey();
				List<CPDefinitionOptionRel> value = resultEntry.getValue();
