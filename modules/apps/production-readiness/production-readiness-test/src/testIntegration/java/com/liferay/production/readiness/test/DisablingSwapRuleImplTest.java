...
public class DisablingSwapRuleImplTest {
	...
	@Test
	public void testDisablingSwapRuleCheckReturnsSingleResult()
		throws Exception {

		BundleContext bundleContext = _getBundleContext();

		ServiceReference<ProductionReadinessRule> serviceReference =
			_getDisablingSwapRuleServiceReference(bundleContext);
	...
	@Test
	public void testDisablingSwapRuleIsRegistered() throws Exception {
		BundleContext bundleContext = _getBundleContext();
	...
	private BundleContext _getBundleContext() {
		return FrameworkUtil.getBundle(
			DisablingSwapRuleImplTest.class
		).getBundleContext();
	}

	private ServiceReference<ProductionReadinessRule>
			_getDisablingSwapRuleServiceReference(BundleContext bundleContext)
		throws Exception {
	...
	private static final String _RULE_KEY = "disable-swap";
