...
public class SearchableAssetNameDisplayResourceFactoryImpl
	implements SearchableAssetNameDisplayResource.Factory {

	@Override
	public SearchableAssetNameDisplayResource.Builder create() {
		return new SearchableAssetNameDisplayResource.Builder() {
			...
			@Override
			public SearchableAssetNameDisplayResource.Builder checkPermissions(
			...
			@Override
			public SearchableAssetNameDisplayResource.Builder
			...
			@Override
			public SearchableAssetNameDisplayResource.Builder preferredLocale(
			...
			@Override
			public SearchableAssetNameDisplayResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		SearchableAssetNameDisplayResource.FactoryHolder.factory = this;
	}
