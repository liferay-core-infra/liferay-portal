...
public class ExperimentResourceFactoryImpl
	...
	public ExperimentResource.Builder create() {
		return new ExperimentResource.Builder() {
			...
			public ExperimentResource build() {
				...
				return _experimentResourceProxyProviderFunction.apply(
			...
			@Override
			public ExperimentResource.Builder httpServletResponse(
			...
			@Override
			public ExperimentResource.Builder preferredLocale(
	...
	private static Function<InvocationHandler, ExperimentResource>
		...
		try {
			Constructor<ExperimentResource> constructor =
				(Constructor<ExperimentResource>)proxyClass.getConstructor(
	...
	private static final Function<InvocationHandler, ExperimentResource>
		_experimentResourceProxyProviderFunction = _getProxyProviderFunction();
