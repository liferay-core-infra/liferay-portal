 ...
 * @generated
 */
public abstract class FragmentEntryFinderBaseImpl
	extends BasePersistenceImpl<FragmentEntry> {

	public FragmentEntryFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return fragmentEntryPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FragmentEntryFinderBaseImpl.class);
