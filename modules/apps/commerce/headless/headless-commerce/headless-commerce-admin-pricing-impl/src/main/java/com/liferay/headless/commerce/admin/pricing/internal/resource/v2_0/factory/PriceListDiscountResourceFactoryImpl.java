...
@Generated("")
public class PriceListDiscountResourceFactoryImpl
	implements PriceListDiscountResource.Factory {

	@Override
	public PriceListDiscountResource.Builder create() {
		return new PriceListDiscountResource.Builder() {
			...
			public PriceListDiscountResource build() {
				...
				return _priceListDiscountResourceProxyProviderFunction.apply(
			...
			@Override
			public PriceListDiscountResource.Builder checkPermissions(
			...
			@Override
			public PriceListDiscountResource.Builder httpServletRequest(
			...
			@Override
			public PriceListDiscountResource.Builder httpServletResponse(
			...
			@Override
			public PriceListDiscountResource.Builder preferredLocale(
			...
			@Override
			public PriceListDiscountResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PriceListDiscountResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PriceListDiscountResource.FactoryHolder.factory = null;
	}
	...
	private static Function<InvocationHandler, PriceListDiscountResource>
		...
		try {
			Constructor<PriceListDiscountResource> constructor =
				(Constructor<PriceListDiscountResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(priceListDiscountResource);
	...
	private static final Function<InvocationHandler, PriceListDiscountResource>
		_priceListDiscountResourceProxyProviderFunction =
			_getProxyProviderFunction();
