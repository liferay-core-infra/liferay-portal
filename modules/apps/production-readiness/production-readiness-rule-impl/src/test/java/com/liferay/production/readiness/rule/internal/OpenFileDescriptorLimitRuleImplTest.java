...
public class OpenFileDescriptorLimitRuleImplTest {
	...
	public void testCheckReturnsFail() {
		Collection<Result> results = _openFileDescriptorLimitRuleImpl.check(0L);
		...
		Assert.assertEquals("ulimit -n >= 65536", result.getRecommendedValue());
	...
	private final OpenFileDescriptorLimitRuleImpl
		_openFileDescriptorLimitRuleImpl =
			new OpenFileDescriptorLimitRuleImpl();
