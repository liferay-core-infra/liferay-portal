...
@Generated("")
public class PlacedOrderResourceFactoryImpl
	implements PlacedOrderResource.Factory {

	@Override
	public PlacedOrderResource.Builder create() {
		return new PlacedOrderResource.Builder() {
			...
			public PlacedOrderResource build() {
				...
				return _placedOrderResourceProxyProviderFunction.apply(
			...
			@Override
			public PlacedOrderResource.Builder checkPermissions(
			...
			@Override
			public PlacedOrderResource.Builder httpServletRequest(
			...
			@Override
			public PlacedOrderResource.Builder httpServletResponse(
			...
			@Override
			public PlacedOrderResource.Builder preferredLocale(
	...
	protected void activate() {
		PlacedOrderResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PlacedOrderResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, PlacedOrderResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PlacedOrderResource.class.getClassLoader(),
			PlacedOrderResource.class);

		try {
			Constructor<PlacedOrderResource> constructor =
				(Constructor<PlacedOrderResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(placedOrderResource);
	...
	private static final Function<InvocationHandler, PlacedOrderResource>
		_placedOrderResourceProxyProviderFunction = _getProxyProviderFunction();
