...
public class UserGroupAnalyticsModelListener
	...
	@Override
	protected EntityModelListener<UserGroup> getEntityModelListener() {
		return _userGroupEntityModelListener;
	}
	...
	@Reference(target = "(entity.model.listener.type=usergroup)")
	private EntityModelListener<UserGroup> _userGroupEntityModelListener;
