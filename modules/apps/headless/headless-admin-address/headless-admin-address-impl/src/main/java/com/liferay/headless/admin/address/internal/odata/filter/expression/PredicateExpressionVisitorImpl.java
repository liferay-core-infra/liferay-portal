...
/**
 * Translates an OData filter expression into a Petra DSL {@link Predicate} over
 * a fixed set of columns. Unlike the search-backed conversion, this lets a
 * DSL-backed resource honor a filter (most notably the {@code dateModified}
 * date range the export/import framework applies) without a search index.
 *
 * <p>
 * Only the fields present in the column map are supported; any other field or
 * an unsupported operation raises an {@link UnsupportedOperationException}.
 * </p>
 *
...
public class PredicateExpressionVisitorImpl
	...
	public Object visitBinaryExpressionOperation(
		...
		return _getComparisonPredicate((String)left, operation, right);
	}
	...
	public Object visitMemberExpression(MemberExpression memberExpression)
		...
		return memberExpression.getExpression(
		).accept(
			this
		);
	}
	...
	public Object visitMethodExpression(
		...
		throw new UnsupportedOperationException(
			"Unsupported method expression " + type);
	}
	...
	private Predicate _getComparisonPredicate(
	...
	private Date _toDate(String text) {
