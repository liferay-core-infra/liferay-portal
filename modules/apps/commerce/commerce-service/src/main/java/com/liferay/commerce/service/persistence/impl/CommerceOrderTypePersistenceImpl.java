 ...
 */
@Component(
	service = {CommerceOrderTypePersistence.class, BasePersistence.class}
)
public class CommerceOrderTypePersistenceImpl
	...
	@Reference
	private CommerceOrderTypeModelArgumentsResolver
		_commerceOrderTypeModelArgumentsResolver;
