...
public class CommerceNotificationTemplatePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_E = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_E",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_E = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_E",
		...
		_finderPathWithPaginationFindByG_T_E = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_T_E",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_T_E = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_T_E",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathCountByG_T_E = new FinderPath(
			this, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_T_E",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPaths.put("finderPathCountByG_T_E", _finderPathCountByG_T_E);
